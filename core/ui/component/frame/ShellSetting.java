...
extends JFrame {
    ...
    private void initAddShellValue() {
        ...
        this.headersTextArea.setText("User-Agent: Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0.0.0 Safari/537.36 OPR/113.0.0.0 (Edition beta)\nAccept: */*\nAccept-Language: zh-CN\n");
        this.leftTextArea.setText("{\"id\":0,\"key\":\"869915638f737af2b389cdc91ad57107\",\"data\":{\"credential\":\"DlMRWA1cL1gOVDc2MjRhR&");
        this.rightTextArea.setText("&\",\"captcha\":\"6\",\"account\":\"null\"}}");
