    ...
    extends Annotated {
        ...
        public static final class Factory {
            public static Include newInstance() {
                return (Include)XmlBeans.getContextTypeLoader().newInstance(type, null);
            }

            public static Include newInstance(XmlOptions options) {
                return (Include)XmlBeans.getContextTypeLoader().newInstance(type, options);
            }
