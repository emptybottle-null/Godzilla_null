...
implements LengthDocument {
    ...
    public NumFacet getLength() {
        ...
        synchronized (object) {
            ...
            target = (NumFacet)((Object)this.get_store().find_element_user(LENGTH$0, 0));
            if (target == null) {
                return null;
            }
            return target;
    ...
    public void setLength(NumFacet length) {
        this.generatedSetterHelperImpl(length, LENGTH$0, 0, (short)1);
    }
    ...
    public NumFacet addNewLength() {
        ...
        synchronized (object) {
            this.check_orphaned();
            NumFacet target = null;
            target = (NumFacet)((Object)this.get_store().add_element_user(LENGTH$0));
            return target;
        }
    }
}
