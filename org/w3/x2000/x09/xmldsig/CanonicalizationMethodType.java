    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CanonicalizationMethodType.class.getClassLoader());
        ...
        public static CanonicalizationMethodType newInstance() {
            return (CanonicalizationMethodType)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CanonicalizationMethodType newInstance(XmlOptions xmlOptions) {
            return (CanonicalizationMethodType)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CanonicalizationMethodType parse(String string) throws XmlException {
            return (CanonicalizationMethodType)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CanonicalizationMethodType parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CanonicalizationMethodType)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CanonicalizationMethodType parse(File file) throws XmlException, IOException {
            return (CanonicalizationMethodType)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CanonicalizationMethodType parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CanonicalizationMethodType)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CanonicalizationMethodType parse(URL uRL) throws XmlException, IOException {
            return (CanonicalizationMethodType)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CanonicalizationMethodType parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CanonicalizationMethodType)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CanonicalizationMethodType parse(InputStream inputStream) throws XmlException, IOException {
            return (CanonicalizationMethodType)Factory.getTypeLoader().parse(inputStream, type, null);
        }
        ...
        public static CanonicalizationMethodType parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CanonicalizationMethodType)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
