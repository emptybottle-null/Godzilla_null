    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTNotesMasterIdListEntry.class.getClassLoader());
        ...
        public static CTNotesMasterIdListEntry newInstance() {
            return (CTNotesMasterIdListEntry)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTNotesMasterIdListEntry newInstance(XmlOptions xmlOptions) {
            return (CTNotesMasterIdListEntry)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTNotesMasterIdListEntry parse(String string) throws XmlException {
            return (CTNotesMasterIdListEntry)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTNotesMasterIdListEntry parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTNotesMasterIdListEntry)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTNotesMasterIdListEntry parse(File file) throws XmlException, IOException {
            return (CTNotesMasterIdListEntry)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTNotesMasterIdListEntry parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTNotesMasterIdListEntry)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTNotesMasterIdListEntry parse(URL uRL) throws XmlException, IOException {
            return (CTNotesMasterIdListEntry)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTNotesMasterIdListEntry parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTNotesMasterIdListEntry)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTNotesMasterIdListEntry parse(InputStream inputStream) throws XmlException, IOException {
            return (CTNotesMasterIdListEntry)Factory.getTypeLoader().parse(inputStream, type, null);
        }
        ...
        public static CTNotesMasterIdListEntry parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTNotesMasterIdListEntry)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
