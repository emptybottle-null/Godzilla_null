    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(NotesDocument.class.getClassLoader());
        ...
        public static NotesDocument newInstance() {
            return (NotesDocument)Factory.getTypeLoader().newInstance(type, null);
        }

        public static NotesDocument newInstance(XmlOptions xmlOptions) {
            return (NotesDocument)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static NotesDocument parse(String string) throws XmlException {
            return (NotesDocument)Factory.getTypeLoader().parse(string, type, null);
        }

        public static NotesDocument parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (NotesDocument)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static NotesDocument parse(File file) throws XmlException, IOException {
            return (NotesDocument)Factory.getTypeLoader().parse(file, type, null);
        }

        public static NotesDocument parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (NotesDocument)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static NotesDocument parse(URL uRL) throws XmlException, IOException {
            return (NotesDocument)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static NotesDocument parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (NotesDocument)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static NotesDocument parse(InputStream inputStream) throws XmlException, IOException {
            return (NotesDocument)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static NotesDocument parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (NotesDocument)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static NotesDocument parse(Reader reader) throws XmlException, IOException {
            return (NotesDocument)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static NotesDocument parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (NotesDocument)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static NotesDocument parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (NotesDocument)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static NotesDocument parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (NotesDocument)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static NotesDocument parse(Node node) throws XmlException {
            return (NotesDocument)Factory.getTypeLoader().parse(node, type, null);
        }

        public static NotesDocument parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (NotesDocument)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static NotesDocument parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (NotesDocument)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static NotesDocument parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (NotesDocument)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
