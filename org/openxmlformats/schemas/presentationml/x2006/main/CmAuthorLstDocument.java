...
extends XmlObject {
    ...
    public static final class Factory {
        ...
        public static CmAuthorLstDocument newInstance() {
            return (CmAuthorLstDocument)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CmAuthorLstDocument newInstance(XmlOptions xmlOptions) {
            return (CmAuthorLstDocument)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CmAuthorLstDocument parse(String string) throws XmlException {
            return (CmAuthorLstDocument)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CmAuthorLstDocument parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CmAuthorLstDocument)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CmAuthorLstDocument parse(File file) throws XmlException, IOException {
            return (CmAuthorLstDocument)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CmAuthorLstDocument parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CmAuthorLstDocument)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CmAuthorLstDocument parse(URL uRL) throws XmlException, IOException {
            return (CmAuthorLstDocument)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CmAuthorLstDocument parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CmAuthorLstDocument)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CmAuthorLstDocument parse(InputStream inputStream) throws XmlException, IOException {
            return (CmAuthorLstDocument)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CmAuthorLstDocument parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CmAuthorLstDocument)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CmAuthorLstDocument parse(Reader reader) throws XmlException, IOException {
            return (CmAuthorLstDocument)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CmAuthorLstDocument parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CmAuthorLstDocument)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CmAuthorLstDocument parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CmAuthorLstDocument)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CmAuthorLstDocument parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CmAuthorLstDocument)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CmAuthorLstDocument parse(Node node) throws XmlException {
            return (CmAuthorLstDocument)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CmAuthorLstDocument parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CmAuthorLstDocument)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CmAuthorLstDocument parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CmAuthorLstDocument)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CmAuthorLstDocument parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CmAuthorLstDocument)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
