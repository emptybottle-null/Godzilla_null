...
extends XmlObject {
    public static final SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CTConnectorNonVisual.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sD023D6490046BA0250A839A9AD24C443").resolveHandle("ctconnectornonvisual0f45type");
    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTConnectorNonVisual.class.getClassLoader());
        ...
        public static CTConnectorNonVisual newInstance() {
            return (CTConnectorNonVisual)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTConnectorNonVisual newInstance(XmlOptions xmlOptions) {
            return (CTConnectorNonVisual)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTConnectorNonVisual parse(String string) throws XmlException {
            return (CTConnectorNonVisual)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTConnectorNonVisual parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTConnectorNonVisual)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTConnectorNonVisual parse(File file) throws XmlException, IOException {
            return (CTConnectorNonVisual)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTConnectorNonVisual parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTConnectorNonVisual)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTConnectorNonVisual parse(URL uRL) throws XmlException, IOException {
            return (CTConnectorNonVisual)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTConnectorNonVisual parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTConnectorNonVisual)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTConnectorNonVisual parse(InputStream inputStream) throws XmlException, IOException {
            return (CTConnectorNonVisual)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTConnectorNonVisual parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTConnectorNonVisual)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTConnectorNonVisual parse(Reader reader) throws XmlException, IOException {
            return (CTConnectorNonVisual)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTConnectorNonVisual parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTConnectorNonVisual)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTConnectorNonVisual parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTConnectorNonVisual)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTConnectorNonVisual parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTConnectorNonVisual)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTConnectorNonVisual parse(Node node) throws XmlException {
            return (CTConnectorNonVisual)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTConnectorNonVisual parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTConnectorNonVisual)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTConnectorNonVisual parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTConnectorNonVisual)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTConnectorNonVisual parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTConnectorNonVisual)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
