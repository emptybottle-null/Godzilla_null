    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(SldDocument.class.getClassLoader());
        ...
        public static SldDocument newInstance() {
            return (SldDocument)Factory.getTypeLoader().newInstance(type, null);
        }

        public static SldDocument newInstance(XmlOptions xmlOptions) {
            return (SldDocument)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static SldDocument parse(String string) throws XmlException {
            return (SldDocument)Factory.getTypeLoader().parse(string, type, null);
        }

        public static SldDocument parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (SldDocument)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static SldDocument parse(File file) throws XmlException, IOException {
            return (SldDocument)Factory.getTypeLoader().parse(file, type, null);
        }

        public static SldDocument parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (SldDocument)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static SldDocument parse(URL uRL) throws XmlException, IOException {
            return (SldDocument)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static SldDocument parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (SldDocument)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static SldDocument parse(InputStream inputStream) throws XmlException, IOException {
            return (SldDocument)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static SldDocument parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (SldDocument)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static SldDocument parse(Reader reader) throws XmlException, IOException {
            return (SldDocument)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static SldDocument parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (SldDocument)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static SldDocument parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (SldDocument)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static SldDocument parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (SldDocument)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static SldDocument parse(Node node) throws XmlException {
            return (SldDocument)Factory.getTypeLoader().parse(node, type, null);
        }

        public static SldDocument parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (SldDocument)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static SldDocument parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (SldDocument)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static SldDocument parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (SldDocument)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
