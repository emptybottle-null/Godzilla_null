...
extends XmlObject {
    ...
    public static final class Factory {
        ...
        public static SldMasterDocument newInstance() {
            return (SldMasterDocument)Factory.getTypeLoader().newInstance(type, null);
        }

        public static SldMasterDocument newInstance(XmlOptions xmlOptions) {
            return (SldMasterDocument)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static SldMasterDocument parse(String string) throws XmlException {
            return (SldMasterDocument)Factory.getTypeLoader().parse(string, type, null);
        }

        public static SldMasterDocument parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (SldMasterDocument)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static SldMasterDocument parse(File file) throws XmlException, IOException {
            return (SldMasterDocument)Factory.getTypeLoader().parse(file, type, null);
        }

        public static SldMasterDocument parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (SldMasterDocument)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static SldMasterDocument parse(URL uRL) throws XmlException, IOException {
            return (SldMasterDocument)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static SldMasterDocument parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (SldMasterDocument)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static SldMasterDocument parse(InputStream inputStream) throws XmlException, IOException {
            return (SldMasterDocument)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static SldMasterDocument parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (SldMasterDocument)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static SldMasterDocument parse(Reader reader) throws XmlException, IOException {
            return (SldMasterDocument)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static SldMasterDocument parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (SldMasterDocument)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static SldMasterDocument parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (SldMasterDocument)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static SldMasterDocument parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (SldMasterDocument)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static SldMasterDocument parse(Node node) throws XmlException {
            return (SldMasterDocument)Factory.getTypeLoader().parse(node, type, null);
        }

        public static SldMasterDocument parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (SldMasterDocument)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static SldMasterDocument parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (SldMasterDocument)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static SldMasterDocument parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (SldMasterDocument)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
