...
public interface STWrapDistance
extends XmlUnsignedInt {
    ...
    public static final class Factory {
        ...
        public static STWrapDistance newValue(Object object) {
            return (STWrapDistance)type.newValue(object);
        }
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(STWrapDistance.class.getClassLoader());
        ...
        public static STWrapDistance newInstance() {
            return (STWrapDistance)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STWrapDistance newInstance(XmlOptions xmlOptions) {
            return (STWrapDistance)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STWrapDistance parse(String string) throws XmlException {
            return (STWrapDistance)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STWrapDistance parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STWrapDistance)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STWrapDistance parse(File file) throws XmlException, IOException {
            return (STWrapDistance)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STWrapDistance parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STWrapDistance)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STWrapDistance parse(URL uRL) throws XmlException, IOException {
            return (STWrapDistance)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STWrapDistance parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STWrapDistance)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STWrapDistance parse(InputStream inputStream) throws XmlException, IOException {
            return (STWrapDistance)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static STWrapDistance parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STWrapDistance)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static STWrapDistance parse(Reader reader) throws XmlException, IOException {
            return (STWrapDistance)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static STWrapDistance parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STWrapDistance)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static STWrapDistance parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STWrapDistance)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static STWrapDistance parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STWrapDistance)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static STWrapDistance parse(Node node) throws XmlException {
            return (STWrapDistance)Factory.getTypeLoader().parse(node, type, null);
        }

        public static STWrapDistance parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STWrapDistance)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static STWrapDistance parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (STWrapDistance)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static STWrapDistance parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STWrapDistance)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
