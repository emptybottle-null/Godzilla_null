...
extends XmlObject {
    ...
    public static final class Factory {
        ...
        public static CTGroupShapeNonVisual newInstance() {
            return (CTGroupShapeNonVisual)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTGroupShapeNonVisual newInstance(XmlOptions xmlOptions) {
            return (CTGroupShapeNonVisual)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTGroupShapeNonVisual parse(String string) throws XmlException {
            return (CTGroupShapeNonVisual)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTGroupShapeNonVisual parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTGroupShapeNonVisual)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTGroupShapeNonVisual parse(File file) throws XmlException, IOException {
            return (CTGroupShapeNonVisual)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTGroupShapeNonVisual parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTGroupShapeNonVisual)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTGroupShapeNonVisual parse(URL uRL) throws XmlException, IOException {
            return (CTGroupShapeNonVisual)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTGroupShapeNonVisual parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTGroupShapeNonVisual)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTGroupShapeNonVisual parse(InputStream inputStream) throws XmlException, IOException {
            return (CTGroupShapeNonVisual)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTGroupShapeNonVisual parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTGroupShapeNonVisual)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTGroupShapeNonVisual parse(Reader reader) throws XmlException, IOException {
            return (CTGroupShapeNonVisual)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTGroupShapeNonVisual parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTGroupShapeNonVisual)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTGroupShapeNonVisual parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTGroupShapeNonVisual)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTGroupShapeNonVisual parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTGroupShapeNonVisual)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTGroupShapeNonVisual parse(Node node) throws XmlException {
            return (CTGroupShapeNonVisual)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTGroupShapeNonVisual parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTGroupShapeNonVisual)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTGroupShapeNonVisual parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTGroupShapeNonVisual)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTGroupShapeNonVisual parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTGroupShapeNonVisual)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
