    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTNumDataSource.class.getClassLoader());
        ...
        public static CTNumDataSource newInstance() {
            return (CTNumDataSource)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTNumDataSource newInstance(XmlOptions xmlOptions) {
            return (CTNumDataSource)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTNumDataSource parse(String string) throws XmlException {
            return (CTNumDataSource)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTNumDataSource parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTNumDataSource)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTNumDataSource parse(File file) throws XmlException, IOException {
            return (CTNumDataSource)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTNumDataSource parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTNumDataSource)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTNumDataSource parse(URL uRL) throws XmlException, IOException {
            return (CTNumDataSource)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTNumDataSource parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTNumDataSource)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTNumDataSource parse(InputStream inputStream) throws XmlException, IOException {
            return (CTNumDataSource)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTNumDataSource parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTNumDataSource)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTNumDataSource parse(Reader reader) throws XmlException, IOException {
            return (CTNumDataSource)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTNumDataSource parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTNumDataSource)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTNumDataSource parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTNumDataSource)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTNumDataSource parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTNumDataSource)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTNumDataSource parse(Node node) throws XmlException {
            return (CTNumDataSource)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTNumDataSource parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTNumDataSource)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTNumDataSource parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTNumDataSource)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTNumDataSource parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTNumDataSource)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
