...
implements CTAreaChart {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTAreaSer> {
                ...
                public CTAreaSer set(int n, CTAreaSer cTAreaSer) {
                    CTAreaSer cTAreaSer2 = CTAreaChartImpl.this.getSerArray(n);
                ...
                public void add(int n, CTAreaSer cTAreaSer) {
                    CTAreaChartImpl.this.insertNewSer(n).set(cTAreaSer);
                }

                @Override
                public CTAreaSer remove(int n) {
                    CTAreaSer cTAreaSer = CTAreaChartImpl.this.getSerArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTUnsignedInt> {
                ...
                public CTUnsignedInt set(int n, CTUnsignedInt cTUnsignedInt) {
                    CTUnsignedInt cTUnsignedInt2 = CTAreaChartImpl.this.getAxIdArray(n);
                ...
                public void add(int n, CTUnsignedInt cTUnsignedInt) {
                    CTAreaChartImpl.this.insertNewAxId(n).set(cTUnsignedInt);
                }

                @Override
                public CTUnsignedInt remove(int n) {
                    CTUnsignedInt cTUnsignedInt = CTAreaChartImpl.this.getAxIdArray(n);
    ...
    public CTUnsignedInt[] getAxIdArray() {
        ...
        synchronized (object) {
            this.check_orphaned();
            ArrayList arrayList = new ArrayList();
            this.get_store().find_all_element_users(AXID$10, arrayList);
    ...
    public CTUnsignedInt getAxIdArray(int n) {
        ...
        synchronized (object) {
            ...
            cTUnsignedInt = (CTUnsignedInt)((Object)this.get_store().find_element_user(AXID$10, n));
    ...
    public int sizeOfAxIdArray() {
        ...
        synchronized (object) {
            this.check_orphaned();
            return this.get_store().count_elements(AXID$10);
        }
    }
    ...
    public void setAxIdArray(CTUnsignedInt[] cTUnsignedIntArray) {
        this.check_orphaned();
        this.arraySetterHelper(cTUnsignedIntArray, AXID$10);
    }

    @Override
    public void setAxIdArray(int n, CTUnsignedInt cTUnsignedInt) {
        this.generatedSetterHelperImpl(cTUnsignedInt, AXID$10, n, (short)2);
    }
    ...
    public CTUnsignedInt insertNewAxId(int n) {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTUnsignedInt cTUnsignedInt = null;
            cTUnsignedInt = (CTUnsignedInt)((Object)this.get_store().insert_element_user(AXID$10, n));
            return cTUnsignedInt;
        }
    }
    ...
    public CTUnsignedInt addNewAxId() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTUnsignedInt cTUnsignedInt = null;
            cTUnsignedInt = (CTUnsignedInt)((Object)this.get_store().add_element_user(AXID$10));
            return cTUnsignedInt;
        }
    }
    ...
    public void removeAxId(int n) {
        ...
        synchronized (object) {
            this.check_orphaned();
            this.get_store().remove_element(AXID$10, n);
        }
    }
