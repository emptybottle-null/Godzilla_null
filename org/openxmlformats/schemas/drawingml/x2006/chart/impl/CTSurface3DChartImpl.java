        ...
        synchronized (object) {
            ...
            extends AbstractList<CTSurfaceSer> {
                ...
                public CTSurfaceSer set(int n, CTSurfaceSer cTSurfaceSer) {
                    CTSurfaceSer cTSurfaceSer2 = CTSurface3DChartImpl.this.getSerArray(n);
                ...
                public void add(int n, CTSurfaceSer cTSurfaceSer) {
                    CTSurface3DChartImpl.this.insertNewSer(n).set(cTSurfaceSer);
                }

                @Override
                public CTSurfaceSer remove(int n) {
                    CTSurfaceSer cTSurfaceSer = CTSurface3DChartImpl.this.getSerArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTUnsignedInt> {
                ...
                public CTUnsignedInt set(int n, CTUnsignedInt cTUnsignedInt) {
                    CTUnsignedInt cTUnsignedInt2 = CTSurface3DChartImpl.this.getAxIdArray(n);
                ...
                public void add(int n, CTUnsignedInt cTUnsignedInt) {
                    CTSurface3DChartImpl.this.insertNewAxId(n).set(cTUnsignedInt);
                }

                @Override
                public CTUnsignedInt remove(int n) {
                    CTUnsignedInt cTUnsignedInt = CTSurface3DChartImpl.this.getAxIdArray(n);
