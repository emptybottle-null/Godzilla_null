...
implements CTDoughnutChart {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPieSer> {
                ...
                public CTPieSer set(int n, CTPieSer cTPieSer) {
                    CTPieSer cTPieSer2 = CTDoughnutChartImpl.this.getSerArray(n);
                ...
                public void add(int n, CTPieSer cTPieSer) {
                    CTDoughnutChartImpl.this.insertNewSer(n).set(cTPieSer);
                }

                @Override
                public CTPieSer remove(int n) {
                    CTPieSer cTPieSer = CTDoughnutChartImpl.this.getSerArray(n);
    ...
    public CTHoleSize getHoleSize() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTHoleSize cTHoleSize = null;
            cTHoleSize = (CTHoleSize)this.get_store().find_element_user(HOLESIZE$8, 0);
            if (cTHoleSize == null) {
                return null;
            }
            return cTHoleSize;
    ...
    public boolean isSetHoleSize() {
        ...
        synchronized (object) {
            this.check_orphaned();
            return this.get_store().count_elements(HOLESIZE$8) != 0;
        }
    }

    @Override
    public void setHoleSize(CTHoleSize cTHoleSize) {
        this.generatedSetterHelperImpl((XmlObject)cTHoleSize, HOLESIZE$8, 0, (short)1);
    }
    ...
    public CTHoleSize addNewHoleSize() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTHoleSize cTHoleSize = null;
            cTHoleSize = (CTHoleSize)this.get_store().add_element_user(HOLESIZE$8);
            return cTHoleSize;
        }
    }
    ...
    public void unsetHoleSize() {
        ...
        synchronized (object) {
            this.check_orphaned();
            this.get_store().remove_element(HOLESIZE$8, 0);
        }
    }
