...
implements CTFirstSliceAng {
    ...
    public STFirstSliceAng xgetVal() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STFirstSliceAng sTFirstSliceAng = null;
            sTFirstSliceAng = (STFirstSliceAng)this.get_store().find_attribute_user(VAL$0);
            if (sTFirstSliceAng == null) {
                sTFirstSliceAng = (STFirstSliceAng)this.get_default_attribute_value(VAL$0);
            }
    ...
    public void xsetVal(STFirstSliceAng sTFirstSliceAng) {
        ...
        synchronized (object) {
            this.check_orphaned();
            STFirstSliceAng sTFirstSliceAng2 = null;
            sTFirstSliceAng2 = (STFirstSliceAng)this.get_store().find_attribute_user(VAL$0);
            if (sTFirstSliceAng2 == null) {
                sTFirstSliceAng2 = (STFirstSliceAng)this.get_store().add_attribute_user(VAL$0);
            }
