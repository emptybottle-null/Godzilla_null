...
implements CTRotX {
    ...
    public STRotX xgetVal() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STRotX sTRotX = null;
            sTRotX = (STRotX)this.get_store().find_attribute_user(VAL$0);
            if (sTRotX == null) {
                sTRotX = (STRotX)this.get_default_attribute_value(VAL$0);
            }
            return sTRotX;
        }
    }
    ...
    public void xsetVal(STRotX sTRotX) {
        ...
        synchronized (object) {
            this.check_orphaned();
            STRotX sTRotX2 = null;
            sTRotX2 = (STRotX)this.get_store().find_attribute_user(VAL$0);
            if (sTRotX2 == null) {
                sTRotX2 = (STRotX)this.get_store().add_attribute_user(VAL$0);
            }
