        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPieSer> {
                ...
                public CTPieSer set(int n, CTPieSer cTPieSer) {
                    CTPieSer cTPieSer2 = CTPie3DChartImpl.this.getSerArray(n);
                ...
                public void add(int n, CTPieSer cTPieSer) {
                    CTPie3DChartImpl.this.insertNewSer(n).set(cTPieSer);
                }

                @Override
                public CTPieSer remove(int n) {
                    CTPieSer cTPieSer = CTPie3DChartImpl.this.getSerArray(n);
