...
implements CTLineSer {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTDPt> {
                ...
                public CTDPt set(int n, CTDPt cTDPt) {
                    CTDPt cTDPt2 = CTLineSerImpl.this.getDPtArray(n);
                ...
                public CTDPt remove(int n) {
                    CTDPt cTDPt = CTLineSerImpl.this.getDPtArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTTrendline> {
                ...
                public CTTrendline set(int n, CTTrendline cTTrendline) {
                    CTTrendline cTTrendline2 = CTLineSerImpl.this.getTrendlineArray(n);
                ...
                public CTTrendline remove(int n) {
                    CTTrendline cTTrendline = CTLineSerImpl.this.getTrendlineArray(n);
    ...
    public CTErrBars getErrBars() {
        ...
        synchronized (object) {
            ...
            cTErrBars = (CTErrBars)((Object)this.get_store().find_element_user(ERRBARS$16, 0));
            if (cTErrBars == null) {
                return null;
            }
            return cTErrBars;
    ...
    public void setErrBars(CTErrBars cTErrBars) {
        this.generatedSetterHelperImpl(cTErrBars, ERRBARS$16, 0, (short)1);
    }
