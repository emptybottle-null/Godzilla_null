...
implements CTAreaSer {
    ...
    private static final QName PICTUREOPTIONS$8 = new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "pictureOptions");
    ...
    private static final QName EXTLST$22 = new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "extLst");
    ...
    public CTPictureOptions getPictureOptions() {
        ...
        synchronized (object) {
            ...
            cTPictureOptions = (CTPictureOptions)this.get_store().find_element_user(PICTUREOPTIONS$8, 0);
    ...
    public boolean isSetPictureOptions() {
        ...
        synchronized (object) {
            this.check_orphaned();
            return this.get_store().count_elements(PICTUREOPTIONS$8) != 0;
        }
    }

    @Override
    public void setPictureOptions(CTPictureOptions cTPictureOptions) {
        this.generatedSetterHelperImpl((XmlObject)cTPictureOptions, PICTUREOPTIONS$8, 0, (short)1);
    }
    ...
    public CTPictureOptions addNewPictureOptions() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTPictureOptions cTPictureOptions = null;
            cTPictureOptions = (CTPictureOptions)this.get_store().add_element_user(PICTUREOPTIONS$8);
            return cTPictureOptions;
        }
    }
    ...
    public void unsetPictureOptions() {
        ...
        synchronized (object) {
            this.check_orphaned();
            this.get_store().remove_element(PICTUREOPTIONS$8, 0);
        }
    }
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTDPt> {
                ...
                public CTDPt set(int n, CTDPt cTDPt) {
                    CTDPt cTDPt2 = CTAreaSerImpl.this.getDPtArray(n);
                ...
                public CTDPt remove(int n) {
                    CTDPt cTDPt = CTAreaSerImpl.this.getDPtArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTTrendline> {
                ...
                public CTTrendline set(int n, CTTrendline cTTrendline) {
                    CTTrendline cTTrendline2 = CTAreaSerImpl.this.getTrendlineArray(n);
                ...
                public CTTrendline remove(int n) {
                    CTTrendline cTTrendline = CTAreaSerImpl.this.getTrendlineArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTErrBars> {
                ...
                public CTErrBars set(int n, CTErrBars cTErrBars) {
                    CTErrBars cTErrBars2 = CTAreaSerImpl.this.getErrBarsArray(n);
                ...
                public void add(int n, CTErrBars cTErrBars) {
                    CTAreaSerImpl.this.insertNewErrBars(n).set(cTErrBars);
                }

                @Override
                public CTErrBars remove(int n) {
                    CTErrBars cTErrBars = CTAreaSerImpl.this.getErrBarsArray(n);
    ...
    public CTAxDataSource getCat() {
        ...
        synchronized (object) {
            ...
            cTAxDataSource = (CTAxDataSource)((Object)this.get_store().find_element_user(CAT$18, 0));
    ...
    public void setCat(CTAxDataSource cTAxDataSource) {
        this.generatedSetterHelperImpl(cTAxDataSource, CAT$18, 0, (short)1);
    }
    ...
    public CTAxDataSource addNewCat() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTAxDataSource cTAxDataSource = null;
            cTAxDataSource = (CTAxDataSource)((Object)this.get_store().add_element_user(CAT$18));
            return cTAxDataSource;
        }
    }
    ...
    public CTNumDataSource getVal() {
        ...
        synchronized (object) {
            ...
            cTNumDataSource = (CTNumDataSource)((Object)this.get_store().find_element_user(VAL$20, 0));
    ...
    public void setVal(CTNumDataSource cTNumDataSource) {
        this.generatedSetterHelperImpl(cTNumDataSource, VAL$20, 0, (short)1);
    }
    ...
    public CTNumDataSource addNewVal() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTNumDataSource cTNumDataSource = null;
            cTNumDataSource = (CTNumDataSource)((Object)this.get_store().add_element_user(VAL$20));
            return cTNumDataSource;
        }
    }
    ...
    public CTExtensionList getExtLst() {
        ...
        synchronized (object) {
            ...
            cTExtensionList = (CTExtensionList)((Object)this.get_store().find_element_user(EXTLST$22, 0));
    ...
    public void setExtLst(CTExtensionList cTExtensionList) {
        this.generatedSetterHelperImpl(cTExtensionList, EXTLST$22, 0, (short)1);
    }
    ...
    public CTExtensionList addNewExtLst() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTExtensionList cTExtensionList = null;
            cTExtensionList = (CTExtensionList)((Object)this.get_store().add_element_user(EXTLST$22));
            return cTExtensionList;
        }
    }
