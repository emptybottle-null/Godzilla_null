    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTLayout.class.getClassLoader());
        ...
        public static CTLayout newInstance() {
            return (CTLayout)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTLayout newInstance(XmlOptions xmlOptions) {
            return (CTLayout)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTLayout parse(String string) throws XmlException {
            return (CTLayout)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTLayout parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTLayout)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTLayout parse(File file) throws XmlException, IOException {
            return (CTLayout)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTLayout parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTLayout)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTLayout parse(URL uRL) throws XmlException, IOException {
            return (CTLayout)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTLayout parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTLayout)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTLayout parse(InputStream inputStream) throws XmlException, IOException {
            return (CTLayout)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTLayout parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTLayout)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTLayout parse(Reader reader) throws XmlException, IOException {
            return (CTLayout)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTLayout parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTLayout)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTLayout parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTLayout)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTLayout parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTLayout)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTLayout parse(Node node) throws XmlException {
            return (CTLayout)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTLayout parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTLayout)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTLayout parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTLayout)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static CTLayout parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTLayout)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
