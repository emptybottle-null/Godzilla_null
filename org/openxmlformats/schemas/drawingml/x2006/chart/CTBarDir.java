...
extends XmlObject {
    ...
    public static final class Factory {
        ...
        public static CTBarDir newInstance() {
            return (CTBarDir)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTBarDir newInstance(XmlOptions xmlOptions) {
            return (CTBarDir)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTBarDir parse(String string) throws XmlException {
            return (CTBarDir)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTBarDir parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTBarDir)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTBarDir parse(File file) throws XmlException, IOException {
            return (CTBarDir)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTBarDir parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTBarDir)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTBarDir parse(URL uRL) throws XmlException, IOException {
            return (CTBarDir)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTBarDir parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTBarDir)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTBarDir parse(InputStream inputStream) throws XmlException, IOException {
            return (CTBarDir)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTBarDir parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTBarDir)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTBarDir parse(Reader reader) throws XmlException, IOException {
            return (CTBarDir)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTBarDir parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTBarDir)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTBarDir parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTBarDir)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTBarDir parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTBarDir)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTBarDir parse(Node node) throws XmlException {
            return (CTBarDir)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTBarDir parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTBarDir)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTBarDir parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTBarDir)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static CTBarDir parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTBarDir)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
