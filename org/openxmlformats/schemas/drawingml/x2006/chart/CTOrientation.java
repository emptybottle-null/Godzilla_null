    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTOrientation.class.getClassLoader());
        ...
        public static CTOrientation newInstance() {
            return (CTOrientation)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTOrientation newInstance(XmlOptions xmlOptions) {
            return (CTOrientation)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTOrientation parse(String string) throws XmlException {
            return (CTOrientation)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTOrientation parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTOrientation)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTOrientation parse(File file) throws XmlException, IOException {
            return (CTOrientation)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTOrientation parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTOrientation)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTOrientation parse(URL uRL) throws XmlException, IOException {
            return (CTOrientation)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTOrientation parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTOrientation)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTOrientation parse(InputStream inputStream) throws XmlException, IOException {
            return (CTOrientation)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTOrientation parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTOrientation)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTOrientation parse(Reader reader) throws XmlException, IOException {
            return (CTOrientation)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTOrientation parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTOrientation)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTOrientation parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTOrientation)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTOrientation parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTOrientation)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTOrientation parse(Node node) throws XmlException {
            return (CTOrientation)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTOrientation parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTOrientation)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTOrientation parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTOrientation)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTOrientation parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTOrientation)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
