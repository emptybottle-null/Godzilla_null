...
extends XmlString {
    ...
    public static final class Factory {
        ...
        public static STTickMark newValue(Object object) {
            return (STTickMark)type.newValue(object);
        }
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(STTickMark.class.getClassLoader());
        ...
        public static STTickMark newInstance() {
            return (STTickMark)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STTickMark newInstance(XmlOptions xmlOptions) {
            return (STTickMark)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STTickMark parse(String string) throws XmlException {
            return (STTickMark)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STTickMark parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STTickMark)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STTickMark parse(File file) throws XmlException, IOException {
            return (STTickMark)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STTickMark parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTickMark)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STTickMark parse(URL uRL) throws XmlException, IOException {
            return (STTickMark)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STTickMark parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTickMark)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STTickMark parse(InputStream inputStream) throws XmlException, IOException {
            return (STTickMark)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static STTickMark parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTickMark)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static STTickMark parse(Reader reader) throws XmlException, IOException {
            return (STTickMark)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static STTickMark parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTickMark)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static STTickMark parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STTickMark)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static STTickMark parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STTickMark)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static STTickMark parse(Node node) throws XmlException {
            return (STTickMark)Factory.getTypeLoader().parse(node, type, null);
        }

        public static STTickMark parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STTickMark)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static STTickMark parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (STTickMark)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static STTickMark parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STTickMark)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
