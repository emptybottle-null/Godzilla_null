    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTScatterStyle.class.getClassLoader());
        ...
        public static CTScatterStyle newInstance() {
            return (CTScatterStyle)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTScatterStyle newInstance(XmlOptions xmlOptions) {
            return (CTScatterStyle)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTScatterStyle parse(String string) throws XmlException {
            return (CTScatterStyle)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTScatterStyle parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTScatterStyle)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTScatterStyle parse(File file) throws XmlException, IOException {
            return (CTScatterStyle)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTScatterStyle parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTScatterStyle)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTScatterStyle parse(URL uRL) throws XmlException, IOException {
            return (CTScatterStyle)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTScatterStyle parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTScatterStyle)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTScatterStyle parse(InputStream inputStream) throws XmlException, IOException {
            return (CTScatterStyle)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTScatterStyle parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTScatterStyle)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTScatterStyle parse(Reader reader) throws XmlException, IOException {
            return (CTScatterStyle)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTScatterStyle parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTScatterStyle)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTScatterStyle parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTScatterStyle)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTScatterStyle parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTScatterStyle)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTScatterStyle parse(Node node) throws XmlException {
            return (CTScatterStyle)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTScatterStyle parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTScatterStyle)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTScatterStyle parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTScatterStyle)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTScatterStyle parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTScatterStyle)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
