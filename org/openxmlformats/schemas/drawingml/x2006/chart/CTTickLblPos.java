    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTTickLblPos.class.getClassLoader());
        ...
        public static CTTickLblPos newInstance() {
            return (CTTickLblPos)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTTickLblPos newInstance(XmlOptions xmlOptions) {
            return (CTTickLblPos)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTTickLblPos parse(String string) throws XmlException {
            return (CTTickLblPos)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTTickLblPos parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTTickLblPos)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTTickLblPos parse(File file) throws XmlException, IOException {
            return (CTTickLblPos)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTTickLblPos parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTickLblPos)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTTickLblPos parse(URL uRL) throws XmlException, IOException {
            return (CTTickLblPos)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTTickLblPos parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTickLblPos)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTTickLblPos parse(InputStream inputStream) throws XmlException, IOException {
            return (CTTickLblPos)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTTickLblPos parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTickLblPos)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTTickLblPos parse(Reader reader) throws XmlException, IOException {
            return (CTTickLblPos)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTTickLblPos parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTickLblPos)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTTickLblPos parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTTickLblPos)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTTickLblPos parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTTickLblPos)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTTickLblPos parse(Node node) throws XmlException {
            return (CTTickLblPos)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTTickLblPos parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTTickLblPos)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTTickLblPos parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTTickLblPos)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTTickLblPos parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTTickLblPos)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
