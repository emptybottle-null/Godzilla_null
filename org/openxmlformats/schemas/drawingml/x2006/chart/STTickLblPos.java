...
extends XmlString {
    ...
    public static final class Factory {
        ...
        public static STTickLblPos newValue(Object object) {
            return (STTickLblPos)type.newValue(object);
        }
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(STTickLblPos.class.getClassLoader());
        ...
        public static STTickLblPos newInstance() {
            return (STTickLblPos)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STTickLblPos newInstance(XmlOptions xmlOptions) {
            return (STTickLblPos)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STTickLblPos parse(String string) throws XmlException {
            return (STTickLblPos)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STTickLblPos parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STTickLblPos)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STTickLblPos parse(File file) throws XmlException, IOException {
            return (STTickLblPos)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STTickLblPos parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTickLblPos)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STTickLblPos parse(URL uRL) throws XmlException, IOException {
            return (STTickLblPos)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STTickLblPos parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTickLblPos)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STTickLblPos parse(InputStream inputStream) throws XmlException, IOException {
            return (STTickLblPos)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static STTickLblPos parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTickLblPos)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static STTickLblPos parse(Reader reader) throws XmlException, IOException {
            return (STTickLblPos)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static STTickLblPos parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTickLblPos)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static STTickLblPos parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STTickLblPos)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static STTickLblPos parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STTickLblPos)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static STTickLblPos parse(Node node) throws XmlException {
            return (STTickLblPos)Factory.getTypeLoader().parse(node, type, null);
        }

        public static STTickLblPos parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STTickLblPos)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static STTickLblPos parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (STTickLblPos)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static STTickLblPos parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STTickLblPos)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
