    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTLayoutMode.class.getClassLoader());
        ...
        public static CTLayoutMode newInstance() {
            return (CTLayoutMode)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTLayoutMode newInstance(XmlOptions xmlOptions) {
            return (CTLayoutMode)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTLayoutMode parse(String string) throws XmlException {
            return (CTLayoutMode)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTLayoutMode parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTLayoutMode)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTLayoutMode parse(File file) throws XmlException, IOException {
            return (CTLayoutMode)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTLayoutMode parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTLayoutMode)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTLayoutMode parse(URL uRL) throws XmlException, IOException {
            return (CTLayoutMode)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTLayoutMode parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTLayoutMode)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTLayoutMode parse(InputStream inputStream) throws XmlException, IOException {
            return (CTLayoutMode)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTLayoutMode parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTLayoutMode)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTLayoutMode parse(Reader reader) throws XmlException, IOException {
            return (CTLayoutMode)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTLayoutMode parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTLayoutMode)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTLayoutMode parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTLayoutMode)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTLayoutMode parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTLayoutMode)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTLayoutMode parse(Node node) throws XmlException {
            return (CTLayoutMode)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTLayoutMode parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTLayoutMode)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTLayoutMode parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTLayoutMode)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTLayoutMode parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTLayoutMode)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
