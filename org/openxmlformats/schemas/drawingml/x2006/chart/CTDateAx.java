    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTDateAx.class.getClassLoader());
        ...
        public static CTDateAx newInstance() {
            return (CTDateAx)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTDateAx newInstance(XmlOptions xmlOptions) {
            return (CTDateAx)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTDateAx parse(String string) throws XmlException {
            return (CTDateAx)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTDateAx parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTDateAx)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTDateAx parse(File file) throws XmlException, IOException {
            return (CTDateAx)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTDateAx parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTDateAx)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTDateAx parse(URL uRL) throws XmlException, IOException {
            return (CTDateAx)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTDateAx parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTDateAx)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTDateAx parse(InputStream inputStream) throws XmlException, IOException {
            return (CTDateAx)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTDateAx parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTDateAx)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTDateAx parse(Reader reader) throws XmlException, IOException {
            return (CTDateAx)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTDateAx parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTDateAx)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTDateAx parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTDateAx)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTDateAx parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTDateAx)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTDateAx parse(Node node) throws XmlException {
            return (CTDateAx)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTDateAx parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTDateAx)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTDateAx parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTDateAx)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static CTDateAx parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTDateAx)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
