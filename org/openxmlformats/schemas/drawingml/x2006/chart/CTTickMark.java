    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTTickMark.class.getClassLoader());
        ...
        public static CTTickMark newInstance() {
            return (CTTickMark)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTTickMark newInstance(XmlOptions xmlOptions) {
            return (CTTickMark)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTTickMark parse(String string) throws XmlException {
            return (CTTickMark)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTTickMark parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTTickMark)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTTickMark parse(File file) throws XmlException, IOException {
            return (CTTickMark)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTTickMark parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTickMark)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTTickMark parse(URL uRL) throws XmlException, IOException {
            return (CTTickMark)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTTickMark parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTickMark)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTTickMark parse(InputStream inputStream) throws XmlException, IOException {
            return (CTTickMark)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTTickMark parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTickMark)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTTickMark parse(Reader reader) throws XmlException, IOException {
            return (CTTickMark)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTTickMark parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTickMark)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTTickMark parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTTickMark)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTTickMark parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTTickMark)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTTickMark parse(Node node) throws XmlException {
            return (CTTickMark)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTTickMark parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTTickMark)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTTickMark parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTTickMark)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTTickMark parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTTickMark)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
