    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTBackgroundFillStyleList.class.getClassLoader());
        ...
        public static CTBackgroundFillStyleList newInstance() {
            return (CTBackgroundFillStyleList)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTBackgroundFillStyleList newInstance(XmlOptions xmlOptions) {
            return (CTBackgroundFillStyleList)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTBackgroundFillStyleList parse(String string) throws XmlException {
            return (CTBackgroundFillStyleList)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTBackgroundFillStyleList parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTBackgroundFillStyleList)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTBackgroundFillStyleList parse(File file) throws XmlException, IOException {
            return (CTBackgroundFillStyleList)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTBackgroundFillStyleList parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTBackgroundFillStyleList)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTBackgroundFillStyleList parse(URL uRL) throws XmlException, IOException {
            return (CTBackgroundFillStyleList)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTBackgroundFillStyleList parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTBackgroundFillStyleList)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTBackgroundFillStyleList parse(InputStream inputStream) throws XmlException, IOException {
            return (CTBackgroundFillStyleList)Factory.getTypeLoader().parse(inputStream, type, null);
        }
        ...
        public static CTBackgroundFillStyleList parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTBackgroundFillStyleList)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
