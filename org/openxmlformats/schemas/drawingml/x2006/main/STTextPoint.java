...
extends XmlInt {
    ...
    public static final class Factory {
        ...
        public static STTextPoint newValue(Object object) {
            return (STTextPoint)type.newValue(object);
        }
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(STTextPoint.class.getClassLoader());
        ...
        public static STTextPoint newInstance() {
            return (STTextPoint)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STTextPoint newInstance(XmlOptions xmlOptions) {
            return (STTextPoint)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STTextPoint parse(String string) throws XmlException {
            return (STTextPoint)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STTextPoint parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STTextPoint)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STTextPoint parse(File file) throws XmlException, IOException {
            return (STTextPoint)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STTextPoint parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTextPoint)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STTextPoint parse(URL uRL) throws XmlException, IOException {
            return (STTextPoint)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STTextPoint parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTextPoint)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STTextPoint parse(InputStream inputStream) throws XmlException, IOException {
            return (STTextPoint)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static STTextPoint parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTextPoint)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static STTextPoint parse(Reader reader) throws XmlException, IOException {
            return (STTextPoint)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static STTextPoint parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTextPoint)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static STTextPoint parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STTextPoint)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static STTextPoint parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STTextPoint)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static STTextPoint parse(Node node) throws XmlException {
            return (STTextPoint)Factory.getTypeLoader().parse(node, type, null);
        }

        public static STTextPoint parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STTextPoint)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static STTextPoint parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (STTextPoint)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static STTextPoint parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STTextPoint)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
