    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTTextSpacing.class.getClassLoader());
        ...
        public static CTTextSpacing newInstance() {
            return (CTTextSpacing)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTTextSpacing newInstance(XmlOptions xmlOptions) {
            return (CTTextSpacing)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTTextSpacing parse(String string) throws XmlException {
            return (CTTextSpacing)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTTextSpacing parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTTextSpacing)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTTextSpacing parse(File file) throws XmlException, IOException {
            return (CTTextSpacing)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTTextSpacing parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTextSpacing)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTTextSpacing parse(URL uRL) throws XmlException, IOException {
            return (CTTextSpacing)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTTextSpacing parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTextSpacing)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTTextSpacing parse(InputStream inputStream) throws XmlException, IOException {
            return (CTTextSpacing)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTTextSpacing parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTextSpacing)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTTextSpacing parse(Reader reader) throws XmlException, IOException {
            return (CTTextSpacing)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTTextSpacing parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTextSpacing)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTTextSpacing parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTTextSpacing)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTTextSpacing parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTTextSpacing)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTTextSpacing parse(Node node) throws XmlException {
            return (CTTextSpacing)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTTextSpacing parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTTextSpacing)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTTextSpacing parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTTextSpacing)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTTextSpacing parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTTextSpacing)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
