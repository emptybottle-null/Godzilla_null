    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTLineJoinRound.class.getClassLoader());
        ...
        public static CTLineJoinRound newInstance() {
            return (CTLineJoinRound)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTLineJoinRound newInstance(XmlOptions xmlOptions) {
            return (CTLineJoinRound)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTLineJoinRound parse(String string) throws XmlException {
            return (CTLineJoinRound)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTLineJoinRound parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTLineJoinRound)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTLineJoinRound parse(File file) throws XmlException, IOException {
            return (CTLineJoinRound)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTLineJoinRound parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTLineJoinRound)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTLineJoinRound parse(URL uRL) throws XmlException, IOException {
            return (CTLineJoinRound)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTLineJoinRound parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTLineJoinRound)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTLineJoinRound parse(InputStream inputStream) throws XmlException, IOException {
            return (CTLineJoinRound)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTLineJoinRound parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTLineJoinRound)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTLineJoinRound parse(Reader reader) throws XmlException, IOException {
            return (CTLineJoinRound)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTLineJoinRound parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTLineJoinRound)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTLineJoinRound parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTLineJoinRound)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTLineJoinRound parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTLineJoinRound)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTLineJoinRound parse(Node node) throws XmlException {
            return (CTLineJoinRound)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTLineJoinRound parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTLineJoinRound)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTLineJoinRound parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTLineJoinRound)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTLineJoinRound parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTLineJoinRound)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
