...
extends XmlObject {
    public static final SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CTSRgbColor.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sD023D6490046BA0250A839A9AD24C443").resolveHandle("ctsrgbcolor5bdatype");
    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTSRgbColor.class.getClassLoader());
        ...
        public static CTSRgbColor newInstance() {
            return (CTSRgbColor)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTSRgbColor newInstance(XmlOptions xmlOptions) {
            return (CTSRgbColor)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTSRgbColor parse(String string) throws XmlException {
            return (CTSRgbColor)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTSRgbColor parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTSRgbColor)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTSRgbColor parse(File file) throws XmlException, IOException {
            return (CTSRgbColor)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTSRgbColor parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSRgbColor)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTSRgbColor parse(URL uRL) throws XmlException, IOException {
            return (CTSRgbColor)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTSRgbColor parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSRgbColor)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTSRgbColor parse(InputStream inputStream) throws XmlException, IOException {
            return (CTSRgbColor)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTSRgbColor parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSRgbColor)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTSRgbColor parse(Reader reader) throws XmlException, IOException {
            return (CTSRgbColor)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTSRgbColor parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSRgbColor)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTSRgbColor parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTSRgbColor)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTSRgbColor parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTSRgbColor)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTSRgbColor parse(Node node) throws XmlException {
            return (CTSRgbColor)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTSRgbColor parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTSRgbColor)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTSRgbColor parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTSRgbColor)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static CTSRgbColor parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTSRgbColor)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
