...
extends XmlObject {
    public static final SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CTPresetColor.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sD023D6490046BA0250A839A9AD24C443").resolveHandle("ctpresetcolora675type");
    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTPresetColor.class.getClassLoader());
        ...
        public static CTPresetColor newInstance() {
            return (CTPresetColor)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTPresetColor newInstance(XmlOptions xmlOptions) {
            return (CTPresetColor)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTPresetColor parse(String string) throws XmlException {
            return (CTPresetColor)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTPresetColor parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTPresetColor)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTPresetColor parse(File file) throws XmlException, IOException {
            return (CTPresetColor)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTPresetColor parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPresetColor)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTPresetColor parse(URL uRL) throws XmlException, IOException {
            return (CTPresetColor)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTPresetColor parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPresetColor)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTPresetColor parse(InputStream inputStream) throws XmlException, IOException {
            return (CTPresetColor)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTPresetColor parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPresetColor)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTPresetColor parse(Reader reader) throws XmlException, IOException {
            return (CTPresetColor)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTPresetColor parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPresetColor)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTPresetColor parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTPresetColor)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTPresetColor parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTPresetColor)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTPresetColor parse(Node node) throws XmlException {
            return (CTPresetColor)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTPresetColor parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTPresetColor)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTPresetColor parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTPresetColor)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static CTPresetColor parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTPresetColor)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
