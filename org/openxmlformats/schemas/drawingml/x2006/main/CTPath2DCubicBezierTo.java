    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTPath2DCubicBezierTo.class.getClassLoader());
        ...
        public static CTPath2DCubicBezierTo newInstance() {
            return (CTPath2DCubicBezierTo)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTPath2DCubicBezierTo newInstance(XmlOptions xmlOptions) {
            return (CTPath2DCubicBezierTo)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTPath2DCubicBezierTo parse(String string) throws XmlException {
            return (CTPath2DCubicBezierTo)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTPath2DCubicBezierTo parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTPath2DCubicBezierTo)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTPath2DCubicBezierTo parse(File file) throws XmlException, IOException {
            return (CTPath2DCubicBezierTo)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTPath2DCubicBezierTo parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPath2DCubicBezierTo)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTPath2DCubicBezierTo parse(URL uRL) throws XmlException, IOException {
            return (CTPath2DCubicBezierTo)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTPath2DCubicBezierTo parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPath2DCubicBezierTo)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTPath2DCubicBezierTo parse(InputStream inputStream) throws XmlException, IOException {
            return (CTPath2DCubicBezierTo)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTPath2DCubicBezierTo parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPath2DCubicBezierTo)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTPath2DCubicBezierTo parse(Reader reader) throws XmlException, IOException {
            return (CTPath2DCubicBezierTo)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTPath2DCubicBezierTo parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPath2DCubicBezierTo)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTPath2DCubicBezierTo parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTPath2DCubicBezierTo)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTPath2DCubicBezierTo parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTPath2DCubicBezierTo)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTPath2DCubicBezierTo parse(Node node) throws XmlException {
            return (CTPath2DCubicBezierTo)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTPath2DCubicBezierTo parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTPath2DCubicBezierTo)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTPath2DCubicBezierTo parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTPath2DCubicBezierTo)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTPath2DCubicBezierTo parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTPath2DCubicBezierTo)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
