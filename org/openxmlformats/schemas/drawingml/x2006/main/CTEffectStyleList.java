    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTEffectStyleList.class.getClassLoader());
        ...
        public static CTEffectStyleList newInstance() {
            return (CTEffectStyleList)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTEffectStyleList newInstance(XmlOptions xmlOptions) {
            return (CTEffectStyleList)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTEffectStyleList parse(String string) throws XmlException {
            return (CTEffectStyleList)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTEffectStyleList parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTEffectStyleList)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTEffectStyleList parse(File file) throws XmlException, IOException {
            return (CTEffectStyleList)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTEffectStyleList parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTEffectStyleList)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTEffectStyleList parse(URL uRL) throws XmlException, IOException {
            return (CTEffectStyleList)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTEffectStyleList parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTEffectStyleList)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTEffectStyleList parse(InputStream inputStream) throws XmlException, IOException {
            return (CTEffectStyleList)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTEffectStyleList parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTEffectStyleList)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTEffectStyleList parse(Reader reader) throws XmlException, IOException {
            return (CTEffectStyleList)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTEffectStyleList parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTEffectStyleList)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTEffectStyleList parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTEffectStyleList)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTEffectStyleList parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTEffectStyleList)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTEffectStyleList parse(Node node) throws XmlException {
            return (CTEffectStyleList)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTEffectStyleList parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTEffectStyleList)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTEffectStyleList parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTEffectStyleList)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTEffectStyleList parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTEffectStyleList)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
