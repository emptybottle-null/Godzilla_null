...
extends XmlInt {
    ...
    public static final class Factory {
        ...
        public static STAngle newValue(Object object) {
            return (STAngle)type.newValue(object);
        }
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(STAngle.class.getClassLoader());
        ...
        public static STAngle newInstance() {
            return (STAngle)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STAngle newInstance(XmlOptions xmlOptions) {
            return (STAngle)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STAngle parse(String string) throws XmlException {
            return (STAngle)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STAngle parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STAngle)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STAngle parse(File file) throws XmlException, IOException {
            return (STAngle)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STAngle parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STAngle)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STAngle parse(URL uRL) throws XmlException, IOException {
            return (STAngle)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STAngle parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STAngle)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STAngle parse(InputStream inputStream) throws XmlException, IOException {
            return (STAngle)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static STAngle parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STAngle)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static STAngle parse(Reader reader) throws XmlException, IOException {
            return (STAngle)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static STAngle parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STAngle)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static STAngle parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STAngle)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static STAngle parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STAngle)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static STAngle parse(Node node) throws XmlException {
            return (STAngle)Factory.getTypeLoader().parse(node, type, null);
        }

        public static STAngle parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STAngle)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static STAngle parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (STAngle)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static STAngle parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STAngle)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
