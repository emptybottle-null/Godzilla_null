...
extends XmlHexBinary {
    ...
    public static final class Factory {
        ...
        public static STHexBinary3 newValue(Object object) {
            return (STHexBinary3)type.newValue(object);
        }
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(STHexBinary3.class.getClassLoader());
        ...
        public static STHexBinary3 newInstance() {
            return (STHexBinary3)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STHexBinary3 newInstance(XmlOptions xmlOptions) {
            return (STHexBinary3)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STHexBinary3 parse(String string) throws XmlException {
            return (STHexBinary3)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STHexBinary3 parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STHexBinary3)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STHexBinary3 parse(File file) throws XmlException, IOException {
            return (STHexBinary3)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STHexBinary3 parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STHexBinary3)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STHexBinary3 parse(URL uRL) throws XmlException, IOException {
            return (STHexBinary3)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STHexBinary3 parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STHexBinary3)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STHexBinary3 parse(InputStream inputStream) throws XmlException, IOException {
            return (STHexBinary3)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static STHexBinary3 parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STHexBinary3)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static STHexBinary3 parse(Reader reader) throws XmlException, IOException {
            return (STHexBinary3)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static STHexBinary3 parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STHexBinary3)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static STHexBinary3 parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STHexBinary3)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static STHexBinary3 parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STHexBinary3)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static STHexBinary3 parse(Node node) throws XmlException {
            return (STHexBinary3)Factory.getTypeLoader().parse(node, type, null);
        }

        public static STHexBinary3 parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STHexBinary3)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static STHexBinary3 parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (STHexBinary3)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static STHexBinary3 parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STHexBinary3)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
