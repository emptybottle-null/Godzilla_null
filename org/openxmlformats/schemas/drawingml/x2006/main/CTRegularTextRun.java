    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTRegularTextRun.class.getClassLoader());
        ...
        public static CTRegularTextRun newInstance() {
            return (CTRegularTextRun)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTRegularTextRun newInstance(XmlOptions xmlOptions) {
            return (CTRegularTextRun)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTRegularTextRun parse(String string) throws XmlException {
            return (CTRegularTextRun)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTRegularTextRun parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTRegularTextRun)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTRegularTextRun parse(File file) throws XmlException, IOException {
            return (CTRegularTextRun)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTRegularTextRun parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTRegularTextRun)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTRegularTextRun parse(URL uRL) throws XmlException, IOException {
            return (CTRegularTextRun)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTRegularTextRun parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTRegularTextRun)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTRegularTextRun parse(InputStream inputStream) throws XmlException, IOException {
            return (CTRegularTextRun)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTRegularTextRun parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTRegularTextRun)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTRegularTextRun parse(Reader reader) throws XmlException, IOException {
            return (CTRegularTextRun)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTRegularTextRun parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTRegularTextRun)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTRegularTextRun parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTRegularTextRun)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTRegularTextRun parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTRegularTextRun)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTRegularTextRun parse(Node node) throws XmlException {
            return (CTRegularTextRun)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTRegularTextRun parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTRegularTextRun)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTRegularTextRun parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTRegularTextRun)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTRegularTextRun parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTRegularTextRun)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
