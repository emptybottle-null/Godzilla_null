...
extends XmlLong {
    ...
    public static final class Factory {
        ...
        public static STPositiveCoordinate newValue(Object object) {
            return (STPositiveCoordinate)type.newValue(object);
        }
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(STPositiveCoordinate.class.getClassLoader());
        ...
        public static STPositiveCoordinate newInstance() {
            return (STPositiveCoordinate)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STPositiveCoordinate newInstance(XmlOptions xmlOptions) {
            return (STPositiveCoordinate)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STPositiveCoordinate parse(String string) throws XmlException {
            return (STPositiveCoordinate)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STPositiveCoordinate parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STPositiveCoordinate)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STPositiveCoordinate parse(File file) throws XmlException, IOException {
            return (STPositiveCoordinate)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STPositiveCoordinate parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPositiveCoordinate)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STPositiveCoordinate parse(URL uRL) throws XmlException, IOException {
            return (STPositiveCoordinate)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STPositiveCoordinate parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPositiveCoordinate)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STPositiveCoordinate parse(InputStream inputStream) throws XmlException, IOException {
            return (STPositiveCoordinate)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static STPositiveCoordinate parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPositiveCoordinate)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static STPositiveCoordinate parse(Reader reader) throws XmlException, IOException {
            return (STPositiveCoordinate)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static STPositiveCoordinate parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPositiveCoordinate)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static STPositiveCoordinate parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STPositiveCoordinate)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static STPositiveCoordinate parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STPositiveCoordinate)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static STPositiveCoordinate parse(Node node) throws XmlException {
            return (STPositiveCoordinate)Factory.getTypeLoader().parse(node, type, null);
        }

        public static STPositiveCoordinate parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STPositiveCoordinate)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static STPositiveCoordinate parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (STPositiveCoordinate)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static STPositiveCoordinate parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STPositiveCoordinate)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
