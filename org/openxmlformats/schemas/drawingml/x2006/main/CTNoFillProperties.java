    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTNoFillProperties.class.getClassLoader());
        ...
        public static CTNoFillProperties newInstance() {
            return (CTNoFillProperties)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTNoFillProperties newInstance(XmlOptions xmlOptions) {
            return (CTNoFillProperties)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTNoFillProperties parse(String string) throws XmlException {
            return (CTNoFillProperties)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTNoFillProperties parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTNoFillProperties)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTNoFillProperties parse(File file) throws XmlException, IOException {
            return (CTNoFillProperties)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTNoFillProperties parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTNoFillProperties)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTNoFillProperties parse(URL uRL) throws XmlException, IOException {
            return (CTNoFillProperties)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTNoFillProperties parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTNoFillProperties)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTNoFillProperties parse(InputStream inputStream) throws XmlException, IOException {
            return (CTNoFillProperties)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTNoFillProperties parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTNoFillProperties)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTNoFillProperties parse(Reader reader) throws XmlException, IOException {
            return (CTNoFillProperties)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTNoFillProperties parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTNoFillProperties)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTNoFillProperties parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTNoFillProperties)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTNoFillProperties parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTNoFillProperties)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTNoFillProperties parse(Node node) throws XmlException {
            return (CTNoFillProperties)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTNoFillProperties parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTNoFillProperties)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTNoFillProperties parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTNoFillProperties)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTNoFillProperties parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTNoFillProperties)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
