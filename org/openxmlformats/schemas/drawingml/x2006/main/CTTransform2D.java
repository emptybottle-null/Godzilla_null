    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTTransform2D.class.getClassLoader());
        ...
        public static CTTransform2D newInstance() {
            return (CTTransform2D)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTTransform2D newInstance(XmlOptions xmlOptions) {
            return (CTTransform2D)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTTransform2D parse(String string) throws XmlException {
            return (CTTransform2D)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTTransform2D parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTTransform2D)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTTransform2D parse(File file) throws XmlException, IOException {
            return (CTTransform2D)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTTransform2D parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTransform2D)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTTransform2D parse(URL uRL) throws XmlException, IOException {
            return (CTTransform2D)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTTransform2D parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTransform2D)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTTransform2D parse(InputStream inputStream) throws XmlException, IOException {
            return (CTTransform2D)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTTransform2D parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTransform2D)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTTransform2D parse(Reader reader) throws XmlException, IOException {
            return (CTTransform2D)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTTransform2D parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTransform2D)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTTransform2D parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTTransform2D)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTTransform2D parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTTransform2D)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTTransform2D parse(Node node) throws XmlException {
            return (CTTransform2D)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTTransform2D parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTTransform2D)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTTransform2D parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTTransform2D)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTTransform2D parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTTransform2D)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
