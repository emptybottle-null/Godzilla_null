...
extends XmlToken {
    ...
    public static final class Factory {
        ...
        public static STLineEndWidth newValue(Object object) {
            return (STLineEndWidth)type.newValue(object);
        }
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(STLineEndWidth.class.getClassLoader());
        ...
        public static STLineEndWidth newInstance() {
            return (STLineEndWidth)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STLineEndWidth newInstance(XmlOptions xmlOptions) {
            return (STLineEndWidth)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STLineEndWidth parse(String string) throws XmlException {
            return (STLineEndWidth)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STLineEndWidth parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STLineEndWidth)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STLineEndWidth parse(File file) throws XmlException, IOException {
            return (STLineEndWidth)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STLineEndWidth parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STLineEndWidth)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STLineEndWidth parse(URL uRL) throws XmlException, IOException {
            return (STLineEndWidth)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STLineEndWidth parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STLineEndWidth)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STLineEndWidth parse(InputStream inputStream) throws XmlException, IOException {
            return (STLineEndWidth)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static STLineEndWidth parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STLineEndWidth)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static STLineEndWidth parse(Reader reader) throws XmlException, IOException {
            return (STLineEndWidth)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static STLineEndWidth parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STLineEndWidth)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static STLineEndWidth parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STLineEndWidth)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static STLineEndWidth parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STLineEndWidth)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static STLineEndWidth parse(Node node) throws XmlException {
            return (STLineEndWidth)Factory.getTypeLoader().parse(node, type, null);
        }

        public static STLineEndWidth parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STLineEndWidth)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static STLineEndWidth parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (STLineEndWidth)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static STLineEndWidth parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STLineEndWidth)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
