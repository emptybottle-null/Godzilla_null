    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTPositivePercentage.class.getClassLoader());
        ...
        public static CTPositivePercentage newInstance() {
            return (CTPositivePercentage)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTPositivePercentage newInstance(XmlOptions xmlOptions) {
            return (CTPositivePercentage)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTPositivePercentage parse(String string) throws XmlException {
            return (CTPositivePercentage)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTPositivePercentage parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTPositivePercentage)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTPositivePercentage parse(File file) throws XmlException, IOException {
            return (CTPositivePercentage)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTPositivePercentage parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPositivePercentage)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTPositivePercentage parse(URL uRL) throws XmlException, IOException {
            return (CTPositivePercentage)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTPositivePercentage parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPositivePercentage)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTPositivePercentage parse(InputStream inputStream) throws XmlException, IOException {
            return (CTPositivePercentage)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTPositivePercentage parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPositivePercentage)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTPositivePercentage parse(Reader reader) throws XmlException, IOException {
            return (CTPositivePercentage)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTPositivePercentage parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPositivePercentage)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTPositivePercentage parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTPositivePercentage)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTPositivePercentage parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTPositivePercentage)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTPositivePercentage parse(Node node) throws XmlException {
            return (CTPositivePercentage)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTPositivePercentage parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTPositivePercentage)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTPositivePercentage parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTPositivePercentage)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTPositivePercentage parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTPositivePercentage)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
