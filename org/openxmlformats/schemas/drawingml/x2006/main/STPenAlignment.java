...
extends XmlToken {
    ...
    public static final class Factory {
        ...
        public static STPenAlignment newValue(Object object) {
            return (STPenAlignment)type.newValue(object);
        }
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(STPenAlignment.class.getClassLoader());
        ...
        public static STPenAlignment newInstance() {
            return (STPenAlignment)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STPenAlignment newInstance(XmlOptions xmlOptions) {
            return (STPenAlignment)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STPenAlignment parse(String string) throws XmlException {
            return (STPenAlignment)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STPenAlignment parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STPenAlignment)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STPenAlignment parse(File file) throws XmlException, IOException {
            return (STPenAlignment)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STPenAlignment parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPenAlignment)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STPenAlignment parse(URL uRL) throws XmlException, IOException {
            return (STPenAlignment)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STPenAlignment parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPenAlignment)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STPenAlignment parse(InputStream inputStream) throws XmlException, IOException {
            return (STPenAlignment)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static STPenAlignment parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPenAlignment)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static STPenAlignment parse(Reader reader) throws XmlException, IOException {
            return (STPenAlignment)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static STPenAlignment parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPenAlignment)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static STPenAlignment parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STPenAlignment)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static STPenAlignment parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STPenAlignment)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static STPenAlignment parse(Node node) throws XmlException {
            return (STPenAlignment)Factory.getTypeLoader().parse(node, type, null);
        }

        public static STPenAlignment parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STPenAlignment)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static STPenAlignment parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (STPenAlignment)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static STPenAlignment parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STPenAlignment)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
