    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTTableCol.class.getClassLoader());
        ...
        public static CTTableCol newInstance() {
            return (CTTableCol)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTTableCol newInstance(XmlOptions xmlOptions) {
            return (CTTableCol)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTTableCol parse(String string) throws XmlException {
            return (CTTableCol)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTTableCol parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTTableCol)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTTableCol parse(File file) throws XmlException, IOException {
            return (CTTableCol)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTTableCol parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTableCol)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTTableCol parse(URL uRL) throws XmlException, IOException {
            return (CTTableCol)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTTableCol parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTableCol)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTTableCol parse(InputStream inputStream) throws XmlException, IOException {
            return (CTTableCol)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTTableCol parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTableCol)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTTableCol parse(Reader reader) throws XmlException, IOException {
            return (CTTableCol)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTTableCol parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTableCol)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTTableCol parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTTableCol)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTTableCol parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTTableCol)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTTableCol parse(Node node) throws XmlException {
            return (CTTableCol)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTTableCol parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTTableCol)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTTableCol parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTTableCol)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTTableCol parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTTableCol)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
