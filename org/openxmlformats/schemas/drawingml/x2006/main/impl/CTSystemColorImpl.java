...
implements CTSystemColor {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPositiveFixedPercentage> {
                ...
                public CTPositiveFixedPercentage set(int n, CTPositiveFixedPercentage cTPositiveFixedPercentage) {
                    CTPositiveFixedPercentage cTPositiveFixedPercentage2 = CTSystemColorImpl.this.getTintArray(n);
                ...
                public void add(int n, CTPositiveFixedPercentage cTPositiveFixedPercentage) {
                    CTSystemColorImpl.this.insertNewTint(n).set(cTPositiveFixedPercentage);
                }

                @Override
                public CTPositiveFixedPercentage remove(int n) {
                    CTPositiveFixedPercentage cTPositiveFixedPercentage = CTSystemColorImpl.this.getTintArray(n);
    ...
    public List<CTPositiveFixedPercentage> getShadeList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPositiveFixedPercentage> {
                ...
                @Override
                public CTPositiveFixedPercentage set(int n, CTPositiveFixedPercentage cTPositiveFixedPercentage) {
                    CTPositiveFixedPercentage cTPositiveFixedPercentage2 = CTSystemColorImpl.this.getShadeArray(n);
                ...
                @Override
                public void add(int n, CTPositiveFixedPercentage cTPositiveFixedPercentage) {
                    CTSystemColorImpl.this.insertNewShade(n).set(cTPositiveFixedPercentage);
                }

                @Override
                public CTPositiveFixedPercentage remove(int n) {
                    CTPositiveFixedPercentage cTPositiveFixedPercentage = CTSystemColorImpl.this.getShadeArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTComplementTransform> {
                ...
                public CTComplementTransform set(int n, CTComplementTransform cTComplementTransform) {
                    CTComplementTransform cTComplementTransform2 = CTSystemColorImpl.this.getCompArray(n);
                ...
                public CTComplementTransform remove(int n) {
                    CTComplementTransform cTComplementTransform = CTSystemColorImpl.this.getCompArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTInverseTransform> {
                ...
                public CTInverseTransform set(int n, CTInverseTransform cTInverseTransform) {
                    CTInverseTransform cTInverseTransform2 = CTSystemColorImpl.this.getInvArray(n);
                ...
                public CTInverseTransform remove(int n) {
                    CTInverseTransform cTInverseTransform = CTSystemColorImpl.this.getInvArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTGrayscaleTransform> {
                ...
                public CTGrayscaleTransform set(int n, CTGrayscaleTransform cTGrayscaleTransform) {
                    CTGrayscaleTransform cTGrayscaleTransform2 = CTSystemColorImpl.this.getGrayArray(n);
                ...
                public CTGrayscaleTransform remove(int n) {
                    CTGrayscaleTransform cTGrayscaleTransform = CTSystemColorImpl.this.getGrayArray(n);
    ...
    public List<CTPositiveFixedPercentage> getAlphaList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPositiveFixedPercentage> {
                ...
                @Override
                public CTPositiveFixedPercentage set(int n, CTPositiveFixedPercentage cTPositiveFixedPercentage) {
                    CTPositiveFixedPercentage cTPositiveFixedPercentage2 = CTSystemColorImpl.this.getAlphaArray(n);
                ...
                @Override
                public void add(int n, CTPositiveFixedPercentage cTPositiveFixedPercentage) {
                    CTSystemColorImpl.this.insertNewAlpha(n).set(cTPositiveFixedPercentage);
                }

                @Override
                public CTPositiveFixedPercentage remove(int n) {
                    CTPositiveFixedPercentage cTPositiveFixedPercentage = CTSystemColorImpl.this.getAlphaArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTFixedPercentage> {
                ...
                public CTFixedPercentage set(int n, CTFixedPercentage cTFixedPercentage) {
                    CTFixedPercentage cTFixedPercentage2 = CTSystemColorImpl.this.getAlphaOffArray(n);
                ...
                public void add(int n, CTFixedPercentage cTFixedPercentage) {
                    CTSystemColorImpl.this.insertNewAlphaOff(n).set(cTFixedPercentage);
                }

                @Override
                public CTFixedPercentage remove(int n) {
                    CTFixedPercentage cTFixedPercentage = CTSystemColorImpl.this.getAlphaOffArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPositivePercentage> {
                ...
                public CTPositivePercentage set(int n, CTPositivePercentage cTPositivePercentage) {
                    CTPositivePercentage cTPositivePercentage2 = CTSystemColorImpl.this.getAlphaModArray(n);
                ...
                public void add(int n, CTPositivePercentage cTPositivePercentage) {
                    CTSystemColorImpl.this.insertNewAlphaMod(n).set(cTPositivePercentage);
                }

                @Override
                public CTPositivePercentage remove(int n) {
                    CTPositivePercentage cTPositivePercentage = CTSystemColorImpl.this.getAlphaModArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPositiveFixedAngle> {
                ...
                public CTPositiveFixedAngle set(int n, CTPositiveFixedAngle cTPositiveFixedAngle) {
                    CTPositiveFixedAngle cTPositiveFixedAngle2 = CTSystemColorImpl.this.getHueArray(n);
                ...
                public CTPositiveFixedAngle remove(int n) {
                    CTPositiveFixedAngle cTPositiveFixedAngle = CTSystemColorImpl.this.getHueArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTAngle> {
                ...
                public CTAngle set(int n, CTAngle cTAngle) {
                    CTAngle cTAngle2 = CTSystemColorImpl.this.getHueOffArray(n);
                ...
                public CTAngle remove(int n) {
                    CTAngle cTAngle = CTSystemColorImpl.this.getHueOffArray(n);
    ...
    public List<CTPositivePercentage> getHueModList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPositivePercentage> {
                ...
                @Override
                public CTPositivePercentage set(int n, CTPositivePercentage cTPositivePercentage) {
                    CTPositivePercentage cTPositivePercentage2 = CTSystemColorImpl.this.getHueModArray(n);
                ...
                @Override
                public void add(int n, CTPositivePercentage cTPositivePercentage) {
                    CTSystemColorImpl.this.insertNewHueMod(n).set(cTPositivePercentage);
                }

                @Override
                public CTPositivePercentage remove(int n) {
                    CTPositivePercentage cTPositivePercentage = CTSystemColorImpl.this.getHueModArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSystemColorImpl.this.getSatArray(n);
                ...
                public void add(int n, CTPercentage cTPercentage) {
                    CTSystemColorImpl.this.insertNewSat(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSystemColorImpl.this.getSatArray(n);
    ...
    public List<CTPercentage> getSatOffList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSystemColorImpl.this.getSatOffArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSystemColorImpl.this.insertNewSatOff(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSystemColorImpl.this.getSatOffArray(n);
    ...
    public List<CTPercentage> getSatModList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSystemColorImpl.this.getSatModArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSystemColorImpl.this.insertNewSatMod(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSystemColorImpl.this.getSatModArray(n);
    ...
    public List<CTPercentage> getLumList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSystemColorImpl.this.getLumArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSystemColorImpl.this.insertNewLum(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSystemColorImpl.this.getLumArray(n);
    ...
    public List<CTPercentage> getLumOffList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSystemColorImpl.this.getLumOffArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSystemColorImpl.this.insertNewLumOff(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSystemColorImpl.this.getLumOffArray(n);
    ...
    public List<CTPercentage> getLumModList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSystemColorImpl.this.getLumModArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSystemColorImpl.this.insertNewLumMod(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSystemColorImpl.this.getLumModArray(n);
    ...
    public List<CTPercentage> getRedList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSystemColorImpl.this.getRedArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSystemColorImpl.this.insertNewRed(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSystemColorImpl.this.getRedArray(n);
    ...
    public List<CTPercentage> getRedOffList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSystemColorImpl.this.getRedOffArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSystemColorImpl.this.insertNewRedOff(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSystemColorImpl.this.getRedOffArray(n);
    ...
    public List<CTPercentage> getRedModList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSystemColorImpl.this.getRedModArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSystemColorImpl.this.insertNewRedMod(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSystemColorImpl.this.getRedModArray(n);
    ...
    public List<CTPercentage> getGreenList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSystemColorImpl.this.getGreenArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSystemColorImpl.this.insertNewGreen(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSystemColorImpl.this.getGreenArray(n);
    ...
    public List<CTPercentage> getGreenOffList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSystemColorImpl.this.getGreenOffArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSystemColorImpl.this.insertNewGreenOff(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSystemColorImpl.this.getGreenOffArray(n);
    ...
    public List<CTPercentage> getGreenModList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSystemColorImpl.this.getGreenModArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSystemColorImpl.this.insertNewGreenMod(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSystemColorImpl.this.getGreenModArray(n);
    ...
    public List<CTPercentage> getBlueList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSystemColorImpl.this.getBlueArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSystemColorImpl.this.insertNewBlue(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSystemColorImpl.this.getBlueArray(n);
    ...
    public List<CTPercentage> getBlueOffList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSystemColorImpl.this.getBlueOffArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSystemColorImpl.this.insertNewBlueOff(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSystemColorImpl.this.getBlueOffArray(n);
    ...
    public List<CTPercentage> getBlueModList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSystemColorImpl.this.getBlueModArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSystemColorImpl.this.insertNewBlueMod(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSystemColorImpl.this.getBlueModArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTGammaTransform> {
                ...
                public CTGammaTransform set(int n, CTGammaTransform cTGammaTransform) {
                    CTGammaTransform cTGammaTransform2 = CTSystemColorImpl.this.getGammaArray(n);
                ...
                public CTGammaTransform remove(int n) {
                    CTGammaTransform cTGammaTransform = CTSystemColorImpl.this.getGammaArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTInverseGammaTransform> {
                ...
                public CTInverseGammaTransform set(int n, CTInverseGammaTransform cTInverseGammaTransform) {
                    CTInverseGammaTransform cTInverseGammaTransform2 = CTSystemColorImpl.this.getInvGammaArray(n);
                ...
                public CTInverseGammaTransform remove(int n) {
                    CTInverseGammaTransform cTInverseGammaTransform = CTSystemColorImpl.this.getInvGammaArray(n);
    ...
    public STSystemColorVal xgetVal() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STSystemColorVal sTSystemColorVal = null;
            sTSystemColorVal = (STSystemColorVal)((Object)this.get_store().find_attribute_user(VAL$56));
     ...
     */
    @Override
    public void setVal(STSystemColorVal.Enum enum_) {
        Object object = this.monitor();
        synchronized (object) {
            this.check_orphaned();
            SimpleValue simpleValue = null;
    ...
    public void xsetVal(STSystemColorVal sTSystemColorVal) {
        ...
        synchronized (object) {
            this.check_orphaned();
            STSystemColorVal sTSystemColorVal2 = null;
            sTSystemColorVal2 = (STSystemColorVal)((Object)this.get_store().find_attribute_user(VAL$56));
            if (sTSystemColorVal2 == null) {
                sTSystemColorVal2 = (STSystemColorVal)((Object)this.get_store().add_attribute_user(VAL$56));
            }
    ...
    public byte[] getLastClr() {
        ...
        synchronized (object) {
            this.check_orphaned();
            SimpleValue simpleValue = null;
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(LASTCLR$58));
            if (simpleValue == null) {
                return null;
            }
    ...
    public STHexBinary3 xgetLastClr() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STHexBinary3 sTHexBinary3 = null;
            sTHexBinary3 = (STHexBinary3)((Object)this.get_store().find_attribute_user(LASTCLR$58));
            return sTHexBinary3;
        }
    }
     ...
     */
    @Override
    public void setLastClr(byte[] byArray) {
        Object object = this.monitor();
        synchronized (object) {
            this.check_orphaned();
            SimpleValue simpleValue = null;
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(LASTCLR$58));
            if (simpleValue == null) {
                simpleValue = (SimpleValue)((Object)this.get_store().add_attribute_user(LASTCLR$58));
            }
     ...
     */
    @Override
    public void xsetLastClr(STHexBinary3 sTHexBinary3) {
        Object object = this.monitor();
        synchronized (object) {
            this.check_orphaned();
            STHexBinary3 sTHexBinary32 = null;
            sTHexBinary32 = (STHexBinary3)((Object)this.get_store().find_attribute_user(LASTCLR$58));
            if (sTHexBinary32 == null) {
                sTHexBinary32 = (STHexBinary3)((Object)this.get_store().add_attribute_user(LASTCLR$58));
            }
