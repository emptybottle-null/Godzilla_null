...
implements CTFontReference {
    ...
    public CTFontReferenceImpl(SchemaType schemaType) {
        super(schemaType);
    }
    ...
    public STFontCollectionIndex.Enum getIdx() {
        ...
        synchronized (object) {
            ...
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(IDX$12));
            if (simpleValue == null) {
                return null;
            }
    ...
    public STFontCollectionIndex xgetIdx() {
        ...
        synchronized (object) {
            ...
            sTFontCollectionIndex = (STFontCollectionIndex)((Object)this.get_store().find_attribute_user(IDX$12));
     ...
     */
    @Override
    public void setIdx(STFontCollectionIndex.Enum enum_) {
        Object object = this.monitor();
        synchronized (object) {
            this.check_orphaned();
            SimpleValue simpleValue = null;
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(IDX$12));
            if (simpleValue == null) {
                simpleValue = (SimpleValue)((Object)this.get_store().add_attribute_user(IDX$12));
            }
    ...
    public void xsetIdx(STFontCollectionIndex sTFontCollectionIndex) {
        ...
        synchronized (object) {
            this.check_orphaned();
            STFontCollectionIndex sTFontCollectionIndex2 = null;
            sTFontCollectionIndex2 = (STFontCollectionIndex)((Object)this.get_store().find_attribute_user(IDX$12));
            if (sTFontCollectionIndex2 == null) {
                sTFontCollectionIndex2 = (STFontCollectionIndex)((Object)this.get_store().add_attribute_user(IDX$12));
            }
