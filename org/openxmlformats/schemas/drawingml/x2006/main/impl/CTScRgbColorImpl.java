...
implements CTScRgbColor {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPositiveFixedPercentage> {
                ...
                public CTPositiveFixedPercentage set(int n, CTPositiveFixedPercentage cTPositiveFixedPercentage) {
                    CTPositiveFixedPercentage cTPositiveFixedPercentage2 = CTScRgbColorImpl.this.getTintArray(n);
                ...
                public void add(int n, CTPositiveFixedPercentage cTPositiveFixedPercentage) {
                    CTScRgbColorImpl.this.insertNewTint(n).set(cTPositiveFixedPercentage);
                }

                @Override
                public CTPositiveFixedPercentage remove(int n) {
                    CTPositiveFixedPercentage cTPositiveFixedPercentage = CTScRgbColorImpl.this.getTintArray(n);
    ...
    public List<CTPositiveFixedPercentage> getShadeList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPositiveFixedPercentage> {
                ...
                @Override
                public CTPositiveFixedPercentage set(int n, CTPositiveFixedPercentage cTPositiveFixedPercentage) {
                    CTPositiveFixedPercentage cTPositiveFixedPercentage2 = CTScRgbColorImpl.this.getShadeArray(n);
                ...
                @Override
                public void add(int n, CTPositiveFixedPercentage cTPositiveFixedPercentage) {
                    CTScRgbColorImpl.this.insertNewShade(n).set(cTPositiveFixedPercentage);
                }

                @Override
                public CTPositiveFixedPercentage remove(int n) {
                    CTPositiveFixedPercentage cTPositiveFixedPercentage = CTScRgbColorImpl.this.getShadeArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTComplementTransform> {
                ...
                public CTComplementTransform set(int n, CTComplementTransform cTComplementTransform) {
                    CTComplementTransform cTComplementTransform2 = CTScRgbColorImpl.this.getCompArray(n);
                ...
                public CTComplementTransform remove(int n) {
                    CTComplementTransform cTComplementTransform = CTScRgbColorImpl.this.getCompArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTInverseTransform> {
                ...
                public CTInverseTransform set(int n, CTInverseTransform cTInverseTransform) {
                    CTInverseTransform cTInverseTransform2 = CTScRgbColorImpl.this.getInvArray(n);
                ...
                public CTInverseTransform remove(int n) {
                    CTInverseTransform cTInverseTransform = CTScRgbColorImpl.this.getInvArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTGrayscaleTransform> {
                ...
                public CTGrayscaleTransform set(int n, CTGrayscaleTransform cTGrayscaleTransform) {
                    CTGrayscaleTransform cTGrayscaleTransform2 = CTScRgbColorImpl.this.getGrayArray(n);
                ...
                public CTGrayscaleTransform remove(int n) {
                    CTGrayscaleTransform cTGrayscaleTransform = CTScRgbColorImpl.this.getGrayArray(n);
    ...
    public List<CTPositiveFixedPercentage> getAlphaList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPositiveFixedPercentage> {
                ...
                @Override
                public CTPositiveFixedPercentage set(int n, CTPositiveFixedPercentage cTPositiveFixedPercentage) {
                    CTPositiveFixedPercentage cTPositiveFixedPercentage2 = CTScRgbColorImpl.this.getAlphaArray(n);
                ...
                @Override
                public void add(int n, CTPositiveFixedPercentage cTPositiveFixedPercentage) {
                    CTScRgbColorImpl.this.insertNewAlpha(n).set(cTPositiveFixedPercentage);
                }

                @Override
                public CTPositiveFixedPercentage remove(int n) {
                    CTPositiveFixedPercentage cTPositiveFixedPercentage = CTScRgbColorImpl.this.getAlphaArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTFixedPercentage> {
                ...
                public CTFixedPercentage set(int n, CTFixedPercentage cTFixedPercentage) {
                    CTFixedPercentage cTFixedPercentage2 = CTScRgbColorImpl.this.getAlphaOffArray(n);
                ...
                public void add(int n, CTFixedPercentage cTFixedPercentage) {
                    CTScRgbColorImpl.this.insertNewAlphaOff(n).set(cTFixedPercentage);
                }

                @Override
                public CTFixedPercentage remove(int n) {
                    CTFixedPercentage cTFixedPercentage = CTScRgbColorImpl.this.getAlphaOffArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPositivePercentage> {
                ...
                public CTPositivePercentage set(int n, CTPositivePercentage cTPositivePercentage) {
                    CTPositivePercentage cTPositivePercentage2 = CTScRgbColorImpl.this.getAlphaModArray(n);
                ...
                public void add(int n, CTPositivePercentage cTPositivePercentage) {
                    CTScRgbColorImpl.this.insertNewAlphaMod(n).set(cTPositivePercentage);
                }

                @Override
                public CTPositivePercentage remove(int n) {
                    CTPositivePercentage cTPositivePercentage = CTScRgbColorImpl.this.getAlphaModArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPositiveFixedAngle> {
                ...
                public CTPositiveFixedAngle set(int n, CTPositiveFixedAngle cTPositiveFixedAngle) {
                    CTPositiveFixedAngle cTPositiveFixedAngle2 = CTScRgbColorImpl.this.getHueArray(n);
                ...
                public CTPositiveFixedAngle remove(int n) {
                    CTPositiveFixedAngle cTPositiveFixedAngle = CTScRgbColorImpl.this.getHueArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTAngle> {
                ...
                public CTAngle set(int n, CTAngle cTAngle) {
                    CTAngle cTAngle2 = CTScRgbColorImpl.this.getHueOffArray(n);
                ...
                public CTAngle remove(int n) {
                    CTAngle cTAngle = CTScRgbColorImpl.this.getHueOffArray(n);
    ...
    public List<CTPositivePercentage> getHueModList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPositivePercentage> {
                ...
                @Override
                public CTPositivePercentage set(int n, CTPositivePercentage cTPositivePercentage) {
                    CTPositivePercentage cTPositivePercentage2 = CTScRgbColorImpl.this.getHueModArray(n);
                ...
                @Override
                public void add(int n, CTPositivePercentage cTPositivePercentage) {
                    CTScRgbColorImpl.this.insertNewHueMod(n).set(cTPositivePercentage);
                }

                @Override
                public CTPositivePercentage remove(int n) {
                    CTPositivePercentage cTPositivePercentage = CTScRgbColorImpl.this.getHueModArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTScRgbColorImpl.this.getSatArray(n);
                ...
                public void add(int n, CTPercentage cTPercentage) {
                    CTScRgbColorImpl.this.insertNewSat(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTScRgbColorImpl.this.getSatArray(n);
    ...
    public List<CTPercentage> getSatOffList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTScRgbColorImpl.this.getSatOffArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTScRgbColorImpl.this.insertNewSatOff(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTScRgbColorImpl.this.getSatOffArray(n);
    ...
    public List<CTPercentage> getSatModList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTScRgbColorImpl.this.getSatModArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTScRgbColorImpl.this.insertNewSatMod(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTScRgbColorImpl.this.getSatModArray(n);
    ...
    public List<CTPercentage> getLumList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTScRgbColorImpl.this.getLumArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTScRgbColorImpl.this.insertNewLum(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTScRgbColorImpl.this.getLumArray(n);
    ...
    public List<CTPercentage> getLumOffList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTScRgbColorImpl.this.getLumOffArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTScRgbColorImpl.this.insertNewLumOff(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTScRgbColorImpl.this.getLumOffArray(n);
    ...
    public List<CTPercentage> getLumModList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTScRgbColorImpl.this.getLumModArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTScRgbColorImpl.this.insertNewLumMod(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTScRgbColorImpl.this.getLumModArray(n);
    ...
    public List<CTPercentage> getRedList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTScRgbColorImpl.this.getRedArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTScRgbColorImpl.this.insertNewRed(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTScRgbColorImpl.this.getRedArray(n);
    ...
    public List<CTPercentage> getRedOffList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTScRgbColorImpl.this.getRedOffArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTScRgbColorImpl.this.insertNewRedOff(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTScRgbColorImpl.this.getRedOffArray(n);
    ...
    public List<CTPercentage> getRedModList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTScRgbColorImpl.this.getRedModArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTScRgbColorImpl.this.insertNewRedMod(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTScRgbColorImpl.this.getRedModArray(n);
    ...
    public List<CTPercentage> getGreenList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTScRgbColorImpl.this.getGreenArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTScRgbColorImpl.this.insertNewGreen(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTScRgbColorImpl.this.getGreenArray(n);
    ...
    public List<CTPercentage> getGreenOffList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTScRgbColorImpl.this.getGreenOffArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTScRgbColorImpl.this.insertNewGreenOff(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTScRgbColorImpl.this.getGreenOffArray(n);
    ...
    public List<CTPercentage> getGreenModList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTScRgbColorImpl.this.getGreenModArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTScRgbColorImpl.this.insertNewGreenMod(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTScRgbColorImpl.this.getGreenModArray(n);
    ...
    public List<CTPercentage> getBlueList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTScRgbColorImpl.this.getBlueArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTScRgbColorImpl.this.insertNewBlue(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTScRgbColorImpl.this.getBlueArray(n);
    ...
    public List<CTPercentage> getBlueOffList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTScRgbColorImpl.this.getBlueOffArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTScRgbColorImpl.this.insertNewBlueOff(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTScRgbColorImpl.this.getBlueOffArray(n);
    ...
    public List<CTPercentage> getBlueModList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTScRgbColorImpl.this.getBlueModArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTScRgbColorImpl.this.insertNewBlueMod(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTScRgbColorImpl.this.getBlueModArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTGammaTransform> {
                ...
                public CTGammaTransform set(int n, CTGammaTransform cTGammaTransform) {
                    CTGammaTransform cTGammaTransform2 = CTScRgbColorImpl.this.getGammaArray(n);
                ...
                public CTGammaTransform remove(int n) {
                    CTGammaTransform cTGammaTransform = CTScRgbColorImpl.this.getGammaArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTInverseGammaTransform> {
                ...
                public CTInverseGammaTransform set(int n, CTInverseGammaTransform cTInverseGammaTransform) {
                    CTInverseGammaTransform cTInverseGammaTransform2 = CTScRgbColorImpl.this.getInvGammaArray(n);
                ...
                public CTInverseGammaTransform remove(int n) {
                    CTInverseGammaTransform cTInverseGammaTransform = CTScRgbColorImpl.this.getInvGammaArray(n);
    ...
    public int getR() {
        ...
        synchronized (object) {
            ...
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(R$56));
            if (simpleValue == null) {
                return 0;
            }
    ...
    public STPercentage xgetR() {
        ...
        synchronized (object) {
            ...
            sTPercentage = (STPercentage)((Object)this.get_store().find_attribute_user(R$56));
            return sTPercentage;
        }
    }
    ...
    public void setR(int n) {
        ...
        synchronized (object) {
            ...
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(R$56));
            if (simpleValue == null) {
                simpleValue = (SimpleValue)((Object)this.get_store().add_attribute_user(R$56));
            }
    ...
    public void xsetR(STPercentage sTPercentage) {
        ...
        synchronized (object) {
            ...
            sTPercentage2 = (STPercentage)((Object)this.get_store().find_attribute_user(R$56));
            if (sTPercentage2 == null) {
                sTPercentage2 = (STPercentage)((Object)this.get_store().add_attribute_user(R$56));
            }
    ...
    public int getG() {
        ...
        synchronized (object) {
            this.check_orphaned();
            SimpleValue simpleValue = null;
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(G$58));
            if (simpleValue == null) {
                return 0;
            }
            return simpleValue.getIntValue();
    ...
    public STPercentage xgetG() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STPercentage sTPercentage = null;
            sTPercentage = (STPercentage)((Object)this.get_store().find_attribute_user(G$58));
            return sTPercentage;
        }
    }
    ...
    public void setG(int n) {
        ...
        synchronized (object) {
            ...
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(G$58));
            if (simpleValue == null) {
                simpleValue = (SimpleValue)((Object)this.get_store().add_attribute_user(G$58));
            }
            simpleValue.setIntValue(n);
        }
    }
    ...
    public void xsetG(STPercentage sTPercentage) {
        ...
        synchronized (object) {
            this.check_orphaned();
            STPercentage sTPercentage2 = null;
            sTPercentage2 = (STPercentage)((Object)this.get_store().find_attribute_user(G$58));
            if (sTPercentage2 == null) {
                sTPercentage2 = (STPercentage)((Object)this.get_store().add_attribute_user(G$58));
            }
            sTPercentage2.set(sTPercentage);
        }
    }
    ...
    public int getB() {
        ...
        synchronized (object) {
            this.check_orphaned();
            SimpleValue simpleValue = null;
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(B$60));
            if (simpleValue == null) {
                return 0;
            }
            return simpleValue.getIntValue();
    ...
    public STPercentage xgetB() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STPercentage sTPercentage = null;
            sTPercentage = (STPercentage)((Object)this.get_store().find_attribute_user(B$60));
            return sTPercentage;
        }
    }
    ...
    public void setB(int n) {
        ...
        synchronized (object) {
            ...
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(B$60));
            if (simpleValue == null) {
                simpleValue = (SimpleValue)((Object)this.get_store().add_attribute_user(B$60));
            }
            simpleValue.setIntValue(n);
        }
    }
    ...
    public void xsetB(STPercentage sTPercentage) {
        ...
        synchronized (object) {
            this.check_orphaned();
            STPercentage sTPercentage2 = null;
            sTPercentage2 = (STPercentage)((Object)this.get_store().find_attribute_user(B$60));
            if (sTPercentage2 == null) {
                sTPercentage2 = (STPercentage)((Object)this.get_store().add_attribute_user(B$60));
            }
            sTPercentage2.set(sTPercentage);
        }
    }
