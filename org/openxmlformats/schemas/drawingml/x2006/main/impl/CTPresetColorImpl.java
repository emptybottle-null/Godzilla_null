...
implements CTPresetColor {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPositiveFixedPercentage> {
                ...
                public CTPositiveFixedPercentage get(int n) {
                    return CTPresetColorImpl.this.getTintArray(n);
                }

                @Override
                public CTPositiveFixedPercentage set(int n, CTPositiveFixedPercentage cTPositiveFixedPercentage) {
                    CTPositiveFixedPercentage cTPositiveFixedPercentage2 = CTPresetColorImpl.this.getTintArray(n);
                    CTPresetColorImpl.this.setTintArray(n, cTPositiveFixedPercentage);
                    return cTPositiveFixedPercentage2;
                }

                @Override
                public void add(int n, CTPositiveFixedPercentage cTPositiveFixedPercentage) {
                    CTPresetColorImpl.this.insertNewTint(n).set(cTPositiveFixedPercentage);
                }

                @Override
                public CTPositiveFixedPercentage remove(int n) {
                    CTPositiveFixedPercentage cTPositiveFixedPercentage = CTPresetColorImpl.this.getTintArray(n);
                    CTPresetColorImpl.this.removeTint(n);
    ...
    public List<CTPositiveFixedPercentage> getShadeList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPositiveFixedPercentage> {
                ...
                @Override
                public CTPositiveFixedPercentage get(int n) {
                    return CTPresetColorImpl.this.getShadeArray(n);
                }

                @Override
                public CTPositiveFixedPercentage set(int n, CTPositiveFixedPercentage cTPositiveFixedPercentage) {
                    CTPositiveFixedPercentage cTPositiveFixedPercentage2 = CTPresetColorImpl.this.getShadeArray(n);
                    CTPresetColorImpl.this.setShadeArray(n, cTPositiveFixedPercentage);
                    return cTPositiveFixedPercentage2;
                }

                @Override
                public void add(int n, CTPositiveFixedPercentage cTPositiveFixedPercentage) {
                    CTPresetColorImpl.this.insertNewShade(n).set(cTPositiveFixedPercentage);
                }

                @Override
                public CTPositiveFixedPercentage remove(int n) {
                    CTPositiveFixedPercentage cTPositiveFixedPercentage = CTPresetColorImpl.this.getShadeArray(n);
                    CTPresetColorImpl.this.removeShade(n);
                    return cTPositiveFixedPercentage;
                }
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTComplementTransform> {
                ...
                public CTComplementTransform get(int n) {
                    return CTPresetColorImpl.this.getCompArray(n);
                }

                @Override
                public CTComplementTransform set(int n, CTComplementTransform cTComplementTransform) {
                    CTComplementTransform cTComplementTransform2 = CTPresetColorImpl.this.getCompArray(n);
                    CTPresetColorImpl.this.setCompArray(n, cTComplementTransform);
                    return cTComplementTransform2;
                }

                @Override
                public void add(int n, CTComplementTransform cTComplementTransform) {
                    CTPresetColorImpl.this.insertNewComp(n).set((XmlObject)cTComplementTransform);
                }

                @Override
                public CTComplementTransform remove(int n) {
                    CTComplementTransform cTComplementTransform = CTPresetColorImpl.this.getCompArray(n);
                    CTPresetColorImpl.this.removeComp(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTInverseTransform> {
                ...
                public CTInverseTransform get(int n) {
                    return CTPresetColorImpl.this.getInvArray(n);
                }

                @Override
                public CTInverseTransform set(int n, CTInverseTransform cTInverseTransform) {
                    CTInverseTransform cTInverseTransform2 = CTPresetColorImpl.this.getInvArray(n);
                    CTPresetColorImpl.this.setInvArray(n, cTInverseTransform);
                    return cTInverseTransform2;
                }

                @Override
                public void add(int n, CTInverseTransform cTInverseTransform) {
                    CTPresetColorImpl.this.insertNewInv(n).set((XmlObject)cTInverseTransform);
                }

                @Override
                public CTInverseTransform remove(int n) {
                    CTInverseTransform cTInverseTransform = CTPresetColorImpl.this.getInvArray(n);
                    CTPresetColorImpl.this.removeInv(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTGrayscaleTransform> {
                ...
                public CTGrayscaleTransform get(int n) {
                    return CTPresetColorImpl.this.getGrayArray(n);
                }

                @Override
                public CTGrayscaleTransform set(int n, CTGrayscaleTransform cTGrayscaleTransform) {
                    CTGrayscaleTransform cTGrayscaleTransform2 = CTPresetColorImpl.this.getGrayArray(n);
                    CTPresetColorImpl.this.setGrayArray(n, cTGrayscaleTransform);
                    return cTGrayscaleTransform2;
                }

                @Override
                public void add(int n, CTGrayscaleTransform cTGrayscaleTransform) {
                    CTPresetColorImpl.this.insertNewGray(n).set((XmlObject)cTGrayscaleTransform);
                }

                @Override
                public CTGrayscaleTransform remove(int n) {
                    CTGrayscaleTransform cTGrayscaleTransform = CTPresetColorImpl.this.getGrayArray(n);
                    CTPresetColorImpl.this.removeGray(n);
    ...
    public List<CTPositiveFixedPercentage> getAlphaList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPositiveFixedPercentage> {
                ...
                @Override
                public CTPositiveFixedPercentage get(int n) {
                    return CTPresetColorImpl.this.getAlphaArray(n);
                }

                @Override
                public CTPositiveFixedPercentage set(int n, CTPositiveFixedPercentage cTPositiveFixedPercentage) {
                    CTPositiveFixedPercentage cTPositiveFixedPercentage2 = CTPresetColorImpl.this.getAlphaArray(n);
                    CTPresetColorImpl.this.setAlphaArray(n, cTPositiveFixedPercentage);
                    return cTPositiveFixedPercentage2;
                }

                @Override
                public void add(int n, CTPositiveFixedPercentage cTPositiveFixedPercentage) {
                    CTPresetColorImpl.this.insertNewAlpha(n).set(cTPositiveFixedPercentage);
                }

                @Override
                public CTPositiveFixedPercentage remove(int n) {
                    CTPositiveFixedPercentage cTPositiveFixedPercentage = CTPresetColorImpl.this.getAlphaArray(n);
                    CTPresetColorImpl.this.removeAlpha(n);
                    return cTPositiveFixedPercentage;
                }
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTFixedPercentage> {
                ...
                public CTFixedPercentage get(int n) {
                    return CTPresetColorImpl.this.getAlphaOffArray(n);
                }

                @Override
                public CTFixedPercentage set(int n, CTFixedPercentage cTFixedPercentage) {
                    CTFixedPercentage cTFixedPercentage2 = CTPresetColorImpl.this.getAlphaOffArray(n);
                    CTPresetColorImpl.this.setAlphaOffArray(n, cTFixedPercentage);
                    return cTFixedPercentage2;
                }

                @Override
                public void add(int n, CTFixedPercentage cTFixedPercentage) {
                    CTPresetColorImpl.this.insertNewAlphaOff(n).set(cTFixedPercentage);
                }

                @Override
                public CTFixedPercentage remove(int n) {
                    CTFixedPercentage cTFixedPercentage = CTPresetColorImpl.this.getAlphaOffArray(n);
                    CTPresetColorImpl.this.removeAlphaOff(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPositivePercentage> {
                ...
                public CTPositivePercentage get(int n) {
                    return CTPresetColorImpl.this.getAlphaModArray(n);
                }

                @Override
                public CTPositivePercentage set(int n, CTPositivePercentage cTPositivePercentage) {
                    CTPositivePercentage cTPositivePercentage2 = CTPresetColorImpl.this.getAlphaModArray(n);
                    CTPresetColorImpl.this.setAlphaModArray(n, cTPositivePercentage);
                    return cTPositivePercentage2;
                }

                @Override
                public void add(int n, CTPositivePercentage cTPositivePercentage) {
                    CTPresetColorImpl.this.insertNewAlphaMod(n).set(cTPositivePercentage);
                }

                @Override
                public CTPositivePercentage remove(int n) {
                    CTPositivePercentage cTPositivePercentage = CTPresetColorImpl.this.getAlphaModArray(n);
                    CTPresetColorImpl.this.removeAlphaMod(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPositiveFixedAngle> {
                ...
                public CTPositiveFixedAngle get(int n) {
                    return CTPresetColorImpl.this.getHueArray(n);
                }

                @Override
                public CTPositiveFixedAngle set(int n, CTPositiveFixedAngle cTPositiveFixedAngle) {
                    CTPositiveFixedAngle cTPositiveFixedAngle2 = CTPresetColorImpl.this.getHueArray(n);
                    CTPresetColorImpl.this.setHueArray(n, cTPositiveFixedAngle);
                    return cTPositiveFixedAngle2;
                }

                @Override
                public void add(int n, CTPositiveFixedAngle cTPositiveFixedAngle) {
                    CTPresetColorImpl.this.insertNewHue(n).set((XmlObject)cTPositiveFixedAngle);
                }

                @Override
                public CTPositiveFixedAngle remove(int n) {
                    CTPositiveFixedAngle cTPositiveFixedAngle = CTPresetColorImpl.this.getHueArray(n);
                    CTPresetColorImpl.this.removeHue(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTAngle> {
                ...
                public CTAngle get(int n) {
                    return CTPresetColorImpl.this.getHueOffArray(n);
                }

                @Override
                public CTAngle set(int n, CTAngle cTAngle) {
                    CTAngle cTAngle2 = CTPresetColorImpl.this.getHueOffArray(n);
                    CTPresetColorImpl.this.setHueOffArray(n, cTAngle);
                    return cTAngle2;
                }

                @Override
                public void add(int n, CTAngle cTAngle) {
                    CTPresetColorImpl.this.insertNewHueOff(n).set((XmlObject)cTAngle);
                }

                @Override
                public CTAngle remove(int n) {
                    CTAngle cTAngle = CTPresetColorImpl.this.getHueOffArray(n);
                    CTPresetColorImpl.this.removeHueOff(n);
                    return cTAngle;
                }
    ...
    public List<CTPositivePercentage> getHueModList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPositivePercentage> {
                ...
                @Override
                public CTPositivePercentage get(int n) {
                    return CTPresetColorImpl.this.getHueModArray(n);
                }

                @Override
                public CTPositivePercentage set(int n, CTPositivePercentage cTPositivePercentage) {
                    CTPositivePercentage cTPositivePercentage2 = CTPresetColorImpl.this.getHueModArray(n);
                    CTPresetColorImpl.this.setHueModArray(n, cTPositivePercentage);
                    return cTPositivePercentage2;
                }

                @Override
                public void add(int n, CTPositivePercentage cTPositivePercentage) {
                    CTPresetColorImpl.this.insertNewHueMod(n).set(cTPositivePercentage);
                }

                @Override
                public CTPositivePercentage remove(int n) {
                    CTPositivePercentage cTPositivePercentage = CTPresetColorImpl.this.getHueModArray(n);
                    CTPresetColorImpl.this.removeHueMod(n);
                    return cTPositivePercentage;
                }
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                public CTPercentage get(int n) {
                    return CTPresetColorImpl.this.getSatArray(n);
                }

                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTPresetColorImpl.this.getSatArray(n);
                    CTPresetColorImpl.this.setSatArray(n, cTPercentage);
                    return cTPercentage2;
                }

                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTPresetColorImpl.this.insertNewSat(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTPresetColorImpl.this.getSatArray(n);
                    CTPresetColorImpl.this.removeSat(n);
                    return cTPercentage;
                }
    ...
    public List<CTPercentage> getSatOffList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage get(int n) {
                    return CTPresetColorImpl.this.getSatOffArray(n);
                }

                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTPresetColorImpl.this.getSatOffArray(n);
                    CTPresetColorImpl.this.setSatOffArray(n, cTPercentage);
                    return cTPercentage2;
                }

                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTPresetColorImpl.this.insertNewSatOff(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTPresetColorImpl.this.getSatOffArray(n);
                    CTPresetColorImpl.this.removeSatOff(n);
                    return cTPercentage;
                }
    ...
    public List<CTPercentage> getSatModList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage get(int n) {
                    return CTPresetColorImpl.this.getSatModArray(n);
                }

                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTPresetColorImpl.this.getSatModArray(n);
                    CTPresetColorImpl.this.setSatModArray(n, cTPercentage);
                    return cTPercentage2;
                }

                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTPresetColorImpl.this.insertNewSatMod(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTPresetColorImpl.this.getSatModArray(n);
                    CTPresetColorImpl.this.removeSatMod(n);
                    return cTPercentage;
                }
    ...
    public List<CTPercentage> getLumList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage get(int n) {
                    return CTPresetColorImpl.this.getLumArray(n);
                }

                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTPresetColorImpl.this.getLumArray(n);
                    CTPresetColorImpl.this.setLumArray(n, cTPercentage);
                    return cTPercentage2;
                }

                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTPresetColorImpl.this.insertNewLum(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTPresetColorImpl.this.getLumArray(n);
                    CTPresetColorImpl.this.removeLum(n);
                    return cTPercentage;
                }
    ...
    public List<CTPercentage> getLumOffList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage get(int n) {
                    return CTPresetColorImpl.this.getLumOffArray(n);
                }

                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTPresetColorImpl.this.getLumOffArray(n);
                    CTPresetColorImpl.this.setLumOffArray(n, cTPercentage);
                    return cTPercentage2;
                }

                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTPresetColorImpl.this.insertNewLumOff(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTPresetColorImpl.this.getLumOffArray(n);
                    CTPresetColorImpl.this.removeLumOff(n);
                    return cTPercentage;
                }
    ...
    public List<CTPercentage> getLumModList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage get(int n) {
                    return CTPresetColorImpl.this.getLumModArray(n);
                }

                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTPresetColorImpl.this.getLumModArray(n);
                    CTPresetColorImpl.this.setLumModArray(n, cTPercentage);
                    return cTPercentage2;
                }

                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTPresetColorImpl.this.insertNewLumMod(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTPresetColorImpl.this.getLumModArray(n);
                    CTPresetColorImpl.this.removeLumMod(n);
                    return cTPercentage;
                }
    ...
    public List<CTPercentage> getRedList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage get(int n) {
                    return CTPresetColorImpl.this.getRedArray(n);
                }

                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTPresetColorImpl.this.getRedArray(n);
                    CTPresetColorImpl.this.setRedArray(n, cTPercentage);
                    return cTPercentage2;
                }

                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTPresetColorImpl.this.insertNewRed(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTPresetColorImpl.this.getRedArray(n);
                    CTPresetColorImpl.this.removeRed(n);
                    return cTPercentage;
                }
    ...
    public List<CTPercentage> getRedOffList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage get(int n) {
                    return CTPresetColorImpl.this.getRedOffArray(n);
                }

                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTPresetColorImpl.this.getRedOffArray(n);
                    CTPresetColorImpl.this.setRedOffArray(n, cTPercentage);
                    return cTPercentage2;
                }

                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTPresetColorImpl.this.insertNewRedOff(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTPresetColorImpl.this.getRedOffArray(n);
                    CTPresetColorImpl.this.removeRedOff(n);
                    return cTPercentage;
                }
    ...
    public List<CTPercentage> getRedModList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage get(int n) {
                    return CTPresetColorImpl.this.getRedModArray(n);
                }

                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTPresetColorImpl.this.getRedModArray(n);
                    CTPresetColorImpl.this.setRedModArray(n, cTPercentage);
                    return cTPercentage2;
                }

                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTPresetColorImpl.this.insertNewRedMod(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTPresetColorImpl.this.getRedModArray(n);
                    CTPresetColorImpl.this.removeRedMod(n);
                    return cTPercentage;
                }
    ...
    public List<CTPercentage> getGreenList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage get(int n) {
                    return CTPresetColorImpl.this.getGreenArray(n);
                }

                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTPresetColorImpl.this.getGreenArray(n);
                    CTPresetColorImpl.this.setGreenArray(n, cTPercentage);
                    return cTPercentage2;
                }

                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTPresetColorImpl.this.insertNewGreen(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTPresetColorImpl.this.getGreenArray(n);
                    CTPresetColorImpl.this.removeGreen(n);
                    return cTPercentage;
                }
    ...
    public List<CTPercentage> getGreenOffList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage get(int n) {
                    return CTPresetColorImpl.this.getGreenOffArray(n);
                }

                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTPresetColorImpl.this.getGreenOffArray(n);
                    CTPresetColorImpl.this.setGreenOffArray(n, cTPercentage);
                    return cTPercentage2;
                }

                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTPresetColorImpl.this.insertNewGreenOff(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTPresetColorImpl.this.getGreenOffArray(n);
                    CTPresetColorImpl.this.removeGreenOff(n);
                    return cTPercentage;
                }
    ...
    public List<CTPercentage> getGreenModList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage get(int n) {
                    return CTPresetColorImpl.this.getGreenModArray(n);
                }

                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTPresetColorImpl.this.getGreenModArray(n);
                    CTPresetColorImpl.this.setGreenModArray(n, cTPercentage);
                    return cTPercentage2;
                }

                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTPresetColorImpl.this.insertNewGreenMod(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTPresetColorImpl.this.getGreenModArray(n);
                    CTPresetColorImpl.this.removeGreenMod(n);
                    return cTPercentage;
                }
    ...
    public List<CTPercentage> getBlueList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage get(int n) {
                    return CTPresetColorImpl.this.getBlueArray(n);
                }

                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTPresetColorImpl.this.getBlueArray(n);
                    CTPresetColorImpl.this.setBlueArray(n, cTPercentage);
                    return cTPercentage2;
                }

                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTPresetColorImpl.this.insertNewBlue(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTPresetColorImpl.this.getBlueArray(n);
                    CTPresetColorImpl.this.removeBlue(n);
                    return cTPercentage;
                }
    ...
    public List<CTPercentage> getBlueOffList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage get(int n) {
                    return CTPresetColorImpl.this.getBlueOffArray(n);
                }

                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTPresetColorImpl.this.getBlueOffArray(n);
                    CTPresetColorImpl.this.setBlueOffArray(n, cTPercentage);
                    return cTPercentage2;
                }

                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTPresetColorImpl.this.insertNewBlueOff(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTPresetColorImpl.this.getBlueOffArray(n);
                    CTPresetColorImpl.this.removeBlueOff(n);
                    return cTPercentage;
                }
    ...
    public List<CTPercentage> getBlueModList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage get(int n) {
                    return CTPresetColorImpl.this.getBlueModArray(n);
                }

                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTPresetColorImpl.this.getBlueModArray(n);
                    CTPresetColorImpl.this.setBlueModArray(n, cTPercentage);
                    return cTPercentage2;
                }

                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTPresetColorImpl.this.insertNewBlueMod(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTPresetColorImpl.this.getBlueModArray(n);
                    CTPresetColorImpl.this.removeBlueMod(n);
                    return cTPercentage;
                }
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTGammaTransform> {
                ...
                public CTGammaTransform get(int n) {
                    return CTPresetColorImpl.this.getGammaArray(n);
                }

                @Override
                public CTGammaTransform set(int n, CTGammaTransform cTGammaTransform) {
                    CTGammaTransform cTGammaTransform2 = CTPresetColorImpl.this.getGammaArray(n);
                    CTPresetColorImpl.this.setGammaArray(n, cTGammaTransform);
                    return cTGammaTransform2;
                }

                @Override
                public void add(int n, CTGammaTransform cTGammaTransform) {
                    CTPresetColorImpl.this.insertNewGamma(n).set((XmlObject)cTGammaTransform);
                }

                @Override
                public CTGammaTransform remove(int n) {
                    CTGammaTransform cTGammaTransform = CTPresetColorImpl.this.getGammaArray(n);
                    CTPresetColorImpl.this.removeGamma(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTInverseGammaTransform> {
                ...
                public CTInverseGammaTransform get(int n) {
                    return CTPresetColorImpl.this.getInvGammaArray(n);
                }

                @Override
                public CTInverseGammaTransform set(int n, CTInverseGammaTransform cTInverseGammaTransform) {
                    CTInverseGammaTransform cTInverseGammaTransform2 = CTPresetColorImpl.this.getInvGammaArray(n);
                    CTPresetColorImpl.this.setInvGammaArray(n, cTInverseGammaTransform);
                    return cTInverseGammaTransform2;
                }

                @Override
                public void add(int n, CTInverseGammaTransform cTInverseGammaTransform) {
                    CTPresetColorImpl.this.insertNewInvGamma(n).set((XmlObject)cTInverseGammaTransform);
                }

                @Override
                public CTInverseGammaTransform remove(int n) {
                    CTInverseGammaTransform cTInverseGammaTransform = CTPresetColorImpl.this.getInvGammaArray(n);
                    CTPresetColorImpl.this.removeInvGamma(n);
    ...
    public STPresetColorVal.Enum getVal() {
        ...
        synchronized (object) {
            ...
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(VAL$56));
            if (simpleValue == null) {
                return null;
            }
    ...
    public STPresetColorVal xgetVal() {
        ...
        synchronized (object) {
            ...
            sTPresetColorVal = (STPresetColorVal)((Object)this.get_store().find_attribute_user(VAL$56));
     ...
     */
    @Override
    public void setVal(STPresetColorVal.Enum enum_) {
        Object object = this.monitor();
        synchronized (object) {
            this.check_orphaned();
            SimpleValue simpleValue = null;
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(VAL$56));
            if (simpleValue == null) {
                simpleValue = (SimpleValue)((Object)this.get_store().add_attribute_user(VAL$56));
            }
    ...
    public void xsetVal(STPresetColorVal sTPresetColorVal) {
        ...
        synchronized (object) {
            this.check_orphaned();
            STPresetColorVal sTPresetColorVal2 = null;
            sTPresetColorVal2 = (STPresetColorVal)((Object)this.get_store().find_attribute_user(VAL$56));
            if (sTPresetColorVal2 == null) {
                sTPresetColorVal2 = (STPresetColorVal)((Object)this.get_store().add_attribute_user(VAL$56));
            }
