...
implements CTGradientStop {
    ...
    public int getPos() {
        ...
        synchronized (object) {
            ...
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(POS$12));
            if (simpleValue == null) {
                return 0;
            }
    ...
    public STPositiveFixedPercentage xgetPos() {
        ...
        synchronized (object) {
            ...
            sTPositiveFixedPercentage = (STPositiveFixedPercentage)((Object)this.get_store().find_attribute_user(POS$12));
    ...
    public void setPos(int n) {
        ...
        synchronized (object) {
            ...
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(POS$12));
            if (simpleValue == null) {
                simpleValue = (SimpleValue)((Object)this.get_store().add_attribute_user(POS$12));
            }
    ...
    public void xsetPos(STPositiveFixedPercentage sTPositiveFixedPercentage) {
        ...
        synchronized (object) {
            ...
            sTPositiveFixedPercentage2 = (STPositiveFixedPercentage)((Object)this.get_store().find_attribute_user(POS$12));
            if (sTPositiveFixedPercentage2 == null) {
                sTPositiveFixedPercentage2 = (STPositiveFixedPercentage)((Object)this.get_store().add_attribute_user(POS$12));
            }
