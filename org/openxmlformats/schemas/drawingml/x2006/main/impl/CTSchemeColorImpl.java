...
implements CTSchemeColor {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPositiveFixedPercentage> {
                ...
                public CTPositiveFixedPercentage set(int n, CTPositiveFixedPercentage cTPositiveFixedPercentage) {
                    CTPositiveFixedPercentage cTPositiveFixedPercentage2 = CTSchemeColorImpl.this.getTintArray(n);
                ...
                public void add(int n, CTPositiveFixedPercentage cTPositiveFixedPercentage) {
                    CTSchemeColorImpl.this.insertNewTint(n).set(cTPositiveFixedPercentage);
                }

                @Override
                public CTPositiveFixedPercentage remove(int n) {
                    CTPositiveFixedPercentage cTPositiveFixedPercentage = CTSchemeColorImpl.this.getTintArray(n);
    ...
    public List<CTPositiveFixedPercentage> getShadeList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPositiveFixedPercentage> {
                ...
                @Override
                public CTPositiveFixedPercentage set(int n, CTPositiveFixedPercentage cTPositiveFixedPercentage) {
                    CTPositiveFixedPercentage cTPositiveFixedPercentage2 = CTSchemeColorImpl.this.getShadeArray(n);
                ...
                @Override
                public void add(int n, CTPositiveFixedPercentage cTPositiveFixedPercentage) {
                    CTSchemeColorImpl.this.insertNewShade(n).set(cTPositiveFixedPercentage);
                }

                @Override
                public CTPositiveFixedPercentage remove(int n) {
                    CTPositiveFixedPercentage cTPositiveFixedPercentage = CTSchemeColorImpl.this.getShadeArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTComplementTransform> {
                ...
                public CTComplementTransform set(int n, CTComplementTransform cTComplementTransform) {
                    CTComplementTransform cTComplementTransform2 = CTSchemeColorImpl.this.getCompArray(n);
                ...
                public CTComplementTransform remove(int n) {
                    CTComplementTransform cTComplementTransform = CTSchemeColorImpl.this.getCompArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTInverseTransform> {
                ...
                public CTInverseTransform set(int n, CTInverseTransform cTInverseTransform) {
                    CTInverseTransform cTInverseTransform2 = CTSchemeColorImpl.this.getInvArray(n);
                ...
                public CTInverseTransform remove(int n) {
                    CTInverseTransform cTInverseTransform = CTSchemeColorImpl.this.getInvArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTGrayscaleTransform> {
                ...
                public CTGrayscaleTransform set(int n, CTGrayscaleTransform cTGrayscaleTransform) {
                    CTGrayscaleTransform cTGrayscaleTransform2 = CTSchemeColorImpl.this.getGrayArray(n);
                ...
                public CTGrayscaleTransform remove(int n) {
                    CTGrayscaleTransform cTGrayscaleTransform = CTSchemeColorImpl.this.getGrayArray(n);
    ...
    public List<CTPositiveFixedPercentage> getAlphaList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPositiveFixedPercentage> {
                ...
                @Override
                public CTPositiveFixedPercentage set(int n, CTPositiveFixedPercentage cTPositiveFixedPercentage) {
                    CTPositiveFixedPercentage cTPositiveFixedPercentage2 = CTSchemeColorImpl.this.getAlphaArray(n);
                ...
                @Override
                public void add(int n, CTPositiveFixedPercentage cTPositiveFixedPercentage) {
                    CTSchemeColorImpl.this.insertNewAlpha(n).set(cTPositiveFixedPercentage);
                }

                @Override
                public CTPositiveFixedPercentage remove(int n) {
                    CTPositiveFixedPercentage cTPositiveFixedPercentage = CTSchemeColorImpl.this.getAlphaArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTFixedPercentage> {
                ...
                public CTFixedPercentage set(int n, CTFixedPercentage cTFixedPercentage) {
                    CTFixedPercentage cTFixedPercentage2 = CTSchemeColorImpl.this.getAlphaOffArray(n);
                ...
                public void add(int n, CTFixedPercentage cTFixedPercentage) {
                    CTSchemeColorImpl.this.insertNewAlphaOff(n).set(cTFixedPercentage);
                }

                @Override
                public CTFixedPercentage remove(int n) {
                    CTFixedPercentage cTFixedPercentage = CTSchemeColorImpl.this.getAlphaOffArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPositivePercentage> {
                ...
                public CTPositivePercentage set(int n, CTPositivePercentage cTPositivePercentage) {
                    CTPositivePercentage cTPositivePercentage2 = CTSchemeColorImpl.this.getAlphaModArray(n);
                ...
                public void add(int n, CTPositivePercentage cTPositivePercentage) {
                    CTSchemeColorImpl.this.insertNewAlphaMod(n).set(cTPositivePercentage);
                }

                @Override
                public CTPositivePercentage remove(int n) {
                    CTPositivePercentage cTPositivePercentage = CTSchemeColorImpl.this.getAlphaModArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPositiveFixedAngle> {
                ...
                public CTPositiveFixedAngle set(int n, CTPositiveFixedAngle cTPositiveFixedAngle) {
                    CTPositiveFixedAngle cTPositiveFixedAngle2 = CTSchemeColorImpl.this.getHueArray(n);
                ...
                public CTPositiveFixedAngle remove(int n) {
                    CTPositiveFixedAngle cTPositiveFixedAngle = CTSchemeColorImpl.this.getHueArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTAngle> {
                ...
                public CTAngle set(int n, CTAngle cTAngle) {
                    CTAngle cTAngle2 = CTSchemeColorImpl.this.getHueOffArray(n);
                ...
                public CTAngle remove(int n) {
                    CTAngle cTAngle = CTSchemeColorImpl.this.getHueOffArray(n);
    ...
    public List<CTPositivePercentage> getHueModList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPositivePercentage> {
                ...
                @Override
                public CTPositivePercentage set(int n, CTPositivePercentage cTPositivePercentage) {
                    CTPositivePercentage cTPositivePercentage2 = CTSchemeColorImpl.this.getHueModArray(n);
                ...
                @Override
                public void add(int n, CTPositivePercentage cTPositivePercentage) {
                    CTSchemeColorImpl.this.insertNewHueMod(n).set(cTPositivePercentage);
                }

                @Override
                public CTPositivePercentage remove(int n) {
                    CTPositivePercentage cTPositivePercentage = CTSchemeColorImpl.this.getHueModArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSchemeColorImpl.this.getSatArray(n);
                ...
                public void add(int n, CTPercentage cTPercentage) {
                    CTSchemeColorImpl.this.insertNewSat(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSchemeColorImpl.this.getSatArray(n);
    ...
    public List<CTPercentage> getSatOffList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSchemeColorImpl.this.getSatOffArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSchemeColorImpl.this.insertNewSatOff(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSchemeColorImpl.this.getSatOffArray(n);
    ...
    public List<CTPercentage> getSatModList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSchemeColorImpl.this.getSatModArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSchemeColorImpl.this.insertNewSatMod(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSchemeColorImpl.this.getSatModArray(n);
    ...
    public List<CTPercentage> getLumList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSchemeColorImpl.this.getLumArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSchemeColorImpl.this.insertNewLum(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSchemeColorImpl.this.getLumArray(n);
    ...
    public List<CTPercentage> getLumOffList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSchemeColorImpl.this.getLumOffArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSchemeColorImpl.this.insertNewLumOff(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSchemeColorImpl.this.getLumOffArray(n);
    ...
    public List<CTPercentage> getLumModList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSchemeColorImpl.this.getLumModArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSchemeColorImpl.this.insertNewLumMod(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSchemeColorImpl.this.getLumModArray(n);
    ...
    public List<CTPercentage> getRedList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSchemeColorImpl.this.getRedArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSchemeColorImpl.this.insertNewRed(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSchemeColorImpl.this.getRedArray(n);
    ...
    public List<CTPercentage> getRedOffList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSchemeColorImpl.this.getRedOffArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSchemeColorImpl.this.insertNewRedOff(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSchemeColorImpl.this.getRedOffArray(n);
    ...
    public List<CTPercentage> getRedModList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSchemeColorImpl.this.getRedModArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSchemeColorImpl.this.insertNewRedMod(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSchemeColorImpl.this.getRedModArray(n);
    ...
    public List<CTPercentage> getGreenList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSchemeColorImpl.this.getGreenArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSchemeColorImpl.this.insertNewGreen(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSchemeColorImpl.this.getGreenArray(n);
    ...
    public List<CTPercentage> getGreenOffList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSchemeColorImpl.this.getGreenOffArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSchemeColorImpl.this.insertNewGreenOff(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSchemeColorImpl.this.getGreenOffArray(n);
    ...
    public List<CTPercentage> getGreenModList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSchemeColorImpl.this.getGreenModArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSchemeColorImpl.this.insertNewGreenMod(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSchemeColorImpl.this.getGreenModArray(n);
    ...
    public List<CTPercentage> getBlueList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSchemeColorImpl.this.getBlueArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSchemeColorImpl.this.insertNewBlue(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSchemeColorImpl.this.getBlueArray(n);
    ...
    public List<CTPercentage> getBlueOffList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSchemeColorImpl.this.getBlueOffArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSchemeColorImpl.this.insertNewBlueOff(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSchemeColorImpl.this.getBlueOffArray(n);
    ...
    public List<CTPercentage> getBlueModList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSchemeColorImpl.this.getBlueModArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSchemeColorImpl.this.insertNewBlueMod(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSchemeColorImpl.this.getBlueModArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTGammaTransform> {
                ...
                public CTGammaTransform set(int n, CTGammaTransform cTGammaTransform) {
                    CTGammaTransform cTGammaTransform2 = CTSchemeColorImpl.this.getGammaArray(n);
                ...
                public CTGammaTransform remove(int n) {
                    CTGammaTransform cTGammaTransform = CTSchemeColorImpl.this.getGammaArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTInverseGammaTransform> {
                ...
                public CTInverseGammaTransform set(int n, CTInverseGammaTransform cTInverseGammaTransform) {
                    CTInverseGammaTransform cTInverseGammaTransform2 = CTSchemeColorImpl.this.getInvGammaArray(n);
                ...
                public CTInverseGammaTransform remove(int n) {
                    CTInverseGammaTransform cTInverseGammaTransform = CTSchemeColorImpl.this.getInvGammaArray(n);
    ...
    public STSchemeColorVal xgetVal() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STSchemeColorVal sTSchemeColorVal = null;
            sTSchemeColorVal = (STSchemeColorVal)((Object)this.get_store().find_attribute_user(VAL$56));
     ...
     */
    @Override
    public void setVal(STSchemeColorVal.Enum enum_) {
        Object object = this.monitor();
        synchronized (object) {
            this.check_orphaned();
            SimpleValue simpleValue = null;
    ...
    public void xsetVal(STSchemeColorVal sTSchemeColorVal) {
        ...
        synchronized (object) {
            this.check_orphaned();
            STSchemeColorVal sTSchemeColorVal2 = null;
            sTSchemeColorVal2 = (STSchemeColorVal)((Object)this.get_store().find_attribute_user(VAL$56));
            if (sTSchemeColorVal2 == null) {
                sTSchemeColorVal2 = (STSchemeColorVal)((Object)this.get_store().add_attribute_user(VAL$56));
            }
