...
implements CTSRgbColor {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPositiveFixedPercentage> {
                ...
                public CTPositiveFixedPercentage set(int n, CTPositiveFixedPercentage cTPositiveFixedPercentage) {
                    CTPositiveFixedPercentage cTPositiveFixedPercentage2 = CTSRgbColorImpl.this.getTintArray(n);
                ...
                public void add(int n, CTPositiveFixedPercentage cTPositiveFixedPercentage) {
                    CTSRgbColorImpl.this.insertNewTint(n).set(cTPositiveFixedPercentage);
                }

                @Override
                public CTPositiveFixedPercentage remove(int n) {
                    CTPositiveFixedPercentage cTPositiveFixedPercentage = CTSRgbColorImpl.this.getTintArray(n);
    ...
    public List<CTPositiveFixedPercentage> getShadeList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPositiveFixedPercentage> {
                ...
                @Override
                public CTPositiveFixedPercentage set(int n, CTPositiveFixedPercentage cTPositiveFixedPercentage) {
                    CTPositiveFixedPercentage cTPositiveFixedPercentage2 = CTSRgbColorImpl.this.getShadeArray(n);
                ...
                @Override
                public void add(int n, CTPositiveFixedPercentage cTPositiveFixedPercentage) {
                    CTSRgbColorImpl.this.insertNewShade(n).set(cTPositiveFixedPercentage);
                }

                @Override
                public CTPositiveFixedPercentage remove(int n) {
                    CTPositiveFixedPercentage cTPositiveFixedPercentage = CTSRgbColorImpl.this.getShadeArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTComplementTransform> {
                ...
                public CTComplementTransform set(int n, CTComplementTransform cTComplementTransform) {
                    CTComplementTransform cTComplementTransform2 = CTSRgbColorImpl.this.getCompArray(n);
                ...
                public CTComplementTransform remove(int n) {
                    CTComplementTransform cTComplementTransform = CTSRgbColorImpl.this.getCompArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTInverseTransform> {
                ...
                public CTInverseTransform set(int n, CTInverseTransform cTInverseTransform) {
                    CTInverseTransform cTInverseTransform2 = CTSRgbColorImpl.this.getInvArray(n);
                ...
                public CTInverseTransform remove(int n) {
                    CTInverseTransform cTInverseTransform = CTSRgbColorImpl.this.getInvArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTGrayscaleTransform> {
                ...
                public CTGrayscaleTransform set(int n, CTGrayscaleTransform cTGrayscaleTransform) {
                    CTGrayscaleTransform cTGrayscaleTransform2 = CTSRgbColorImpl.this.getGrayArray(n);
                ...
                public CTGrayscaleTransform remove(int n) {
                    CTGrayscaleTransform cTGrayscaleTransform = CTSRgbColorImpl.this.getGrayArray(n);
    ...
    public List<CTPositiveFixedPercentage> getAlphaList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPositiveFixedPercentage> {
                ...
                @Override
                public CTPositiveFixedPercentage set(int n, CTPositiveFixedPercentage cTPositiveFixedPercentage) {
                    CTPositiveFixedPercentage cTPositiveFixedPercentage2 = CTSRgbColorImpl.this.getAlphaArray(n);
                ...
                @Override
                public void add(int n, CTPositiveFixedPercentage cTPositiveFixedPercentage) {
                    CTSRgbColorImpl.this.insertNewAlpha(n).set(cTPositiveFixedPercentage);
                }

                @Override
                public CTPositiveFixedPercentage remove(int n) {
                    CTPositiveFixedPercentage cTPositiveFixedPercentage = CTSRgbColorImpl.this.getAlphaArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTFixedPercentage> {
                ...
                public CTFixedPercentage set(int n, CTFixedPercentage cTFixedPercentage) {
                    CTFixedPercentage cTFixedPercentage2 = CTSRgbColorImpl.this.getAlphaOffArray(n);
                ...
                public void add(int n, CTFixedPercentage cTFixedPercentage) {
                    CTSRgbColorImpl.this.insertNewAlphaOff(n).set(cTFixedPercentage);
                }

                @Override
                public CTFixedPercentage remove(int n) {
                    CTFixedPercentage cTFixedPercentage = CTSRgbColorImpl.this.getAlphaOffArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPositivePercentage> {
                ...
                public CTPositivePercentage set(int n, CTPositivePercentage cTPositivePercentage) {
                    CTPositivePercentage cTPositivePercentage2 = CTSRgbColorImpl.this.getAlphaModArray(n);
                ...
                public void add(int n, CTPositivePercentage cTPositivePercentage) {
                    CTSRgbColorImpl.this.insertNewAlphaMod(n).set(cTPositivePercentage);
                }

                @Override
                public CTPositivePercentage remove(int n) {
                    CTPositivePercentage cTPositivePercentage = CTSRgbColorImpl.this.getAlphaModArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPositiveFixedAngle> {
                ...
                public CTPositiveFixedAngle set(int n, CTPositiveFixedAngle cTPositiveFixedAngle) {
                    CTPositiveFixedAngle cTPositiveFixedAngle2 = CTSRgbColorImpl.this.getHueArray(n);
                ...
                public CTPositiveFixedAngle remove(int n) {
                    CTPositiveFixedAngle cTPositiveFixedAngle = CTSRgbColorImpl.this.getHueArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTAngle> {
                ...
                public CTAngle set(int n, CTAngle cTAngle) {
                    CTAngle cTAngle2 = CTSRgbColorImpl.this.getHueOffArray(n);
                ...
                public CTAngle remove(int n) {
                    CTAngle cTAngle = CTSRgbColorImpl.this.getHueOffArray(n);
    ...
    public List<CTPositivePercentage> getHueModList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPositivePercentage> {
                ...
                @Override
                public CTPositivePercentage set(int n, CTPositivePercentage cTPositivePercentage) {
                    CTPositivePercentage cTPositivePercentage2 = CTSRgbColorImpl.this.getHueModArray(n);
                ...
                @Override
                public void add(int n, CTPositivePercentage cTPositivePercentage) {
                    CTSRgbColorImpl.this.insertNewHueMod(n).set(cTPositivePercentage);
                }

                @Override
                public CTPositivePercentage remove(int n) {
                    CTPositivePercentage cTPositivePercentage = CTSRgbColorImpl.this.getHueModArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSRgbColorImpl.this.getSatArray(n);
                ...
                public void add(int n, CTPercentage cTPercentage) {
                    CTSRgbColorImpl.this.insertNewSat(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSRgbColorImpl.this.getSatArray(n);
    ...
    public List<CTPercentage> getSatOffList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSRgbColorImpl.this.getSatOffArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSRgbColorImpl.this.insertNewSatOff(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSRgbColorImpl.this.getSatOffArray(n);
    ...
    public List<CTPercentage> getSatModList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSRgbColorImpl.this.getSatModArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSRgbColorImpl.this.insertNewSatMod(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSRgbColorImpl.this.getSatModArray(n);
    ...
    public List<CTPercentage> getLumList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSRgbColorImpl.this.getLumArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSRgbColorImpl.this.insertNewLum(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSRgbColorImpl.this.getLumArray(n);
    ...
    public List<CTPercentage> getLumOffList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSRgbColorImpl.this.getLumOffArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSRgbColorImpl.this.insertNewLumOff(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSRgbColorImpl.this.getLumOffArray(n);
    ...
    public List<CTPercentage> getLumModList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSRgbColorImpl.this.getLumModArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSRgbColorImpl.this.insertNewLumMod(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSRgbColorImpl.this.getLumModArray(n);
    ...
    public List<CTPercentage> getRedList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSRgbColorImpl.this.getRedArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSRgbColorImpl.this.insertNewRed(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSRgbColorImpl.this.getRedArray(n);
    ...
    public List<CTPercentage> getRedOffList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSRgbColorImpl.this.getRedOffArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSRgbColorImpl.this.insertNewRedOff(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSRgbColorImpl.this.getRedOffArray(n);
    ...
    public List<CTPercentage> getRedModList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSRgbColorImpl.this.getRedModArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSRgbColorImpl.this.insertNewRedMod(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSRgbColorImpl.this.getRedModArray(n);
    ...
    public List<CTPercentage> getGreenList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSRgbColorImpl.this.getGreenArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSRgbColorImpl.this.insertNewGreen(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSRgbColorImpl.this.getGreenArray(n);
    ...
    public List<CTPercentage> getGreenOffList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSRgbColorImpl.this.getGreenOffArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSRgbColorImpl.this.insertNewGreenOff(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSRgbColorImpl.this.getGreenOffArray(n);
    ...
    public List<CTPercentage> getGreenModList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSRgbColorImpl.this.getGreenModArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSRgbColorImpl.this.insertNewGreenMod(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSRgbColorImpl.this.getGreenModArray(n);
    ...
    public List<CTPercentage> getBlueList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSRgbColorImpl.this.getBlueArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSRgbColorImpl.this.insertNewBlue(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSRgbColorImpl.this.getBlueArray(n);
    ...
    public List<CTPercentage> getBlueOffList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSRgbColorImpl.this.getBlueOffArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSRgbColorImpl.this.insertNewBlueOff(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSRgbColorImpl.this.getBlueOffArray(n);
    ...
    public List<CTPercentage> getBlueModList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPercentage> {
                ...
                @Override
                public CTPercentage set(int n, CTPercentage cTPercentage) {
                    CTPercentage cTPercentage2 = CTSRgbColorImpl.this.getBlueModArray(n);
                ...
                @Override
                public void add(int n, CTPercentage cTPercentage) {
                    CTSRgbColorImpl.this.insertNewBlueMod(n).set(cTPercentage);
                }

                @Override
                public CTPercentage remove(int n) {
                    CTPercentage cTPercentage = CTSRgbColorImpl.this.getBlueModArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTGammaTransform> {
                ...
                public CTGammaTransform set(int n, CTGammaTransform cTGammaTransform) {
                    CTGammaTransform cTGammaTransform2 = CTSRgbColorImpl.this.getGammaArray(n);
                ...
                public CTGammaTransform remove(int n) {
                    CTGammaTransform cTGammaTransform = CTSRgbColorImpl.this.getGammaArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTInverseGammaTransform> {
                ...
                public CTInverseGammaTransform set(int n, CTInverseGammaTransform cTInverseGammaTransform) {
                    CTInverseGammaTransform cTInverseGammaTransform2 = CTSRgbColorImpl.this.getInvGammaArray(n);
                ...
                public CTInverseGammaTransform remove(int n) {
                    CTInverseGammaTransform cTInverseGammaTransform = CTSRgbColorImpl.this.getInvGammaArray(n);
    ...
    public STHexBinary3 xgetVal() {
        ...
        synchronized (object) {
            ...
            sTHexBinary3 = (STHexBinary3)((Object)this.get_store().find_attribute_user(VAL$56));
            return sTHexBinary3;
        }
    }
     ...
     */
    @Override
    public void setVal(byte[] byArray) {
        Object object = this.monitor();
        synchronized (object) {
            this.check_orphaned();
            SimpleValue simpleValue = null;
    ...
    public void xsetVal(STHexBinary3 sTHexBinary3) {
        ...
        synchronized (object) {
            ...
            sTHexBinary32 = (STHexBinary3)((Object)this.get_store().find_attribute_user(VAL$56));
            if (sTHexBinary32 == null) {
                sTHexBinary32 = (STHexBinary3)((Object)this.get_store().add_attribute_user(VAL$56));
            }
