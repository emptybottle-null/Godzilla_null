        ...
        synchronized (object) {
            ...
            extends AbstractList<CTNoFillProperties> {
                ...
                public CTNoFillProperties set(int n, CTNoFillProperties cTNoFillProperties) {
                    CTNoFillProperties cTNoFillProperties2 = CTFillStyleListImpl.this.getNoFillArray(n);
                ...
                public void add(int n, CTNoFillProperties cTNoFillProperties) {
                    CTFillStyleListImpl.this.insertNewNoFill(n).set(cTNoFillProperties);
                }

                @Override
                public CTNoFillProperties remove(int n) {
                    CTNoFillProperties cTNoFillProperties = CTFillStyleListImpl.this.getNoFillArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTSolidColorFillProperties> {
                ...
                public CTSolidColorFillProperties set(int n, CTSolidColorFillProperties cTSolidColorFillProperties) {
                    CTSolidColorFillProperties cTSolidColorFillProperties2 = CTFillStyleListImpl.this.getSolidFillArray(n);
                ...
                public void add(int n, CTSolidColorFillProperties cTSolidColorFillProperties) {
                    CTFillStyleListImpl.this.insertNewSolidFill(n).set(cTSolidColorFillProperties);
                }

                @Override
                public CTSolidColorFillProperties remove(int n) {
                    CTSolidColorFillProperties cTSolidColorFillProperties = CTFillStyleListImpl.this.getSolidFillArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTGradientFillProperties> {
                ...
                public CTGradientFillProperties set(int n, CTGradientFillProperties cTGradientFillProperties) {
                    CTGradientFillProperties cTGradientFillProperties2 = CTFillStyleListImpl.this.getGradFillArray(n);
                ...
                public void add(int n, CTGradientFillProperties cTGradientFillProperties) {
                    CTFillStyleListImpl.this.insertNewGradFill(n).set(cTGradientFillProperties);
                }

                @Override
                public CTGradientFillProperties remove(int n) {
                    CTGradientFillProperties cTGradientFillProperties = CTFillStyleListImpl.this.getGradFillArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTBlipFillProperties> {
                ...
                public CTBlipFillProperties set(int n, CTBlipFillProperties cTBlipFillProperties) {
                    CTBlipFillProperties cTBlipFillProperties2 = CTFillStyleListImpl.this.getBlipFillArray(n);
                ...
                public void add(int n, CTBlipFillProperties cTBlipFillProperties) {
                    CTFillStyleListImpl.this.insertNewBlipFill(n).set(cTBlipFillProperties);
                }

                @Override
                public CTBlipFillProperties remove(int n) {
                    CTBlipFillProperties cTBlipFillProperties = CTFillStyleListImpl.this.getBlipFillArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPatternFillProperties> {
                ...
                public CTPatternFillProperties set(int n, CTPatternFillProperties cTPatternFillProperties) {
                    CTPatternFillProperties cTPatternFillProperties2 = CTFillStyleListImpl.this.getPattFillArray(n);
                ...
                public void add(int n, CTPatternFillProperties cTPatternFillProperties) {
                    CTFillStyleListImpl.this.insertNewPattFill(n).set(cTPatternFillProperties);
                }

                @Override
                public CTPatternFillProperties remove(int n) {
                    CTPatternFillProperties cTPatternFillProperties = CTFillStyleListImpl.this.getPattFillArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTGroupFillProperties> {
                ...
                public CTGroupFillProperties set(int n, CTGroupFillProperties cTGroupFillProperties) {
                    CTGroupFillProperties cTGroupFillProperties2 = CTFillStyleListImpl.this.getGrpFillArray(n);
                ...
                public void add(int n, CTGroupFillProperties cTGroupFillProperties) {
                    CTFillStyleListImpl.this.insertNewGrpFill(n).set(cTGroupFillProperties);
                }

                @Override
                public CTGroupFillProperties remove(int n) {
                    CTGroupFillProperties cTGroupFillProperties = CTFillStyleListImpl.this.getGrpFillArray(n);
