    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTEmptyElement.class.getClassLoader());
        ...
        public static CTEmptyElement newInstance() {
            return (CTEmptyElement)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTEmptyElement newInstance(XmlOptions xmlOptions) {
            return (CTEmptyElement)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTEmptyElement parse(String string) throws XmlException {
            return (CTEmptyElement)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTEmptyElement parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTEmptyElement)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTEmptyElement parse(File file) throws XmlException, IOException {
            return (CTEmptyElement)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTEmptyElement parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTEmptyElement)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTEmptyElement parse(URL uRL) throws XmlException, IOException {
            return (CTEmptyElement)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTEmptyElement parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTEmptyElement)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTEmptyElement parse(InputStream inputStream) throws XmlException, IOException {
            return (CTEmptyElement)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTEmptyElement parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTEmptyElement)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTEmptyElement parse(Reader reader) throws XmlException, IOException {
            return (CTEmptyElement)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTEmptyElement parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTEmptyElement)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTEmptyElement parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTEmptyElement)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTEmptyElement parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTEmptyElement)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTEmptyElement parse(Node node) throws XmlException {
            return (CTEmptyElement)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTEmptyElement parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTEmptyElement)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTEmptyElement parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTEmptyElement)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTEmptyElement parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTEmptyElement)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
