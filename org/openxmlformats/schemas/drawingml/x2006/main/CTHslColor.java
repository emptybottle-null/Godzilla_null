...
extends XmlObject {
    public static final SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CTHslColor.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sD023D6490046BA0250A839A9AD24C443").resolveHandle("cthslcolora63dtype");
    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTHslColor.class.getClassLoader());
        ...
        public static CTHslColor newInstance() {
            return (CTHslColor)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTHslColor newInstance(XmlOptions xmlOptions) {
            return (CTHslColor)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTHslColor parse(String string) throws XmlException {
            return (CTHslColor)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTHslColor parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTHslColor)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTHslColor parse(File file) throws XmlException, IOException {
            return (CTHslColor)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTHslColor parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTHslColor)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTHslColor parse(URL uRL) throws XmlException, IOException {
            return (CTHslColor)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTHslColor parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTHslColor)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTHslColor parse(InputStream inputStream) throws XmlException, IOException {
            return (CTHslColor)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTHslColor parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTHslColor)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTHslColor parse(Reader reader) throws XmlException, IOException {
            return (CTHslColor)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTHslColor parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTHslColor)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTHslColor parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTHslColor)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTHslColor parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTHslColor)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTHslColor parse(Node node) throws XmlException {
            return (CTHslColor)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTHslColor parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTHslColor)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTHslColor parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTHslColor)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTHslColor parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTHslColor)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
