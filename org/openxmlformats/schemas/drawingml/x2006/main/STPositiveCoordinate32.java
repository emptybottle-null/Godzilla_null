...
public interface STPositiveCoordinate32
extends STCoordinate32 {
    ...
    public static final class Factory {
        ...
        public static STPositiveCoordinate32 newValue(Object object) {
            return (STPositiveCoordinate32)type.newValue(object);
        }
        ...
        public static STPositiveCoordinate32 newInstance() {
            return (STPositiveCoordinate32)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STPositiveCoordinate32 newInstance(XmlOptions xmlOptions) {
            return (STPositiveCoordinate32)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STPositiveCoordinate32 parse(String string) throws XmlException {
            return (STPositiveCoordinate32)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STPositiveCoordinate32 parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STPositiveCoordinate32)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STPositiveCoordinate32 parse(File file) throws XmlException, IOException {
            return (STPositiveCoordinate32)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STPositiveCoordinate32 parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPositiveCoordinate32)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STPositiveCoordinate32 parse(URL uRL) throws XmlException, IOException {
            return (STPositiveCoordinate32)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STPositiveCoordinate32 parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPositiveCoordinate32)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STPositiveCoordinate32 parse(InputStream inputStream) throws XmlException, IOException {
            return (STPositiveCoordinate32)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static STPositiveCoordinate32 parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPositiveCoordinate32)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static STPositiveCoordinate32 parse(Reader reader) throws XmlException, IOException {
            return (STPositiveCoordinate32)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static STPositiveCoordinate32 parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPositiveCoordinate32)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static STPositiveCoordinate32 parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STPositiveCoordinate32)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static STPositiveCoordinate32 parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STPositiveCoordinate32)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static STPositiveCoordinate32 parse(Node node) throws XmlException {
            return (STPositiveCoordinate32)Factory.getTypeLoader().parse(node, type, null);
        }

        public static STPositiveCoordinate32 parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STPositiveCoordinate32)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static STPositiveCoordinate32 parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (STPositiveCoordinate32)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static STPositiveCoordinate32 parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STPositiveCoordinate32)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
