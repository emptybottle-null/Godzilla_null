    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTTextSpacingPoint.class.getClassLoader());
        ...
        public static CTTextSpacingPoint newInstance() {
            return (CTTextSpacingPoint)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTTextSpacingPoint newInstance(XmlOptions xmlOptions) {
            return (CTTextSpacingPoint)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTTextSpacingPoint parse(String string) throws XmlException {
            return (CTTextSpacingPoint)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTTextSpacingPoint parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTTextSpacingPoint)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTTextSpacingPoint parse(File file) throws XmlException, IOException {
            return (CTTextSpacingPoint)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTTextSpacingPoint parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTextSpacingPoint)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTTextSpacingPoint parse(URL uRL) throws XmlException, IOException {
            return (CTTextSpacingPoint)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTTextSpacingPoint parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTextSpacingPoint)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTTextSpacingPoint parse(InputStream inputStream) throws XmlException, IOException {
            return (CTTextSpacingPoint)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTTextSpacingPoint parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTextSpacingPoint)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTTextSpacingPoint parse(Reader reader) throws XmlException, IOException {
            return (CTTextSpacingPoint)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTTextSpacingPoint parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTextSpacingPoint)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTTextSpacingPoint parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTTextSpacingPoint)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTTextSpacingPoint parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTTextSpacingPoint)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTTextSpacingPoint parse(Node node) throws XmlException {
            return (CTTextSpacingPoint)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTTextSpacingPoint parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTTextSpacingPoint)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTTextSpacingPoint parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTTextSpacingPoint)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTTextSpacingPoint parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTTextSpacingPoint)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
