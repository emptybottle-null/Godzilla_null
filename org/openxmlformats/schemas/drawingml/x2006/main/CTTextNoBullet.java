    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTTextNoBullet.class.getClassLoader());
        ...
        public static CTTextNoBullet newInstance() {
            return (CTTextNoBullet)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTTextNoBullet newInstance(XmlOptions xmlOptions) {
            return (CTTextNoBullet)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTTextNoBullet parse(String string) throws XmlException {
            return (CTTextNoBullet)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTTextNoBullet parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTTextNoBullet)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTTextNoBullet parse(File file) throws XmlException, IOException {
            return (CTTextNoBullet)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTTextNoBullet parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTextNoBullet)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTTextNoBullet parse(URL uRL) throws XmlException, IOException {
            return (CTTextNoBullet)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTTextNoBullet parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTextNoBullet)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTTextNoBullet parse(InputStream inputStream) throws XmlException, IOException {
            return (CTTextNoBullet)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTTextNoBullet parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTextNoBullet)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTTextNoBullet parse(Reader reader) throws XmlException, IOException {
            return (CTTextNoBullet)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTTextNoBullet parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTextNoBullet)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTTextNoBullet parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTTextNoBullet)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTTextNoBullet parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTTextNoBullet)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTTextNoBullet parse(Node node) throws XmlException {
            return (CTTextNoBullet)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTTextNoBullet parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTTextNoBullet)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTTextNoBullet parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTTextNoBullet)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTTextNoBullet parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTTextNoBullet)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
