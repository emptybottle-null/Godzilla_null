...
extends XmlObject {
    public static final SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CTSystemColor.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sD023D6490046BA0250A839A9AD24C443").resolveHandle("ctsystemcolor4525type");
    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTSystemColor.class.getClassLoader());
        ...
        public static CTSystemColor newInstance() {
            return (CTSystemColor)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTSystemColor newInstance(XmlOptions xmlOptions) {
            return (CTSystemColor)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTSystemColor parse(String string) throws XmlException {
            return (CTSystemColor)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTSystemColor parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTSystemColor)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTSystemColor parse(File file) throws XmlException, IOException {
            return (CTSystemColor)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTSystemColor parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSystemColor)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTSystemColor parse(URL uRL) throws XmlException, IOException {
            return (CTSystemColor)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTSystemColor parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSystemColor)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTSystemColor parse(InputStream inputStream) throws XmlException, IOException {
            return (CTSystemColor)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTSystemColor parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSystemColor)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTSystemColor parse(Reader reader) throws XmlException, IOException {
            return (CTSystemColor)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTSystemColor parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSystemColor)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTSystemColor parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTSystemColor)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTSystemColor parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTSystemColor)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTSystemColor parse(Node node) throws XmlException {
            return (CTSystemColor)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTSystemColor parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTSystemColor)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTSystemColor parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTSystemColor)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTSystemColor parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTSystemColor)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
