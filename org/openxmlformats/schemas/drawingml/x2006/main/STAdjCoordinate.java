...
extends XmlAnySimpleType {
    ...
    public static final class Factory {
        ...
        public static STAdjCoordinate newValue(Object object) {
            return (STAdjCoordinate)type.newValue(object);
        }
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(STAdjCoordinate.class.getClassLoader());
        ...
        public static STAdjCoordinate newInstance() {
            return (STAdjCoordinate)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STAdjCoordinate newInstance(XmlOptions xmlOptions) {
            return (STAdjCoordinate)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STAdjCoordinate parse(String string) throws XmlException {
            return (STAdjCoordinate)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STAdjCoordinate parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STAdjCoordinate)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STAdjCoordinate parse(File file) throws XmlException, IOException {
            return (STAdjCoordinate)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STAdjCoordinate parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STAdjCoordinate)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STAdjCoordinate parse(URL uRL) throws XmlException, IOException {
            return (STAdjCoordinate)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STAdjCoordinate parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STAdjCoordinate)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STAdjCoordinate parse(InputStream inputStream) throws XmlException, IOException {
            return (STAdjCoordinate)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static STAdjCoordinate parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STAdjCoordinate)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static STAdjCoordinate parse(Reader reader) throws XmlException, IOException {
            return (STAdjCoordinate)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static STAdjCoordinate parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STAdjCoordinate)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static STAdjCoordinate parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STAdjCoordinate)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static STAdjCoordinate parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STAdjCoordinate)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static STAdjCoordinate parse(Node node) throws XmlException {
            return (STAdjCoordinate)Factory.getTypeLoader().parse(node, type, null);
        }

        public static STAdjCoordinate parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STAdjCoordinate)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static STAdjCoordinate parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (STAdjCoordinate)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static STAdjCoordinate parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STAdjCoordinate)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
