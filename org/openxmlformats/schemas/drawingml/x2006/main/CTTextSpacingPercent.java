    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTTextSpacingPercent.class.getClassLoader());
        ...
        public static CTTextSpacingPercent newInstance() {
            return (CTTextSpacingPercent)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTTextSpacingPercent newInstance(XmlOptions xmlOptions) {
            return (CTTextSpacingPercent)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTTextSpacingPercent parse(String string) throws XmlException {
            return (CTTextSpacingPercent)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTTextSpacingPercent parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTTextSpacingPercent)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTTextSpacingPercent parse(File file) throws XmlException, IOException {
            return (CTTextSpacingPercent)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTTextSpacingPercent parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTextSpacingPercent)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTTextSpacingPercent parse(URL uRL) throws XmlException, IOException {
            return (CTTextSpacingPercent)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTTextSpacingPercent parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTextSpacingPercent)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTTextSpacingPercent parse(InputStream inputStream) throws XmlException, IOException {
            return (CTTextSpacingPercent)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTTextSpacingPercent parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTextSpacingPercent)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTTextSpacingPercent parse(Reader reader) throws XmlException, IOException {
            return (CTTextSpacingPercent)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTTextSpacingPercent parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTextSpacingPercent)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTTextSpacingPercent parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTTextSpacingPercent)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTTextSpacingPercent parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTTextSpacingPercent)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTTextSpacingPercent parse(Node node) throws XmlException {
            return (CTTextSpacingPercent)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTTextSpacingPercent parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTTextSpacingPercent)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTTextSpacingPercent parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTTextSpacingPercent)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTTextSpacingPercent parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTTextSpacingPercent)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
