    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTStyleMatrixReference.class.getClassLoader());
        ...
        public static CTStyleMatrixReference newInstance() {
            return (CTStyleMatrixReference)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTStyleMatrixReference newInstance(XmlOptions xmlOptions) {
            return (CTStyleMatrixReference)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTStyleMatrixReference parse(String string) throws XmlException {
            return (CTStyleMatrixReference)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTStyleMatrixReference parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTStyleMatrixReference)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTStyleMatrixReference parse(File file) throws XmlException, IOException {
            return (CTStyleMatrixReference)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTStyleMatrixReference parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTStyleMatrixReference)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTStyleMatrixReference parse(URL uRL) throws XmlException, IOException {
            return (CTStyleMatrixReference)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTStyleMatrixReference parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTStyleMatrixReference)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTStyleMatrixReference parse(InputStream inputStream) throws XmlException, IOException {
            return (CTStyleMatrixReference)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTStyleMatrixReference parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTStyleMatrixReference)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTStyleMatrixReference parse(Reader reader) throws XmlException, IOException {
            return (CTStyleMatrixReference)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTStyleMatrixReference parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTStyleMatrixReference)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTStyleMatrixReference parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTStyleMatrixReference)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTStyleMatrixReference parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTStyleMatrixReference)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTStyleMatrixReference parse(Node node) throws XmlException {
            return (CTStyleMatrixReference)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTStyleMatrixReference parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTStyleMatrixReference)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTStyleMatrixReference parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTStyleMatrixReference)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTStyleMatrixReference parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTStyleMatrixReference)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
