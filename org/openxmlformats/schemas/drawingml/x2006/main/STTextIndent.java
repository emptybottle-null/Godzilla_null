...
extends STCoordinate32 {
    ...
    public static final class Factory {
        ...
        public static STTextIndent newValue(Object object) {
            return (STTextIndent)type.newValue(object);
        }
        ...
        public static STTextIndent newInstance() {
            return (STTextIndent)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STTextIndent newInstance(XmlOptions xmlOptions) {
            return (STTextIndent)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STTextIndent parse(String string) throws XmlException {
            return (STTextIndent)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STTextIndent parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STTextIndent)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STTextIndent parse(File file) throws XmlException, IOException {
            return (STTextIndent)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STTextIndent parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTextIndent)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STTextIndent parse(URL uRL) throws XmlException, IOException {
            return (STTextIndent)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STTextIndent parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTextIndent)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STTextIndent parse(InputStream inputStream) throws XmlException, IOException {
            return (STTextIndent)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static STTextIndent parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTextIndent)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static STTextIndent parse(Reader reader) throws XmlException, IOException {
            return (STTextIndent)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static STTextIndent parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTextIndent)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static STTextIndent parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STTextIndent)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static STTextIndent parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STTextIndent)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static STTextIndent parse(Node node) throws XmlException {
            return (STTextIndent)Factory.getTypeLoader().parse(node, type, null);
        }

        public static STTextIndent parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STTextIndent)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static STTextIndent parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (STTextIndent)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static STTextIndent parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STTextIndent)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
