    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTConnectionSiteList.class.getClassLoader());
        ...
        public static CTConnectionSiteList newInstance() {
            return (CTConnectionSiteList)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTConnectionSiteList newInstance(XmlOptions xmlOptions) {
            return (CTConnectionSiteList)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTConnectionSiteList parse(String string) throws XmlException {
            return (CTConnectionSiteList)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTConnectionSiteList parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTConnectionSiteList)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTConnectionSiteList parse(File file) throws XmlException, IOException {
            return (CTConnectionSiteList)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTConnectionSiteList parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTConnectionSiteList)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTConnectionSiteList parse(URL uRL) throws XmlException, IOException {
            return (CTConnectionSiteList)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTConnectionSiteList parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTConnectionSiteList)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTConnectionSiteList parse(InputStream inputStream) throws XmlException, IOException {
            return (CTConnectionSiteList)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTConnectionSiteList parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTConnectionSiteList)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTConnectionSiteList parse(Reader reader) throws XmlException, IOException {
            return (CTConnectionSiteList)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTConnectionSiteList parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTConnectionSiteList)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTConnectionSiteList parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTConnectionSiteList)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTConnectionSiteList parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTConnectionSiteList)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTConnectionSiteList parse(Node node) throws XmlException {
            return (CTConnectionSiteList)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTConnectionSiteList parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTConnectionSiteList)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTConnectionSiteList parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTConnectionSiteList)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTConnectionSiteList parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTConnectionSiteList)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
