...
extends XmlObject {
    public static final SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CTSchemeColor.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sD023D6490046BA0250A839A9AD24C443").resolveHandle("ctschemecolor5feftype");
    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTSchemeColor.class.getClassLoader());
        ...
        public static CTSchemeColor newInstance() {
            return (CTSchemeColor)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTSchemeColor newInstance(XmlOptions xmlOptions) {
            return (CTSchemeColor)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTSchemeColor parse(String string) throws XmlException {
            return (CTSchemeColor)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTSchemeColor parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTSchemeColor)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTSchemeColor parse(File file) throws XmlException, IOException {
            return (CTSchemeColor)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTSchemeColor parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSchemeColor)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTSchemeColor parse(URL uRL) throws XmlException, IOException {
            return (CTSchemeColor)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTSchemeColor parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSchemeColor)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTSchemeColor parse(InputStream inputStream) throws XmlException, IOException {
            return (CTSchemeColor)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTSchemeColor parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSchemeColor)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTSchemeColor parse(Reader reader) throws XmlException, IOException {
            return (CTSchemeColor)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTSchemeColor parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSchemeColor)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTSchemeColor parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTSchemeColor)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTSchemeColor parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTSchemeColor)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTSchemeColor parse(Node node) throws XmlException {
            return (CTSchemeColor)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTSchemeColor parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTSchemeColor)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTSchemeColor parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTSchemeColor)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static CTSchemeColor parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTSchemeColor)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
