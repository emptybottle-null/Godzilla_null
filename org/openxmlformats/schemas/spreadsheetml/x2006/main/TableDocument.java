    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(TableDocument.class.getClassLoader());
        ...
        public static TableDocument newInstance() {
            return (TableDocument)Factory.getTypeLoader().newInstance(type, null);
        }

        public static TableDocument newInstance(XmlOptions xmlOptions) {
            return (TableDocument)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static TableDocument parse(String string) throws XmlException {
            return (TableDocument)Factory.getTypeLoader().parse(string, type, null);
        }

        public static TableDocument parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (TableDocument)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static TableDocument parse(File file) throws XmlException, IOException {
            return (TableDocument)Factory.getTypeLoader().parse(file, type, null);
        }

        public static TableDocument parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (TableDocument)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static TableDocument parse(URL uRL) throws XmlException, IOException {
            return (TableDocument)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static TableDocument parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (TableDocument)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static TableDocument parse(InputStream inputStream) throws XmlException, IOException {
            return (TableDocument)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static TableDocument parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (TableDocument)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static TableDocument parse(Reader reader) throws XmlException, IOException {
            return (TableDocument)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static TableDocument parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (TableDocument)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static TableDocument parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (TableDocument)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static TableDocument parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (TableDocument)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static TableDocument parse(Node node) throws XmlException {
            return (TableDocument)Factory.getTypeLoader().parse(node, type, null);
        }

        public static TableDocument parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (TableDocument)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static TableDocument parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (TableDocument)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static TableDocument parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (TableDocument)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
