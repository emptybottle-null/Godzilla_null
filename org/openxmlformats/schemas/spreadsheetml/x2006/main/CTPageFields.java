    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTPageFields.class.getClassLoader());
        ...
        public static CTPageFields newInstance() {
            return (CTPageFields)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTPageFields newInstance(XmlOptions xmlOptions) {
            return (CTPageFields)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTPageFields parse(String string) throws XmlException {
            return (CTPageFields)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTPageFields parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTPageFields)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTPageFields parse(File file) throws XmlException, IOException {
            return (CTPageFields)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTPageFields parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPageFields)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTPageFields parse(URL uRL) throws XmlException, IOException {
            return (CTPageFields)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTPageFields parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPageFields)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTPageFields parse(InputStream inputStream) throws XmlException, IOException {
            return (CTPageFields)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTPageFields parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPageFields)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTPageFields parse(Reader reader) throws XmlException, IOException {
            return (CTPageFields)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTPageFields parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPageFields)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTPageFields parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTPageFields)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTPageFields parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTPageFields)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTPageFields parse(Node node) throws XmlException {
            return (CTPageFields)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTPageFields parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTPageFields)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTPageFields parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTPageFields)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTPageFields parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTPageFields)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
