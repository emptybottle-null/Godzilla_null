    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTMergeCells.class.getClassLoader());
        ...
        public static CTMergeCells newInstance() {
            return (CTMergeCells)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTMergeCells newInstance(XmlOptions xmlOptions) {
            return (CTMergeCells)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTMergeCells parse(String string) throws XmlException {
            return (CTMergeCells)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTMergeCells parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTMergeCells)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTMergeCells parse(File file) throws XmlException, IOException {
            return (CTMergeCells)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTMergeCells parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTMergeCells)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTMergeCells parse(URL uRL) throws XmlException, IOException {
            return (CTMergeCells)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTMergeCells parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTMergeCells)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTMergeCells parse(InputStream inputStream) throws XmlException, IOException {
            return (CTMergeCells)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTMergeCells parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTMergeCells)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTMergeCells parse(Reader reader) throws XmlException, IOException {
            return (CTMergeCells)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTMergeCells parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTMergeCells)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTMergeCells parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTMergeCells)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTMergeCells parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTMergeCells)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTMergeCells parse(Node node) throws XmlException {
            return (CTMergeCells)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTMergeCells parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTMergeCells)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTMergeCells parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTMergeCells)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTMergeCells parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTMergeCells)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
