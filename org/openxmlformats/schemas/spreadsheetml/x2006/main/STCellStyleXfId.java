...
public interface STCellStyleXfId
extends XmlUnsignedInt {
    ...
    public static final class Factory {
        ...
        public static STCellStyleXfId newValue(Object object) {
            return (STCellStyleXfId)type.newValue(object);
        }
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(STCellStyleXfId.class.getClassLoader());
        ...
        public static STCellStyleXfId newInstance() {
            return (STCellStyleXfId)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STCellStyleXfId newInstance(XmlOptions xmlOptions) {
            return (STCellStyleXfId)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STCellStyleXfId parse(String string) throws XmlException {
            return (STCellStyleXfId)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STCellStyleXfId parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STCellStyleXfId)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STCellStyleXfId parse(File file) throws XmlException, IOException {
            return (STCellStyleXfId)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STCellStyleXfId parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STCellStyleXfId)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STCellStyleXfId parse(URL uRL) throws XmlException, IOException {
            return (STCellStyleXfId)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STCellStyleXfId parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STCellStyleXfId)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STCellStyleXfId parse(InputStream inputStream) throws XmlException, IOException {
            return (STCellStyleXfId)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static STCellStyleXfId parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STCellStyleXfId)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static STCellStyleXfId parse(Reader reader) throws XmlException, IOException {
            return (STCellStyleXfId)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static STCellStyleXfId parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STCellStyleXfId)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static STCellStyleXfId parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STCellStyleXfId)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static STCellStyleXfId parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STCellStyleXfId)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static STCellStyleXfId parse(Node node) throws XmlException {
            return (STCellStyleXfId)Factory.getTypeLoader().parse(node, type, null);
        }

        public static STCellStyleXfId parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STCellStyleXfId)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static STCellStyleXfId parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (STCellStyleXfId)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static STCellStyleXfId parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STCellStyleXfId)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
