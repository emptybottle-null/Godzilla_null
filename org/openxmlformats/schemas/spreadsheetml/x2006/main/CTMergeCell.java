    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTMergeCell.class.getClassLoader());
        ...
        public static CTMergeCell newInstance() {
            return (CTMergeCell)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTMergeCell newInstance(XmlOptions xmlOptions) {
            return (CTMergeCell)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTMergeCell parse(String string) throws XmlException {
            return (CTMergeCell)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTMergeCell parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTMergeCell)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTMergeCell parse(File file) throws XmlException, IOException {
            return (CTMergeCell)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTMergeCell parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTMergeCell)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTMergeCell parse(URL uRL) throws XmlException, IOException {
            return (CTMergeCell)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTMergeCell parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTMergeCell)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTMergeCell parse(InputStream inputStream) throws XmlException, IOException {
            return (CTMergeCell)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTMergeCell parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTMergeCell)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTMergeCell parse(Reader reader) throws XmlException, IOException {
            return (CTMergeCell)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTMergeCell parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTMergeCell)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTMergeCell parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTMergeCell)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTMergeCell parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTMergeCell)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTMergeCell parse(Node node) throws XmlException {
            return (CTMergeCell)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTMergeCell parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTMergeCell)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTMergeCell parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTMergeCell)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTMergeCell parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTMergeCell)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
