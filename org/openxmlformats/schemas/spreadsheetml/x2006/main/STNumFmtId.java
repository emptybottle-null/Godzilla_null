...
extends XmlUnsignedInt {
    ...
    public static final class Factory {
        ...
        public static STNumFmtId newValue(Object object) {
            return (STNumFmtId)type.newValue(object);
        }
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(STNumFmtId.class.getClassLoader());
        ...
        public static STNumFmtId newInstance() {
            return (STNumFmtId)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STNumFmtId newInstance(XmlOptions xmlOptions) {
            return (STNumFmtId)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STNumFmtId parse(String string) throws XmlException {
            return (STNumFmtId)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STNumFmtId parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STNumFmtId)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STNumFmtId parse(File file) throws XmlException, IOException {
            return (STNumFmtId)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STNumFmtId parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STNumFmtId)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STNumFmtId parse(URL uRL) throws XmlException, IOException {
            return (STNumFmtId)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STNumFmtId parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STNumFmtId)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STNumFmtId parse(InputStream inputStream) throws XmlException, IOException {
            return (STNumFmtId)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static STNumFmtId parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STNumFmtId)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static STNumFmtId parse(Reader reader) throws XmlException, IOException {
            return (STNumFmtId)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static STNumFmtId parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STNumFmtId)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static STNumFmtId parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STNumFmtId)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static STNumFmtId parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STNumFmtId)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static STNumFmtId parse(Node node) throws XmlException {
            return (STNumFmtId)Factory.getTypeLoader().parse(node, type, null);
        }

        public static STNumFmtId parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STNumFmtId)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static STNumFmtId parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (STNumFmtId)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static STNumFmtId parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STNumFmtId)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
