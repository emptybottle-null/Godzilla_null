    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTTablePart.class.getClassLoader());
        ...
        public static CTTablePart newInstance() {
            return (CTTablePart)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTTablePart newInstance(XmlOptions xmlOptions) {
            return (CTTablePart)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTTablePart parse(String string) throws XmlException {
            return (CTTablePart)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTTablePart parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTTablePart)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTTablePart parse(File file) throws XmlException, IOException {
            return (CTTablePart)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTTablePart parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTablePart)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTTablePart parse(URL uRL) throws XmlException, IOException {
            return (CTTablePart)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTTablePart parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTablePart)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTTablePart parse(InputStream inputStream) throws XmlException, IOException {
            return (CTTablePart)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTTablePart parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTablePart)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTTablePart parse(Reader reader) throws XmlException, IOException {
            return (CTTablePart)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTTablePart parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTablePart)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTTablePart parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTTablePart)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTTablePart parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTTablePart)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTTablePart parse(Node node) throws XmlException {
            return (CTTablePart)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTTablePart parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTTablePart)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTTablePart parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTTablePart)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTTablePart parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTTablePart)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
