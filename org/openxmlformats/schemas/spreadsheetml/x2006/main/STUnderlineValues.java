...
extends XmlString {
    ...
    public static final class Factory {
        ...
        public static STUnderlineValues newValue(Object object) {
            return (STUnderlineValues)type.newValue(object);
        }
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(STUnderlineValues.class.getClassLoader());
        ...
        public static STUnderlineValues newInstance() {
            return (STUnderlineValues)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STUnderlineValues newInstance(XmlOptions xmlOptions) {
            return (STUnderlineValues)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STUnderlineValues parse(String string) throws XmlException {
            return (STUnderlineValues)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STUnderlineValues parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STUnderlineValues)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STUnderlineValues parse(File file) throws XmlException, IOException {
            return (STUnderlineValues)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STUnderlineValues parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STUnderlineValues)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STUnderlineValues parse(URL uRL) throws XmlException, IOException {
            return (STUnderlineValues)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STUnderlineValues parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STUnderlineValues)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STUnderlineValues parse(InputStream inputStream) throws XmlException, IOException {
            return (STUnderlineValues)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static STUnderlineValues parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STUnderlineValues)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static STUnderlineValues parse(Reader reader) throws XmlException, IOException {
            return (STUnderlineValues)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static STUnderlineValues parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STUnderlineValues)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static STUnderlineValues parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STUnderlineValues)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static STUnderlineValues parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STUnderlineValues)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static STUnderlineValues parse(Node node) throws XmlException {
            return (STUnderlineValues)Factory.getTypeLoader().parse(node, type, null);
        }

        public static STUnderlineValues parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STUnderlineValues)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static STUnderlineValues parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (STUnderlineValues)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static STUnderlineValues parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STUnderlineValues)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
