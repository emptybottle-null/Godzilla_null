...
implements CTHeaderFooter {
    ...
    public boolean getDifferentOddEven() {
        ...
        synchronized (object) {
            this.check_orphaned();
            SimpleValue simpleValue = null;
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(DIFFERENTODDEVEN$12));
            if (simpleValue == null) {
                simpleValue = (SimpleValue)((Object)this.get_default_attribute_value(DIFFERENTODDEVEN$12));
            }
            if (simpleValue == null) {
                return false;
            }
    ...
    public XmlBoolean xgetDifferentOddEven() {
        ...
        synchronized (object) {
            ...
            xmlBoolean = (XmlBoolean)((Object)this.get_store().find_attribute_user(DIFFERENTODDEVEN$12));
            if (xmlBoolean == null) {
                xmlBoolean = (XmlBoolean)this.get_default_attribute_value(DIFFERENTODDEVEN$12);
            }
            return xmlBoolean;
        }
    }
    ...
    public void setDifferentOddEven(boolean bl) {
        ...
        synchronized (object) {
            ...
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(DIFFERENTODDEVEN$12));
            if (simpleValue == null) {
                simpleValue = (SimpleValue)((Object)this.get_store().add_attribute_user(DIFFERENTODDEVEN$12));
            }
    ...
    public void xsetDifferentOddEven(XmlBoolean xmlBoolean) {
        ...
        synchronized (object) {
            ...
            xmlBoolean2 = (XmlBoolean)((Object)this.get_store().find_attribute_user(DIFFERENTODDEVEN$12));
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean)((Object)this.get_store().add_attribute_user(DIFFERENTODDEVEN$12));
            }
    ...
    public boolean getDifferentFirst() {
        ...
        synchronized (object) {
            this.check_orphaned();
            SimpleValue simpleValue = null;
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(DIFFERENTFIRST$14));
            if (simpleValue == null) {
                simpleValue = (SimpleValue)((Object)this.get_default_attribute_value(DIFFERENTFIRST$14));
            }
            if (simpleValue == null) {
                return false;
            }
    ...
    public XmlBoolean xgetDifferentFirst() {
        ...
        synchronized (object) {
            this.check_orphaned();
            XmlBoolean xmlBoolean = null;
            xmlBoolean = (XmlBoolean)((Object)this.get_store().find_attribute_user(DIFFERENTFIRST$14));
            if (xmlBoolean == null) {
                xmlBoolean = (XmlBoolean)this.get_default_attribute_value(DIFFERENTFIRST$14);
            }
            return xmlBoolean;
        }
    }
    ...
    public void setDifferentFirst(boolean bl) {
        ...
        synchronized (object) {
            ...
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(DIFFERENTFIRST$14));
            if (simpleValue == null) {
                simpleValue = (SimpleValue)((Object)this.get_store().add_attribute_user(DIFFERENTFIRST$14));
            }
            simpleValue.setBooleanValue(bl);
        }
    }
    ...
    public void xsetDifferentFirst(XmlBoolean xmlBoolean) {
        ...
        synchronized (object) {
            this.check_orphaned();
            XmlBoolean xmlBoolean2 = null;
            xmlBoolean2 = (XmlBoolean)((Object)this.get_store().find_attribute_user(DIFFERENTFIRST$14));
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean)((Object)this.get_store().add_attribute_user(DIFFERENTFIRST$14));
            }
            xmlBoolean2.set(xmlBoolean);
        }
    }
    ...
    public boolean getScaleWithDoc() {
        ...
        synchronized (object) {
            this.check_orphaned();
            SimpleValue simpleValue = null;
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(SCALEWITHDOC$16));
            if (simpleValue == null) {
                simpleValue = (SimpleValue)((Object)this.get_default_attribute_value(SCALEWITHDOC$16));
            }
            if (simpleValue == null) {
                return false;
            }
    ...
    public XmlBoolean xgetScaleWithDoc() {
        ...
        synchronized (object) {
            this.check_orphaned();
            XmlBoolean xmlBoolean = null;
            xmlBoolean = (XmlBoolean)((Object)this.get_store().find_attribute_user(SCALEWITHDOC$16));
            if (xmlBoolean == null) {
                xmlBoolean = (XmlBoolean)this.get_default_attribute_value(SCALEWITHDOC$16);
            }
            return xmlBoolean;
        }
    }
     ...
     */
    @Override
    public void setScaleWithDoc(boolean bl) {
        Object object = this.monitor();
        synchronized (object) {
            this.check_orphaned();
            SimpleValue simpleValue = null;
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(SCALEWITHDOC$16));
            if (simpleValue == null) {
                simpleValue = (SimpleValue)((Object)this.get_store().add_attribute_user(SCALEWITHDOC$16));
            }
            simpleValue.setBooleanValue(bl);
        }
    }
    ...
    public void xsetScaleWithDoc(XmlBoolean xmlBoolean) {
        ...
        synchronized (object) {
            this.check_orphaned();
            XmlBoolean xmlBoolean2 = null;
            xmlBoolean2 = (XmlBoolean)((Object)this.get_store().find_attribute_user(SCALEWITHDOC$16));
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean)((Object)this.get_store().add_attribute_user(SCALEWITHDOC$16));
            }
            xmlBoolean2.set(xmlBoolean);
        }
    }
    ...
    public boolean getAlignWithMargins() {
        ...
        synchronized (object) {
            this.check_orphaned();
            SimpleValue simpleValue = null;
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(ALIGNWITHMARGINS$18));
            if (simpleValue == null) {
                simpleValue = (SimpleValue)((Object)this.get_default_attribute_value(ALIGNWITHMARGINS$18));
            }
            if (simpleValue == null) {
                return false;
            }
    ...
    public XmlBoolean xgetAlignWithMargins() {
        ...
        synchronized (object) {
            this.check_orphaned();
            XmlBoolean xmlBoolean = null;
            xmlBoolean = (XmlBoolean)((Object)this.get_store().find_attribute_user(ALIGNWITHMARGINS$18));
            if (xmlBoolean == null) {
                xmlBoolean = (XmlBoolean)this.get_default_attribute_value(ALIGNWITHMARGINS$18);
            }
            return xmlBoolean;
        }
    }
    ...
    public void setAlignWithMargins(boolean bl) {
        ...
        synchronized (object) {
            ...
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(ALIGNWITHMARGINS$18));
            if (simpleValue == null) {
                simpleValue = (SimpleValue)((Object)this.get_store().add_attribute_user(ALIGNWITHMARGINS$18));
            }
            simpleValue.setBooleanValue(bl);
        }
    }
    ...
    public void xsetAlignWithMargins(XmlBoolean xmlBoolean) {
        ...
        synchronized (object) {
            this.check_orphaned();
            XmlBoolean xmlBoolean2 = null;
            xmlBoolean2 = (XmlBoolean)((Object)this.get_store().find_attribute_user(ALIGNWITHMARGINS$18));
            if (xmlBoolean2 == null) {
                xmlBoolean2 = (XmlBoolean)((Object)this.get_store().add_attribute_user(ALIGNWITHMARGINS$18));
            }
            xmlBoolean2.set(xmlBoolean);
        }
    }
