        ...
        synchronized (object) {
            ...
            extends AbstractList<CTField> {
                ...
                public CTField get(int n) {
                    return CTColFieldsImpl.this.getFieldArray(n);
                }

                @Override
                public CTField set(int n, CTField cTField) {
                    CTField cTField2 = CTColFieldsImpl.this.getFieldArray(n);
                    CTColFieldsImpl.this.setFieldArray(n, cTField);
                    return cTField2;
                }

                @Override
                public void add(int n, CTField cTField) {
                    CTColFieldsImpl.this.insertNewField(n).set(cTField);
                }

                @Override
                public CTField remove(int n) {
                    CTField cTField = CTColFieldsImpl.this.getFieldArray(n);
                    CTColFieldsImpl.this.removeField(n);
                    return cTField;
                }
