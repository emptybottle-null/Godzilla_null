...
implements CTXmlPr {
    ...
    public STXmlDataType.Enum getXmlDataType() {
        ...
        synchronized (object) {
            this.check_orphaned();
            SimpleValue simpleValue = null;
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(XMLDATATYPE$6));
            if (simpleValue == null) {
                return null;
            }
    ...
    public STXmlDataType xgetXmlDataType() {
        ...
        synchronized (object) {
            ...
            sTXmlDataType = (STXmlDataType)((Object)this.get_store().find_attribute_user(XMLDATATYPE$6));
    ...
    public void setXmlDataType(STXmlDataType.Enum enum_) {
        ...
        synchronized (object) {
            ...
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(XMLDATATYPE$6));
            if (simpleValue == null) {
                simpleValue = (SimpleValue)((Object)this.get_store().add_attribute_user(XMLDATATYPE$6));
            }
    ...
    public void xsetXmlDataType(STXmlDataType sTXmlDataType) {
        ...
        synchronized (object) {
            ...
            sTXmlDataType2 = (STXmlDataType)((Object)this.get_store().find_attribute_user(XMLDATATYPE$6));
            if (sTXmlDataType2 == null) {
                sTXmlDataType2 = (STXmlDataType)((Object)this.get_store().add_attribute_user(XMLDATATYPE$6));
            }
