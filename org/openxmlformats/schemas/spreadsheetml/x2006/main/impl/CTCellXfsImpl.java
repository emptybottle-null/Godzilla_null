...
implements CTCellXfs {
    ...
    public CTCellXfsImpl(SchemaType schemaType) {
        super(schemaType);
    }
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTXf> {
                ...
                public CTXf get(int n) {
                    return CTCellXfsImpl.this.getXfArray(n);
                }

                @Override
                public CTXf set(int n, CTXf cTXf) {
                    CTXf cTXf2 = CTCellXfsImpl.this.getXfArray(n);
                    CTCellXfsImpl.this.setXfArray(n, cTXf);
                    return cTXf2;
                }

                @Override
                public void add(int n, CTXf cTXf) {
                    CTCellXfsImpl.this.insertNewXf(n).set(cTXf);
                }

                @Override
                public CTXf remove(int n) {
                    CTXf cTXf = CTCellXfsImpl.this.getXfArray(n);
                    CTCellXfsImpl.this.removeXf(n);
                    return cTXf;
                }
