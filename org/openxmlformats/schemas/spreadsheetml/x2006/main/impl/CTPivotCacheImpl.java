...
implements CTPivotCache {
    ...
    public long getCacheId() {
        ...
        synchronized (object) {
            ...
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(CACHEID$0));
            if (simpleValue == null) {
                return 0L;
            }
    ...
    public XmlUnsignedInt xgetCacheId() {
        ...
        synchronized (object) {
            ...
            xmlUnsignedInt = (XmlUnsignedInt)((Object)this.get_store().find_attribute_user(CACHEID$0));
    ...
    public void setCacheId(long l) {
        ...
        synchronized (object) {
            ...
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(CACHEID$0));
            if (simpleValue == null) {
                simpleValue = (SimpleValue)((Object)this.get_store().add_attribute_user(CACHEID$0));
            }
    ...
    public void xsetCacheId(XmlUnsignedInt xmlUnsignedInt) {
        ...
        synchronized (object) {
            ...
            xmlUnsignedInt2 = (XmlUnsignedInt)((Object)this.get_store().find_attribute_user(CACHEID$0));
            if (xmlUnsignedInt2 == null) {
                xmlUnsignedInt2 = (XmlUnsignedInt)((Object)this.get_store().add_attribute_user(CACHEID$0));
            }
