    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTFills.class.getClassLoader());
        ...
        public static CTFills newInstance() {
            return (CTFills)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTFills newInstance(XmlOptions xmlOptions) {
            return (CTFills)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTFills parse(String string) throws XmlException {
            return (CTFills)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTFills parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTFills)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTFills parse(File file) throws XmlException, IOException {
            return (CTFills)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTFills parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTFills)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTFills parse(URL uRL) throws XmlException, IOException {
            return (CTFills)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTFills parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTFills)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTFills parse(InputStream inputStream) throws XmlException, IOException {
            return (CTFills)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTFills parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTFills)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTFills parse(Reader reader) throws XmlException, IOException {
            return (CTFills)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTFills parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTFills)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTFills parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTFills)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTFills parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTFills)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTFills parse(Node node) throws XmlException {
            return (CTFills)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTFills parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTFills)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTFills parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTFills)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static CTFills parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTFills)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
