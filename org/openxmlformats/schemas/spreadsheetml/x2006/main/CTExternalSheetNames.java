    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTExternalSheetNames.class.getClassLoader());
        ...
        public static CTExternalSheetNames newInstance() {
            return (CTExternalSheetNames)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTExternalSheetNames newInstance(XmlOptions xmlOptions) {
            return (CTExternalSheetNames)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTExternalSheetNames parse(String string) throws XmlException {
            return (CTExternalSheetNames)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTExternalSheetNames parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTExternalSheetNames)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTExternalSheetNames parse(File file) throws XmlException, IOException {
            return (CTExternalSheetNames)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTExternalSheetNames parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTExternalSheetNames)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTExternalSheetNames parse(URL uRL) throws XmlException, IOException {
            return (CTExternalSheetNames)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTExternalSheetNames parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTExternalSheetNames)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTExternalSheetNames parse(InputStream inputStream) throws XmlException, IOException {
            return (CTExternalSheetNames)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTExternalSheetNames parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTExternalSheetNames)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTExternalSheetNames parse(Reader reader) throws XmlException, IOException {
            return (CTExternalSheetNames)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTExternalSheetNames parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTExternalSheetNames)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTExternalSheetNames parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTExternalSheetNames)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTExternalSheetNames parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTExternalSheetNames)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTExternalSheetNames parse(Node node) throws XmlException {
            return (CTExternalSheetNames)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTExternalSheetNames parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTExternalSheetNames)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTExternalSheetNames parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTExternalSheetNames)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTExternalSheetNames parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTExternalSheetNames)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
