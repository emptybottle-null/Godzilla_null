...
extends XmlUnsignedInt {
    ...
    public static final class Factory {
        ...
        public static STFontId newValue(Object object) {
            return (STFontId)type.newValue(object);
        }
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(STFontId.class.getClassLoader());
        ...
        public static STFontId newInstance() {
            return (STFontId)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STFontId newInstance(XmlOptions xmlOptions) {
            return (STFontId)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STFontId parse(String string) throws XmlException {
            return (STFontId)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STFontId parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STFontId)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STFontId parse(File file) throws XmlException, IOException {
            return (STFontId)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STFontId parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STFontId)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STFontId parse(URL uRL) throws XmlException, IOException {
            return (STFontId)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STFontId parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STFontId)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STFontId parse(InputStream inputStream) throws XmlException, IOException {
            return (STFontId)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static STFontId parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STFontId)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static STFontId parse(Reader reader) throws XmlException, IOException {
            return (STFontId)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static STFontId parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STFontId)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static STFontId parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STFontId)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static STFontId parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STFontId)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static STFontId parse(Node node) throws XmlException {
            return (STFontId)Factory.getTypeLoader().parse(node, type, null);
        }

        public static STFontId parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STFontId)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static STFontId parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (STFontId)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static STFontId parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STFontId)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
