    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CalcChainDocument.class.getClassLoader());
        ...
        public static CalcChainDocument newInstance() {
            return (CalcChainDocument)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CalcChainDocument newInstance(XmlOptions xmlOptions) {
            return (CalcChainDocument)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CalcChainDocument parse(String string) throws XmlException {
            return (CalcChainDocument)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CalcChainDocument parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CalcChainDocument)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CalcChainDocument parse(File file) throws XmlException, IOException {
            return (CalcChainDocument)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CalcChainDocument parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CalcChainDocument)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CalcChainDocument parse(URL uRL) throws XmlException, IOException {
            return (CalcChainDocument)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CalcChainDocument parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CalcChainDocument)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CalcChainDocument parse(InputStream inputStream) throws XmlException, IOException {
            return (CalcChainDocument)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CalcChainDocument parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CalcChainDocument)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CalcChainDocument parse(Reader reader) throws XmlException, IOException {
            return (CalcChainDocument)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CalcChainDocument parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CalcChainDocument)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CalcChainDocument parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CalcChainDocument)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CalcChainDocument parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CalcChainDocument)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CalcChainDocument parse(Node node) throws XmlException {
            return (CalcChainDocument)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CalcChainDocument parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CalcChainDocument)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CalcChainDocument parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CalcChainDocument)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CalcChainDocument parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CalcChainDocument)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
