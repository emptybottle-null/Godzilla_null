...
extends XmlUnsignedInt {
    ...
    public static final class Factory {
        ...
        public static STBorderId newValue(Object object) {
            return (STBorderId)type.newValue(object);
        }
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(STBorderId.class.getClassLoader());
        ...
        public static STBorderId newInstance() {
            return (STBorderId)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STBorderId newInstance(XmlOptions xmlOptions) {
            return (STBorderId)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STBorderId parse(String string) throws XmlException {
            return (STBorderId)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STBorderId parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STBorderId)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STBorderId parse(File file) throws XmlException, IOException {
            return (STBorderId)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STBorderId parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STBorderId)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STBorderId parse(URL uRL) throws XmlException, IOException {
            return (STBorderId)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STBorderId parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STBorderId)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STBorderId parse(InputStream inputStream) throws XmlException, IOException {
            return (STBorderId)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static STBorderId parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STBorderId)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static STBorderId parse(Reader reader) throws XmlException, IOException {
            return (STBorderId)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static STBorderId parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STBorderId)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static STBorderId parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STBorderId)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static STBorderId parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STBorderId)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static STBorderId parse(Node node) throws XmlException {
            return (STBorderId)Factory.getTypeLoader().parse(node, type, null);
        }

        public static STBorderId parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STBorderId)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static STBorderId parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (STBorderId)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static STBorderId parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STBorderId)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
