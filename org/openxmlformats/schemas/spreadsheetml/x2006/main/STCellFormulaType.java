...
extends XmlString {
    ...
    public static final class Factory {
        ...
        public static STCellFormulaType newValue(Object object) {
            return (STCellFormulaType)type.newValue(object);
        }
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(STCellFormulaType.class.getClassLoader());
        ...
        public static STCellFormulaType newInstance() {
            return (STCellFormulaType)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STCellFormulaType newInstance(XmlOptions xmlOptions) {
            return (STCellFormulaType)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STCellFormulaType parse(String string) throws XmlException {
            return (STCellFormulaType)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STCellFormulaType parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STCellFormulaType)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STCellFormulaType parse(File file) throws XmlException, IOException {
            return (STCellFormulaType)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STCellFormulaType parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STCellFormulaType)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STCellFormulaType parse(URL uRL) throws XmlException, IOException {
            return (STCellFormulaType)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STCellFormulaType parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STCellFormulaType)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STCellFormulaType parse(InputStream inputStream) throws XmlException, IOException {
            return (STCellFormulaType)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static STCellFormulaType parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STCellFormulaType)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static STCellFormulaType parse(Reader reader) throws XmlException, IOException {
            return (STCellFormulaType)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static STCellFormulaType parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STCellFormulaType)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static STCellFormulaType parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STCellFormulaType)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static STCellFormulaType parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STCellFormulaType)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static STCellFormulaType parse(Node node) throws XmlException {
            return (STCellFormulaType)Factory.getTypeLoader().parse(node, type, null);
        }

        public static STCellFormulaType parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STCellFormulaType)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static STCellFormulaType parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (STCellFormulaType)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static STCellFormulaType parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STCellFormulaType)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
