...
extends XmlString {
    ...
    public static final class Factory {
        ...
        public static STSourceType newValue(Object object) {
            return (STSourceType)type.newValue(object);
        }
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(STSourceType.class.getClassLoader());
        ...
        public static STSourceType newInstance() {
            return (STSourceType)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STSourceType newInstance(XmlOptions xmlOptions) {
            return (STSourceType)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STSourceType parse(String string) throws XmlException {
            return (STSourceType)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STSourceType parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STSourceType)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STSourceType parse(File file) throws XmlException, IOException {
            return (STSourceType)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STSourceType parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STSourceType)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STSourceType parse(URL uRL) throws XmlException, IOException {
            return (STSourceType)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STSourceType parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STSourceType)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STSourceType parse(InputStream inputStream) throws XmlException, IOException {
            return (STSourceType)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static STSourceType parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STSourceType)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static STSourceType parse(Reader reader) throws XmlException, IOException {
            return (STSourceType)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static STSourceType parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STSourceType)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static STSourceType parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STSourceType)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static STSourceType parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STSourceType)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static STSourceType parse(Node node) throws XmlException {
            return (STSourceType)Factory.getTypeLoader().parse(node, type, null);
        }

        public static STSourceType parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STSourceType)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static STSourceType parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (STSourceType)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static STSourceType parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STSourceType)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
