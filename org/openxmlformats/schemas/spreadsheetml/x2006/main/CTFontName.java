    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTFontName.class.getClassLoader());
        ...
        public static CTFontName newInstance() {
            return (CTFontName)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTFontName newInstance(XmlOptions xmlOptions) {
            return (CTFontName)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTFontName parse(String string) throws XmlException {
            return (CTFontName)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTFontName parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTFontName)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTFontName parse(File file) throws XmlException, IOException {
            return (CTFontName)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTFontName parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTFontName)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTFontName parse(URL uRL) throws XmlException, IOException {
            return (CTFontName)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTFontName parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTFontName)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTFontName parse(InputStream inputStream) throws XmlException, IOException {
            return (CTFontName)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTFontName parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTFontName)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTFontName parse(Reader reader) throws XmlException, IOException {
            return (CTFontName)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTFontName parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTFontName)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTFontName parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTFontName)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTFontName parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTFontName)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTFontName parse(Node node) throws XmlException {
            return (CTFontName)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTFontName parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTFontName)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTFontName parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTFontName)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTFontName parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTFontName)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
