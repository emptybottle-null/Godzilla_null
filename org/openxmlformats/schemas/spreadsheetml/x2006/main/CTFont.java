    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTFont.class.getClassLoader());
        ...
        public static CTFont newInstance() {
            return (CTFont)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTFont newInstance(XmlOptions xmlOptions) {
            return (CTFont)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTFont parse(String string) throws XmlException {
            return (CTFont)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTFont parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTFont)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTFont parse(File file) throws XmlException, IOException {
            return (CTFont)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTFont parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTFont)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTFont parse(URL uRL) throws XmlException, IOException {
            return (CTFont)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTFont parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTFont)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTFont parse(InputStream inputStream) throws XmlException, IOException {
            return (CTFont)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTFont parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTFont)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTFont parse(Reader reader) throws XmlException, IOException {
            return (CTFont)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTFont parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTFont)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTFont parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTFont)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTFont parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTFont)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTFont parse(Node node) throws XmlException {
            return (CTFont)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTFont parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTFont)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTFont parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTFont)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static CTFont parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTFont)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
