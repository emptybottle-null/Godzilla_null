...
extends XmlString {
    ...
    public static final class Factory {
        ...
        public static STDataValidationErrorStyle newValue(Object object) {
            return (STDataValidationErrorStyle)type.newValue(object);
        }
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(STDataValidationErrorStyle.class.getClassLoader());
        ...
        public static STDataValidationErrorStyle newInstance() {
            return (STDataValidationErrorStyle)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STDataValidationErrorStyle newInstance(XmlOptions xmlOptions) {
            return (STDataValidationErrorStyle)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STDataValidationErrorStyle parse(String string) throws XmlException {
            return (STDataValidationErrorStyle)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STDataValidationErrorStyle parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STDataValidationErrorStyle)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STDataValidationErrorStyle parse(File file) throws XmlException, IOException {
            return (STDataValidationErrorStyle)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STDataValidationErrorStyle parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STDataValidationErrorStyle)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STDataValidationErrorStyle parse(URL uRL) throws XmlException, IOException {
            return (STDataValidationErrorStyle)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STDataValidationErrorStyle parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STDataValidationErrorStyle)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STDataValidationErrorStyle parse(InputStream inputStream) throws XmlException, IOException {
            return (STDataValidationErrorStyle)Factory.getTypeLoader().parse(inputStream, type, null);
        }
        ...
        public static STDataValidationErrorStyle parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STDataValidationErrorStyle)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
