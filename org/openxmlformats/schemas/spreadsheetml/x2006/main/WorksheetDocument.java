...
extends XmlObject {
    ...
    public static final class Factory {
        ...
        public static WorksheetDocument newInstance() {
            return (WorksheetDocument)Factory.getTypeLoader().newInstance(type, null);
        }

        public static WorksheetDocument newInstance(XmlOptions xmlOptions) {
            return (WorksheetDocument)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static WorksheetDocument parse(String string) throws XmlException {
            return (WorksheetDocument)Factory.getTypeLoader().parse(string, type, null);
        }

        public static WorksheetDocument parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (WorksheetDocument)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static WorksheetDocument parse(File file) throws XmlException, IOException {
            return (WorksheetDocument)Factory.getTypeLoader().parse(file, type, null);
        }

        public static WorksheetDocument parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (WorksheetDocument)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static WorksheetDocument parse(URL uRL) throws XmlException, IOException {
            return (WorksheetDocument)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static WorksheetDocument parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (WorksheetDocument)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static WorksheetDocument parse(InputStream inputStream) throws XmlException, IOException {
            return (WorksheetDocument)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static WorksheetDocument parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (WorksheetDocument)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static WorksheetDocument parse(Reader reader) throws XmlException, IOException {
            return (WorksheetDocument)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static WorksheetDocument parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (WorksheetDocument)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static WorksheetDocument parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (WorksheetDocument)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static WorksheetDocument parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (WorksheetDocument)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static WorksheetDocument parse(Node node) throws XmlException {
            return (WorksheetDocument)Factory.getTypeLoader().parse(node, type, null);
        }

        public static WorksheetDocument parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (WorksheetDocument)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static WorksheetDocument parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (WorksheetDocument)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static WorksheetDocument parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (WorksheetDocument)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
