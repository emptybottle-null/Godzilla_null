    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTIntProperty.class.getClassLoader());
        ...
        public static CTIntProperty newInstance() {
            return (CTIntProperty)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTIntProperty newInstance(XmlOptions xmlOptions) {
            return (CTIntProperty)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTIntProperty parse(String string) throws XmlException {
            return (CTIntProperty)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTIntProperty parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTIntProperty)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTIntProperty parse(File file) throws XmlException, IOException {
            return (CTIntProperty)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTIntProperty parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTIntProperty)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTIntProperty parse(URL uRL) throws XmlException, IOException {
            return (CTIntProperty)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTIntProperty parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTIntProperty)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTIntProperty parse(InputStream inputStream) throws XmlException, IOException {
            return (CTIntProperty)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTIntProperty parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTIntProperty)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTIntProperty parse(Reader reader) throws XmlException, IOException {
            return (CTIntProperty)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTIntProperty parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTIntProperty)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTIntProperty parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTIntProperty)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTIntProperty parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTIntProperty)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTIntProperty parse(Node node) throws XmlException {
            return (CTIntProperty)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTIntProperty parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTIntProperty)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTIntProperty parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTIntProperty)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTIntProperty parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTIntProperty)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
