...
extends XmlObject {
    ...
    public static final class Factory {
        ...
        public static CTRgbColor newInstance() {
            return (CTRgbColor)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTRgbColor newInstance(XmlOptions xmlOptions) {
            return (CTRgbColor)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTRgbColor parse(String string) throws XmlException {
            return (CTRgbColor)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTRgbColor parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTRgbColor)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTRgbColor parse(File file) throws XmlException, IOException {
            return (CTRgbColor)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTRgbColor parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTRgbColor)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTRgbColor parse(URL uRL) throws XmlException, IOException {
            return (CTRgbColor)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTRgbColor parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTRgbColor)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTRgbColor parse(InputStream inputStream) throws XmlException, IOException {
            return (CTRgbColor)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTRgbColor parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTRgbColor)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTRgbColor parse(Reader reader) throws XmlException, IOException {
            return (CTRgbColor)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTRgbColor parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTRgbColor)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTRgbColor parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTRgbColor)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTRgbColor parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTRgbColor)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTRgbColor parse(Node node) throws XmlException {
            return (CTRgbColor)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTRgbColor parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTRgbColor)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTRgbColor parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTRgbColor)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTRgbColor parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTRgbColor)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
