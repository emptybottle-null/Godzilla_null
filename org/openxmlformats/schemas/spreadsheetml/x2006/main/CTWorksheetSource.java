    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTWorksheetSource.class.getClassLoader());
        ...
        public static CTWorksheetSource newInstance() {
            return (CTWorksheetSource)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTWorksheetSource newInstance(XmlOptions xmlOptions) {
            return (CTWorksheetSource)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTWorksheetSource parse(String string) throws XmlException {
            return (CTWorksheetSource)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTWorksheetSource parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTWorksheetSource)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTWorksheetSource parse(File file) throws XmlException, IOException {
            return (CTWorksheetSource)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTWorksheetSource parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTWorksheetSource)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTWorksheetSource parse(URL uRL) throws XmlException, IOException {
            return (CTWorksheetSource)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTWorksheetSource parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTWorksheetSource)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTWorksheetSource parse(InputStream inputStream) throws XmlException, IOException {
            return (CTWorksheetSource)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTWorksheetSource parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTWorksheetSource)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTWorksheetSource parse(Reader reader) throws XmlException, IOException {
            return (CTWorksheetSource)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTWorksheetSource parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTWorksheetSource)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTWorksheetSource parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTWorksheetSource)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTWorksheetSource parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTWorksheetSource)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTWorksheetSource parse(Node node) throws XmlException {
            return (CTWorksheetSource)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTWorksheetSource parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTWorksheetSource)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTWorksheetSource parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTWorksheetSource)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTWorksheetSource parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTWorksheetSource)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
