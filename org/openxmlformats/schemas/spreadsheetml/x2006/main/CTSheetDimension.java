    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTSheetDimension.class.getClassLoader());
        ...
        public static CTSheetDimension newInstance() {
            return (CTSheetDimension)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTSheetDimension newInstance(XmlOptions xmlOptions) {
            return (CTSheetDimension)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTSheetDimension parse(String string) throws XmlException {
            return (CTSheetDimension)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTSheetDimension parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTSheetDimension)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTSheetDimension parse(File file) throws XmlException, IOException {
            return (CTSheetDimension)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTSheetDimension parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSheetDimension)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTSheetDimension parse(URL uRL) throws XmlException, IOException {
            return (CTSheetDimension)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTSheetDimension parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSheetDimension)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTSheetDimension parse(InputStream inputStream) throws XmlException, IOException {
            return (CTSheetDimension)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTSheetDimension parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSheetDimension)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTSheetDimension parse(Reader reader) throws XmlException, IOException {
            return (CTSheetDimension)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTSheetDimension parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSheetDimension)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTSheetDimension parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTSheetDimension)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTSheetDimension parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTSheetDimension)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTSheetDimension parse(Node node) throws XmlException {
            return (CTSheetDimension)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTSheetDimension parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTSheetDimension)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTSheetDimension parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTSheetDimension)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTSheetDimension parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTSheetDimension)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
