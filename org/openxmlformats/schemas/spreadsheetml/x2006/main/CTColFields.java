    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTColFields.class.getClassLoader());
        ...
        public static CTColFields newInstance() {
            return (CTColFields)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTColFields newInstance(XmlOptions xmlOptions) {
            return (CTColFields)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTColFields parse(String string) throws XmlException {
            return (CTColFields)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTColFields parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTColFields)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTColFields parse(File file) throws XmlException, IOException {
            return (CTColFields)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTColFields parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTColFields)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTColFields parse(URL uRL) throws XmlException, IOException {
            return (CTColFields)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTColFields parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTColFields)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTColFields parse(InputStream inputStream) throws XmlException, IOException {
            return (CTColFields)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTColFields parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTColFields)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTColFields parse(Reader reader) throws XmlException, IOException {
            return (CTColFields)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTColFields parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTColFields)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTColFields parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTColFields)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTColFields parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTColFields)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTColFields parse(Node node) throws XmlException {
            return (CTColFields)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTColFields parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTColFields)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTColFields parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTColFields)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTColFields parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTColFields)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
