...
extends XmlString {
    ...
    public static final class Factory {
        ...
        public static STRef newValue(Object object) {
            return (STRef)type.newValue(object);
        }
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(STRef.class.getClassLoader());
        ...
        public static STRef newInstance() {
            return (STRef)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STRef newInstance(XmlOptions xmlOptions) {
            return (STRef)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STRef parse(String string) throws XmlException {
            return (STRef)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STRef parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STRef)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STRef parse(File file) throws XmlException, IOException {
            return (STRef)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STRef parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STRef)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STRef parse(URL uRL) throws XmlException, IOException {
            return (STRef)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STRef parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STRef)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STRef parse(InputStream inputStream) throws XmlException, IOException {
            return (STRef)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static STRef parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STRef)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static STRef parse(Reader reader) throws XmlException, IOException {
            return (STRef)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static STRef parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STRef)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static STRef parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STRef)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static STRef parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STRef)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static STRef parse(Node node) throws XmlException {
            return (STRef)Factory.getTypeLoader().parse(node, type, null);
        }

        public static STRef parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STRef)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static STRef parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (STRef)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static STRef parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STRef)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
