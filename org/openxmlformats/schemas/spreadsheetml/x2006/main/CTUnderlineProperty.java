    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTUnderlineProperty.class.getClassLoader());
        ...
        public static CTUnderlineProperty newInstance() {
            return (CTUnderlineProperty)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTUnderlineProperty newInstance(XmlOptions xmlOptions) {
            return (CTUnderlineProperty)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTUnderlineProperty parse(String string) throws XmlException {
            return (CTUnderlineProperty)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTUnderlineProperty parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTUnderlineProperty)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTUnderlineProperty parse(File file) throws XmlException, IOException {
            return (CTUnderlineProperty)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTUnderlineProperty parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTUnderlineProperty)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTUnderlineProperty parse(URL uRL) throws XmlException, IOException {
            return (CTUnderlineProperty)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTUnderlineProperty parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTUnderlineProperty)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTUnderlineProperty parse(InputStream inputStream) throws XmlException, IOException {
            return (CTUnderlineProperty)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTUnderlineProperty parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTUnderlineProperty)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTUnderlineProperty parse(Reader reader) throws XmlException, IOException {
            return (CTUnderlineProperty)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTUnderlineProperty parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTUnderlineProperty)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTUnderlineProperty parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTUnderlineProperty)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTUnderlineProperty parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTUnderlineProperty)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTUnderlineProperty parse(Node node) throws XmlException {
            return (CTUnderlineProperty)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTUnderlineProperty parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTUnderlineProperty)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTUnderlineProperty parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTUnderlineProperty)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTUnderlineProperty parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTUnderlineProperty)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
