    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(WorkbookDocument.class.getClassLoader());
        ...
        public static WorkbookDocument newInstance() {
            return (WorkbookDocument)Factory.getTypeLoader().newInstance(type, null);
        }

        public static WorkbookDocument newInstance(XmlOptions xmlOptions) {
            return (WorkbookDocument)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static WorkbookDocument parse(String string) throws XmlException {
            return (WorkbookDocument)Factory.getTypeLoader().parse(string, type, null);
        }

        public static WorkbookDocument parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (WorkbookDocument)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static WorkbookDocument parse(File file) throws XmlException, IOException {
            return (WorkbookDocument)Factory.getTypeLoader().parse(file, type, null);
        }

        public static WorkbookDocument parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (WorkbookDocument)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static WorkbookDocument parse(URL uRL) throws XmlException, IOException {
            return (WorkbookDocument)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static WorkbookDocument parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (WorkbookDocument)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static WorkbookDocument parse(InputStream inputStream) throws XmlException, IOException {
            return (WorkbookDocument)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static WorkbookDocument parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (WorkbookDocument)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static WorkbookDocument parse(Reader reader) throws XmlException, IOException {
            return (WorkbookDocument)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static WorkbookDocument parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (WorkbookDocument)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static WorkbookDocument parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (WorkbookDocument)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static WorkbookDocument parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (WorkbookDocument)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static WorkbookDocument parse(Node node) throws XmlException {
            return (WorkbookDocument)Factory.getTypeLoader().parse(node, type, null);
        }

        public static WorkbookDocument parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (WorkbookDocument)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static WorkbookDocument parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (WorkbookDocument)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static WorkbookDocument parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (WorkbookDocument)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
