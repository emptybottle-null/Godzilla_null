    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTPivotCache.class.getClassLoader());
        ...
        public static CTPivotCache newInstance() {
            return (CTPivotCache)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTPivotCache newInstance(XmlOptions xmlOptions) {
            return (CTPivotCache)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTPivotCache parse(String string) throws XmlException {
            return (CTPivotCache)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTPivotCache parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTPivotCache)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTPivotCache parse(File file) throws XmlException, IOException {
            return (CTPivotCache)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTPivotCache parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPivotCache)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTPivotCache parse(URL uRL) throws XmlException, IOException {
            return (CTPivotCache)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTPivotCache parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPivotCache)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTPivotCache parse(InputStream inputStream) throws XmlException, IOException {
            return (CTPivotCache)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTPivotCache parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPivotCache)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTPivotCache parse(Reader reader) throws XmlException, IOException {
            return (CTPivotCache)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTPivotCache parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPivotCache)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTPivotCache parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTPivotCache)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTPivotCache parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTPivotCache)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTPivotCache parse(Node node) throws XmlException {
            return (CTPivotCache)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTPivotCache parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTPivotCache)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTPivotCache parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTPivotCache)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTPivotCache parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTPivotCache)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
