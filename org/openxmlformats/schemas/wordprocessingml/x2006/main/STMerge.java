...
extends XmlString {
    ...
    public static final class Factory {
        ...
        public static STMerge newValue(Object object) {
            return (STMerge)type.newValue(object);
        }
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(STMerge.class.getClassLoader());
        ...
        public static STMerge newInstance() {
            return (STMerge)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STMerge newInstance(XmlOptions xmlOptions) {
            return (STMerge)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STMerge parse(String string) throws XmlException {
            return (STMerge)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STMerge parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STMerge)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STMerge parse(File file) throws XmlException, IOException {
            return (STMerge)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STMerge parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STMerge)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STMerge parse(URL uRL) throws XmlException, IOException {
            return (STMerge)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STMerge parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STMerge)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STMerge parse(InputStream inputStream) throws XmlException, IOException {
            return (STMerge)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static STMerge parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STMerge)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static STMerge parse(Reader reader) throws XmlException, IOException {
            return (STMerge)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static STMerge parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STMerge)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static STMerge parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STMerge)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static STMerge parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STMerge)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static STMerge parse(Node node) throws XmlException {
            return (STMerge)Factory.getTypeLoader().parse(node, type, null);
        }

        public static STMerge parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STMerge)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static STMerge parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (STMerge)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static STMerge parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STMerge)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
