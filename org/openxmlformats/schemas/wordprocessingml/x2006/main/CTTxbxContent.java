    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTTxbxContent.class.getClassLoader());
        ...
        public static CTTxbxContent newInstance() {
            return (CTTxbxContent)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTTxbxContent newInstance(XmlOptions xmlOptions) {
            return (CTTxbxContent)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTTxbxContent parse(String string) throws XmlException {
            return (CTTxbxContent)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTTxbxContent parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTTxbxContent)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTTxbxContent parse(File file) throws XmlException, IOException {
            return (CTTxbxContent)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTTxbxContent parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTxbxContent)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTTxbxContent parse(URL uRL) throws XmlException, IOException {
            return (CTTxbxContent)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTTxbxContent parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTxbxContent)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTTxbxContent parse(InputStream inputStream) throws XmlException, IOException {
            return (CTTxbxContent)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTTxbxContent parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTxbxContent)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTTxbxContent parse(Reader reader) throws XmlException, IOException {
            return (CTTxbxContent)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTTxbxContent parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTxbxContent)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTTxbxContent parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTTxbxContent)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTTxbxContent parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTTxbxContent)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTTxbxContent parse(Node node) throws XmlException {
            return (CTTxbxContent)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTTxbxContent parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTTxbxContent)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTTxbxContent parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTTxbxContent)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTTxbxContent parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTTxbxContent)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
