...
extends XmlObject {
    public static final SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CTSdtContentCell.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sD023D6490046BA0250A839A9AD24C443").resolveHandle("ctsdtcontentcellb170type");
    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTSdtContentCell.class.getClassLoader());
        ...
        public static CTSdtContentCell newInstance() {
            return (CTSdtContentCell)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTSdtContentCell newInstance(XmlOptions xmlOptions) {
            return (CTSdtContentCell)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTSdtContentCell parse(String string) throws XmlException {
            return (CTSdtContentCell)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTSdtContentCell parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTSdtContentCell)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTSdtContentCell parse(File file) throws XmlException, IOException {
            return (CTSdtContentCell)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTSdtContentCell parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentCell)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTSdtContentCell parse(URL uRL) throws XmlException, IOException {
            return (CTSdtContentCell)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTSdtContentCell parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentCell)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTSdtContentCell parse(InputStream inputStream) throws XmlException, IOException {
            return (CTSdtContentCell)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTSdtContentCell parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentCell)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTSdtContentCell parse(Reader reader) throws XmlException, IOException {
            return (CTSdtContentCell)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTSdtContentCell parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentCell)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTSdtContentCell parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTSdtContentCell)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTSdtContentCell parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTSdtContentCell)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTSdtContentCell parse(Node node) throws XmlException {
            return (CTSdtContentCell)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTSdtContentCell parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTSdtContentCell)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTSdtContentCell parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTSdtContentCell)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static CTSdtContentCell parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTSdtContentCell)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
