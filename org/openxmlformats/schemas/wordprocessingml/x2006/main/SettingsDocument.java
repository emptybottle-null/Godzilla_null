    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(SettingsDocument.class.getClassLoader());
        ...
        public static SettingsDocument newInstance() {
            return (SettingsDocument)Factory.getTypeLoader().newInstance(type, null);
        }

        public static SettingsDocument newInstance(XmlOptions xmlOptions) {
            return (SettingsDocument)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static SettingsDocument parse(String string) throws XmlException {
            return (SettingsDocument)Factory.getTypeLoader().parse(string, type, null);
        }

        public static SettingsDocument parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (SettingsDocument)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static SettingsDocument parse(File file) throws XmlException, IOException {
            return (SettingsDocument)Factory.getTypeLoader().parse(file, type, null);
        }

        public static SettingsDocument parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (SettingsDocument)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static SettingsDocument parse(URL uRL) throws XmlException, IOException {
            return (SettingsDocument)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static SettingsDocument parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (SettingsDocument)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static SettingsDocument parse(InputStream inputStream) throws XmlException, IOException {
            return (SettingsDocument)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static SettingsDocument parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (SettingsDocument)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static SettingsDocument parse(Reader reader) throws XmlException, IOException {
            return (SettingsDocument)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static SettingsDocument parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (SettingsDocument)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static SettingsDocument parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (SettingsDocument)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static SettingsDocument parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (SettingsDocument)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static SettingsDocument parse(Node node) throws XmlException {
            return (SettingsDocument)Factory.getTypeLoader().parse(node, type, null);
        }

        public static SettingsDocument parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (SettingsDocument)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static SettingsDocument parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (SettingsDocument)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static SettingsDocument parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (SettingsDocument)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
