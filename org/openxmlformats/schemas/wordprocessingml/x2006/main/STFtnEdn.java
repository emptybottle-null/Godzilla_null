...
extends XmlString {
    ...
    public static final class Factory {
        ...
        public static STFtnEdn newValue(Object object) {
            return (STFtnEdn)type.newValue(object);
        }
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(STFtnEdn.class.getClassLoader());
        ...
        public static STFtnEdn newInstance() {
            return (STFtnEdn)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STFtnEdn newInstance(XmlOptions xmlOptions) {
            return (STFtnEdn)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STFtnEdn parse(String string) throws XmlException {
            return (STFtnEdn)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STFtnEdn parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STFtnEdn)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STFtnEdn parse(File file) throws XmlException, IOException {
            return (STFtnEdn)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STFtnEdn parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STFtnEdn)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STFtnEdn parse(URL uRL) throws XmlException, IOException {
            return (STFtnEdn)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STFtnEdn parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STFtnEdn)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STFtnEdn parse(InputStream inputStream) throws XmlException, IOException {
            return (STFtnEdn)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static STFtnEdn parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STFtnEdn)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static STFtnEdn parse(Reader reader) throws XmlException, IOException {
            return (STFtnEdn)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static STFtnEdn parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STFtnEdn)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static STFtnEdn parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STFtnEdn)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static STFtnEdn parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STFtnEdn)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static STFtnEdn parse(Node node) throws XmlException {
            return (STFtnEdn)Factory.getTypeLoader().parse(node, type, null);
        }

        public static STFtnEdn parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STFtnEdn)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static STFtnEdn parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (STFtnEdn)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static STFtnEdn parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STFtnEdn)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
