    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTRPr.class.getClassLoader());
        ...
        public static CTRPr newInstance() {
            return (CTRPr)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTRPr newInstance(XmlOptions xmlOptions) {
            return (CTRPr)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTRPr parse(String string) throws XmlException {
            return (CTRPr)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTRPr parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTRPr)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTRPr parse(File file) throws XmlException, IOException {
            return (CTRPr)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTRPr parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTRPr)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTRPr parse(URL uRL) throws XmlException, IOException {
            return (CTRPr)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTRPr parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTRPr)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTRPr parse(InputStream inputStream) throws XmlException, IOException {
            return (CTRPr)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTRPr parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTRPr)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTRPr parse(Reader reader) throws XmlException, IOException {
            return (CTRPr)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTRPr parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTRPr)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTRPr parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTRPr)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTRPr parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTRPr)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTRPr parse(Node node) throws XmlException {
            return (CTRPr)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTRPr parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTRPr)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTRPr parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTRPr)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static CTRPr parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTRPr)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
