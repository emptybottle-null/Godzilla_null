    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTHpsMeasure.class.getClassLoader());
        ...
        public static CTHpsMeasure newInstance() {
            return (CTHpsMeasure)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTHpsMeasure newInstance(XmlOptions xmlOptions) {
            return (CTHpsMeasure)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTHpsMeasure parse(String string) throws XmlException {
            return (CTHpsMeasure)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTHpsMeasure parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTHpsMeasure)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTHpsMeasure parse(File file) throws XmlException, IOException {
            return (CTHpsMeasure)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTHpsMeasure parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTHpsMeasure)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTHpsMeasure parse(URL uRL) throws XmlException, IOException {
            return (CTHpsMeasure)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTHpsMeasure parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTHpsMeasure)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTHpsMeasure parse(InputStream inputStream) throws XmlException, IOException {
            return (CTHpsMeasure)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTHpsMeasure parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTHpsMeasure)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTHpsMeasure parse(Reader reader) throws XmlException, IOException {
            return (CTHpsMeasure)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTHpsMeasure parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTHpsMeasure)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTHpsMeasure parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTHpsMeasure)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTHpsMeasure parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTHpsMeasure)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTHpsMeasure parse(Node node) throws XmlException {
            return (CTHpsMeasure)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTHpsMeasure parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTHpsMeasure)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTHpsMeasure parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTHpsMeasure)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTHpsMeasure parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTHpsMeasure)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
