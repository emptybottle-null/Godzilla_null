...
extends XmlString {
    ...
    public static final class Factory {
        ...
        public static STVerticalJc newValue(Object object) {
            return (STVerticalJc)type.newValue(object);
        }
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(STVerticalJc.class.getClassLoader());
        ...
        public static STVerticalJc newInstance() {
            return (STVerticalJc)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STVerticalJc newInstance(XmlOptions xmlOptions) {
            return (STVerticalJc)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STVerticalJc parse(String string) throws XmlException {
            return (STVerticalJc)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STVerticalJc parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STVerticalJc)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STVerticalJc parse(File file) throws XmlException, IOException {
            return (STVerticalJc)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STVerticalJc parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STVerticalJc)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STVerticalJc parse(URL uRL) throws XmlException, IOException {
            return (STVerticalJc)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STVerticalJc parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STVerticalJc)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STVerticalJc parse(InputStream inputStream) throws XmlException, IOException {
            return (STVerticalJc)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static STVerticalJc parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STVerticalJc)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static STVerticalJc parse(Reader reader) throws XmlException, IOException {
            return (STVerticalJc)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static STVerticalJc parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STVerticalJc)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static STVerticalJc parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STVerticalJc)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static STVerticalJc parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STVerticalJc)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static STVerticalJc parse(Node node) throws XmlException {
            return (STVerticalJc)Factory.getTypeLoader().parse(node, type, null);
        }

        public static STVerticalJc parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STVerticalJc)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static STVerticalJc parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (STVerticalJc)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static STVerticalJc parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STVerticalJc)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
