    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTSdtRun.class.getClassLoader());
        ...
        public static CTSdtRun newInstance() {
            return (CTSdtRun)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTSdtRun newInstance(XmlOptions xmlOptions) {
            return (CTSdtRun)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTSdtRun parse(String string) throws XmlException {
            return (CTSdtRun)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTSdtRun parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTSdtRun)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTSdtRun parse(File file) throws XmlException, IOException {
            return (CTSdtRun)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTSdtRun parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtRun)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTSdtRun parse(URL uRL) throws XmlException, IOException {
            return (CTSdtRun)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTSdtRun parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtRun)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTSdtRun parse(InputStream inputStream) throws XmlException, IOException {
            return (CTSdtRun)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTSdtRun parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtRun)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTSdtRun parse(Reader reader) throws XmlException, IOException {
            return (CTSdtRun)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTSdtRun parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtRun)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTSdtRun parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTSdtRun)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTSdtRun parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTSdtRun)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTSdtRun parse(Node node) throws XmlException {
            return (CTSdtRun)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTSdtRun parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTSdtRun)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTSdtRun parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTSdtRun)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static CTSdtRun parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTSdtRun)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
