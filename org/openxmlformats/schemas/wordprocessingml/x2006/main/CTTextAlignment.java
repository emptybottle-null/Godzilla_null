    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTTextAlignment.class.getClassLoader());
        ...
        public static CTTextAlignment newInstance() {
            return (CTTextAlignment)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTTextAlignment newInstance(XmlOptions xmlOptions) {
            return (CTTextAlignment)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTTextAlignment parse(String string) throws XmlException {
            return (CTTextAlignment)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTTextAlignment parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTTextAlignment)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTTextAlignment parse(File file) throws XmlException, IOException {
            return (CTTextAlignment)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTTextAlignment parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTextAlignment)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTTextAlignment parse(URL uRL) throws XmlException, IOException {
            return (CTTextAlignment)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTTextAlignment parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTextAlignment)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTTextAlignment parse(InputStream inputStream) throws XmlException, IOException {
            return (CTTextAlignment)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTTextAlignment parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTextAlignment)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTTextAlignment parse(Reader reader) throws XmlException, IOException {
            return (CTTextAlignment)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTTextAlignment parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTextAlignment)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTTextAlignment parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTTextAlignment)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTTextAlignment parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTTextAlignment)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTTextAlignment parse(Node node) throws XmlException {
            return (CTTextAlignment)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTTextAlignment parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTTextAlignment)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTTextAlignment parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTTextAlignment)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTTextAlignment parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTTextAlignment)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
