    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(FtrDocument.class.getClassLoader());
        ...
        public static FtrDocument newInstance() {
            return (FtrDocument)Factory.getTypeLoader().newInstance(type, null);
        }

        public static FtrDocument newInstance(XmlOptions xmlOptions) {
            return (FtrDocument)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static FtrDocument parse(String string) throws XmlException {
            return (FtrDocument)Factory.getTypeLoader().parse(string, type, null);
        }

        public static FtrDocument parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (FtrDocument)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static FtrDocument parse(File file) throws XmlException, IOException {
            return (FtrDocument)Factory.getTypeLoader().parse(file, type, null);
        }

        public static FtrDocument parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (FtrDocument)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static FtrDocument parse(URL uRL) throws XmlException, IOException {
            return (FtrDocument)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static FtrDocument parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (FtrDocument)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static FtrDocument parse(InputStream inputStream) throws XmlException, IOException {
            return (FtrDocument)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static FtrDocument parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (FtrDocument)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static FtrDocument parse(Reader reader) throws XmlException, IOException {
            return (FtrDocument)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static FtrDocument parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (FtrDocument)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static FtrDocument parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (FtrDocument)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static FtrDocument parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (FtrDocument)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static FtrDocument parse(Node node) throws XmlException {
            return (FtrDocument)Factory.getTypeLoader().parse(node, type, null);
        }

        public static FtrDocument parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (FtrDocument)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static FtrDocument parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (FtrDocument)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static FtrDocument parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (FtrDocument)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
