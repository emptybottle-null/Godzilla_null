...
public interface STEighthPointMeasure
extends STUnsignedDecimalNumber {
    ...
    public static final class Factory {
        ...
        public static STEighthPointMeasure newValue(Object object) {
            return (STEighthPointMeasure)type.newValue(object);
        }
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(STEighthPointMeasure.class.getClassLoader());
        ...
        public static STEighthPointMeasure newInstance() {
            return (STEighthPointMeasure)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STEighthPointMeasure newInstance(XmlOptions xmlOptions) {
            return (STEighthPointMeasure)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STEighthPointMeasure parse(String string) throws XmlException {
            return (STEighthPointMeasure)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STEighthPointMeasure parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STEighthPointMeasure)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STEighthPointMeasure parse(File file) throws XmlException, IOException {
            return (STEighthPointMeasure)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STEighthPointMeasure parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STEighthPointMeasure)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STEighthPointMeasure parse(URL uRL) throws XmlException, IOException {
            return (STEighthPointMeasure)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STEighthPointMeasure parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STEighthPointMeasure)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STEighthPointMeasure parse(InputStream inputStream) throws XmlException, IOException {
            return (STEighthPointMeasure)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static STEighthPointMeasure parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STEighthPointMeasure)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static STEighthPointMeasure parse(Reader reader) throws XmlException, IOException {
            return (STEighthPointMeasure)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static STEighthPointMeasure parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STEighthPointMeasure)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static STEighthPointMeasure parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STEighthPointMeasure)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static STEighthPointMeasure parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STEighthPointMeasure)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static STEighthPointMeasure parse(Node node) throws XmlException {
            return (STEighthPointMeasure)Factory.getTypeLoader().parse(node, type, null);
        }

        public static STEighthPointMeasure parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STEighthPointMeasure)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static STEighthPointMeasure parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (STEighthPointMeasure)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static STEighthPointMeasure parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STEighthPointMeasure)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
