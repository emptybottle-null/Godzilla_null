...
extends XmlObject {
    public static final SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CTSdtContentBlock.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sD023D6490046BA0250A839A9AD24C443").resolveHandle("ctsdtcontentblockb37btype");
    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTSdtContentBlock.class.getClassLoader());
        ...
        public static CTSdtContentBlock newInstance() {
            return (CTSdtContentBlock)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTSdtContentBlock newInstance(XmlOptions xmlOptions) {
            return (CTSdtContentBlock)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTSdtContentBlock parse(String string) throws XmlException {
            return (CTSdtContentBlock)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTSdtContentBlock parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTSdtContentBlock)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTSdtContentBlock parse(File file) throws XmlException, IOException {
            return (CTSdtContentBlock)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTSdtContentBlock parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentBlock)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTSdtContentBlock parse(URL uRL) throws XmlException, IOException {
            return (CTSdtContentBlock)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTSdtContentBlock parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentBlock)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTSdtContentBlock parse(InputStream inputStream) throws XmlException, IOException {
            return (CTSdtContentBlock)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTSdtContentBlock parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentBlock)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTSdtContentBlock parse(Reader reader) throws XmlException, IOException {
            return (CTSdtContentBlock)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTSdtContentBlock parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentBlock)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTSdtContentBlock parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTSdtContentBlock)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTSdtContentBlock parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTSdtContentBlock)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTSdtContentBlock parse(Node node) throws XmlException {
            return (CTSdtContentBlock)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTSdtContentBlock parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTSdtContentBlock)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTSdtContentBlock parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTSdtContentBlock)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static CTSdtContentBlock parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTSdtContentBlock)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
