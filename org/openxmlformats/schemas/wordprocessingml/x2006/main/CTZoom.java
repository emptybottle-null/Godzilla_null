    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTZoom.class.getClassLoader());
        ...
        public static CTZoom newInstance() {
            return (CTZoom)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTZoom newInstance(XmlOptions xmlOptions) {
            return (CTZoom)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTZoom parse(String string) throws XmlException {
            return (CTZoom)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTZoom parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTZoom)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTZoom parse(File file) throws XmlException, IOException {
            return (CTZoom)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTZoom parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTZoom)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTZoom parse(URL uRL) throws XmlException, IOException {
            return (CTZoom)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTZoom parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTZoom)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTZoom parse(InputStream inputStream) throws XmlException, IOException {
            return (CTZoom)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTZoom parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTZoom)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTZoom parse(Reader reader) throws XmlException, IOException {
            return (CTZoom)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTZoom parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTZoom)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTZoom parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTZoom)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTZoom parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTZoom)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTZoom parse(Node node) throws XmlException {
            return (CTZoom)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTZoom parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTZoom)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTZoom parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTZoom)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static CTZoom parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTZoom)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
