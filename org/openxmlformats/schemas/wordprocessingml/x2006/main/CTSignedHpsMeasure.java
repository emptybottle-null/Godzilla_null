    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTSignedHpsMeasure.class.getClassLoader());
        ...
        public static CTSignedHpsMeasure newInstance() {
            return (CTSignedHpsMeasure)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTSignedHpsMeasure newInstance(XmlOptions xmlOptions) {
            return (CTSignedHpsMeasure)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTSignedHpsMeasure parse(String string) throws XmlException {
            return (CTSignedHpsMeasure)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTSignedHpsMeasure parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTSignedHpsMeasure)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTSignedHpsMeasure parse(File file) throws XmlException, IOException {
            return (CTSignedHpsMeasure)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTSignedHpsMeasure parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSignedHpsMeasure)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTSignedHpsMeasure parse(URL uRL) throws XmlException, IOException {
            return (CTSignedHpsMeasure)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTSignedHpsMeasure parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSignedHpsMeasure)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTSignedHpsMeasure parse(InputStream inputStream) throws XmlException, IOException {
            return (CTSignedHpsMeasure)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTSignedHpsMeasure parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSignedHpsMeasure)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTSignedHpsMeasure parse(Reader reader) throws XmlException, IOException {
            return (CTSignedHpsMeasure)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTSignedHpsMeasure parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSignedHpsMeasure)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTSignedHpsMeasure parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTSignedHpsMeasure)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTSignedHpsMeasure parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTSignedHpsMeasure)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTSignedHpsMeasure parse(Node node) throws XmlException {
            return (CTSignedHpsMeasure)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTSignedHpsMeasure parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTSignedHpsMeasure)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTSignedHpsMeasure parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTSignedHpsMeasure)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTSignedHpsMeasure parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTSignedHpsMeasure)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
