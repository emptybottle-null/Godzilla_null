...
implements CTBody {
    ...
    public CTBodyImpl(SchemaType schemaType) {
        super(schemaType);
    }
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTCustomXmlBlock> {
                ...
                public CTCustomXmlBlock set(int n, CTCustomXmlBlock cTCustomXmlBlock) {
                    CTCustomXmlBlock cTCustomXmlBlock2 = CTBodyImpl.this.getCustomXmlArray(n);
                ...
                public CTCustomXmlBlock remove(int n) {
                    CTCustomXmlBlock cTCustomXmlBlock = CTBodyImpl.this.getCustomXmlArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTSdtBlock> {
                ...
                public CTSdtBlock set(int n, CTSdtBlock cTSdtBlock) {
                    CTSdtBlock cTSdtBlock2 = CTBodyImpl.this.getSdtArray(n);
                ...
                public void add(int n, CTSdtBlock cTSdtBlock) {
                    CTBodyImpl.this.insertNewSdt(n).set(cTSdtBlock);
                }

                @Override
                public CTSdtBlock remove(int n) {
                    CTSdtBlock cTSdtBlock = CTBodyImpl.this.getSdtArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTP> {
                ...
                public CTP set(int n, CTP cTP) {
                    CTP cTP2 = CTBodyImpl.this.getPArray(n);
                ...
                public void add(int n, CTP cTP) {
                    CTBodyImpl.this.insertNewP(n).set(cTP);
                }

                @Override
                public CTP remove(int n) {
                    CTP cTP = CTBodyImpl.this.getPArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTTbl> {
                ...
                public CTTbl set(int n, CTTbl cTTbl) {
                    CTTbl cTTbl2 = CTBodyImpl.this.getTblArray(n);
                ...
                public void add(int n, CTTbl cTTbl) {
                    CTBodyImpl.this.insertNewTbl(n).set(cTTbl);
                }

                @Override
                public CTTbl remove(int n) {
                    CTTbl cTTbl = CTBodyImpl.this.getTblArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTProofErr> {
                ...
                public CTProofErr set(int n, CTProofErr cTProofErr) {
                    CTProofErr cTProofErr2 = CTBodyImpl.this.getProofErrArray(n);
                ...
                public void add(int n, CTProofErr cTProofErr) {
                    CTBodyImpl.this.insertNewProofErr(n).set(cTProofErr);
                }

                @Override
                public CTProofErr remove(int n) {
                    CTProofErr cTProofErr = CTBodyImpl.this.getProofErrArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPermStart> {
                ...
                public CTPermStart set(int n, CTPermStart cTPermStart) {
                    CTPermStart cTPermStart2 = CTBodyImpl.this.getPermStartArray(n);
                ...
                public CTPermStart remove(int n) {
                    CTPermStart cTPermStart = CTBodyImpl.this.getPermStartArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPerm> {
                ...
                public CTPerm set(int n, CTPerm cTPerm) {
                    CTPerm cTPerm2 = CTBodyImpl.this.getPermEndArray(n);
                ...
                public CTPerm remove(int n) {
                    CTPerm cTPerm = CTBodyImpl.this.getPermEndArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTBookmark> {
                ...
                public CTBookmark set(int n, CTBookmark cTBookmark) {
                    CTBookmark cTBookmark2 = CTBodyImpl.this.getBookmarkStartArray(n);
                ...
                public void add(int n, CTBookmark cTBookmark) {
                    CTBodyImpl.this.insertNewBookmarkStart(n).set(cTBookmark);
                }

                @Override
                public CTBookmark remove(int n) {
                    CTBookmark cTBookmark = CTBodyImpl.this.getBookmarkStartArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTMarkupRange> {
                ...
                public CTMarkupRange set(int n, CTMarkupRange cTMarkupRange) {
                    CTMarkupRange cTMarkupRange2 = CTBodyImpl.this.getBookmarkEndArray(n);
                ...
                public void add(int n, CTMarkupRange cTMarkupRange) {
                    CTBodyImpl.this.insertNewBookmarkEnd(n).set(cTMarkupRange);
                }

                @Override
                public CTMarkupRange remove(int n) {
                    CTMarkupRange cTMarkupRange = CTBodyImpl.this.getBookmarkEndArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTMoveBookmark> {
                ...
                public CTMoveBookmark set(int n, CTMoveBookmark cTMoveBookmark) {
                    CTMoveBookmark cTMoveBookmark2 = CTBodyImpl.this.getMoveFromRangeStartArray(n);
                ...
                public void add(int n, CTMoveBookmark cTMoveBookmark) {
                    CTBodyImpl.this.insertNewMoveFromRangeStart(n).set(cTMoveBookmark);
                }

                @Override
                public CTMoveBookmark remove(int n) {
                    CTMoveBookmark cTMoveBookmark = CTBodyImpl.this.getMoveFromRangeStartArray(n);
    ...
    public List<CTMarkupRange> getMoveFromRangeEndList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTMarkupRange> {
                ...
                @Override
                public CTMarkupRange set(int n, CTMarkupRange cTMarkupRange) {
                    CTMarkupRange cTMarkupRange2 = CTBodyImpl.this.getMoveFromRangeEndArray(n);
                ...
                @Override
                public void add(int n, CTMarkupRange cTMarkupRange) {
                    CTBodyImpl.this.insertNewMoveFromRangeEnd(n).set(cTMarkupRange);
                }

                @Override
                public CTMarkupRange remove(int n) {
                    CTMarkupRange cTMarkupRange = CTBodyImpl.this.getMoveFromRangeEndArray(n);
    ...
    public List<CTMoveBookmark> getMoveToRangeStartList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTMoveBookmark> {
                ...
                @Override
                public CTMoveBookmark set(int n, CTMoveBookmark cTMoveBookmark) {
                    CTMoveBookmark cTMoveBookmark2 = CTBodyImpl.this.getMoveToRangeStartArray(n);
                ...
                @Override
                public void add(int n, CTMoveBookmark cTMoveBookmark) {
                    CTBodyImpl.this.insertNewMoveToRangeStart(n).set(cTMoveBookmark);
                }

                @Override
                public CTMoveBookmark remove(int n) {
                    CTMoveBookmark cTMoveBookmark = CTBodyImpl.this.getMoveToRangeStartArray(n);
    ...
    public List<CTMarkupRange> getMoveToRangeEndList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTMarkupRange> {
                ...
                @Override
                public CTMarkupRange set(int n, CTMarkupRange cTMarkupRange) {
                    CTMarkupRange cTMarkupRange2 = CTBodyImpl.this.getMoveToRangeEndArray(n);
                ...
                @Override
                public void add(int n, CTMarkupRange cTMarkupRange) {
                    CTBodyImpl.this.insertNewMoveToRangeEnd(n).set(cTMarkupRange);
                }

                @Override
                public CTMarkupRange remove(int n) {
                    CTMarkupRange cTMarkupRange = CTBodyImpl.this.getMoveToRangeEndArray(n);
    ...
    public List<CTMarkupRange> getCommentRangeStartList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTMarkupRange> {
                ...
                @Override
                public CTMarkupRange set(int n, CTMarkupRange cTMarkupRange) {
                    CTMarkupRange cTMarkupRange2 = CTBodyImpl.this.getCommentRangeStartArray(n);
                ...
                @Override
                public void add(int n, CTMarkupRange cTMarkupRange) {
                    CTBodyImpl.this.insertNewCommentRangeStart(n).set(cTMarkupRange);
                }

                @Override
                public CTMarkupRange remove(int n) {
                    CTMarkupRange cTMarkupRange = CTBodyImpl.this.getCommentRangeStartArray(n);
    ...
    public List<CTMarkupRange> getCommentRangeEndList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTMarkupRange> {
                ...
                @Override
                public CTMarkupRange set(int n, CTMarkupRange cTMarkupRange) {
                    CTMarkupRange cTMarkupRange2 = CTBodyImpl.this.getCommentRangeEndArray(n);
                ...
                @Override
                public void add(int n, CTMarkupRange cTMarkupRange) {
                    CTBodyImpl.this.insertNewCommentRangeEnd(n).set(cTMarkupRange);
                }

                @Override
                public CTMarkupRange remove(int n) {
                    CTMarkupRange cTMarkupRange = CTBodyImpl.this.getCommentRangeEndArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTTrackChange> {
                ...
                public CTTrackChange set(int n, CTTrackChange cTTrackChange) {
                    CTTrackChange cTTrackChange2 = CTBodyImpl.this.getCustomXmlInsRangeStartArray(n);
                ...
                public void add(int n, CTTrackChange cTTrackChange) {
                    CTBodyImpl.this.insertNewCustomXmlInsRangeStart(n).set(cTTrackChange);
                }

                @Override
                public CTTrackChange remove(int n) {
                    CTTrackChange cTTrackChange = CTBodyImpl.this.getCustomXmlInsRangeStartArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTMarkup> {
                ...
                public CTMarkup set(int n, CTMarkup cTMarkup) {
                    CTMarkup cTMarkup2 = CTBodyImpl.this.getCustomXmlInsRangeEndArray(n);
                ...
                public void add(int n, CTMarkup cTMarkup) {
                    CTBodyImpl.this.insertNewCustomXmlInsRangeEnd(n).set(cTMarkup);
                }

                @Override
                public CTMarkup remove(int n) {
                    CTMarkup cTMarkup = CTBodyImpl.this.getCustomXmlInsRangeEndArray(n);
    ...
    public List<CTTrackChange> getCustomXmlDelRangeStartList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTTrackChange> {
                ...
                @Override
                public CTTrackChange set(int n, CTTrackChange cTTrackChange) {
                    CTTrackChange cTTrackChange2 = CTBodyImpl.this.getCustomXmlDelRangeStartArray(n);
                ...
                @Override
                public void add(int n, CTTrackChange cTTrackChange) {
                    CTBodyImpl.this.insertNewCustomXmlDelRangeStart(n).set(cTTrackChange);
                }

                @Override
                public CTTrackChange remove(int n) {
                    CTTrackChange cTTrackChange = CTBodyImpl.this.getCustomXmlDelRangeStartArray(n);
    ...
    public List<CTMarkup> getCustomXmlDelRangeEndList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTMarkup> {
                ...
                @Override
                public CTMarkup set(int n, CTMarkup cTMarkup) {
                    CTMarkup cTMarkup2 = CTBodyImpl.this.getCustomXmlDelRangeEndArray(n);
                ...
                @Override
                public void add(int n, CTMarkup cTMarkup) {
                    CTBodyImpl.this.insertNewCustomXmlDelRangeEnd(n).set(cTMarkup);
                }

                @Override
                public CTMarkup remove(int n) {
                    CTMarkup cTMarkup = CTBodyImpl.this.getCustomXmlDelRangeEndArray(n);
    ...
    public List<CTTrackChange> getCustomXmlMoveFromRangeStartList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTTrackChange> {
                ...
                @Override
                public CTTrackChange set(int n, CTTrackChange cTTrackChange) {
                    CTTrackChange cTTrackChange2 = CTBodyImpl.this.getCustomXmlMoveFromRangeStartArray(n);
                ...
                @Override
                public void add(int n, CTTrackChange cTTrackChange) {
                    CTBodyImpl.this.insertNewCustomXmlMoveFromRangeStart(n).set(cTTrackChange);
                }

                @Override
                public CTTrackChange remove(int n) {
                    CTTrackChange cTTrackChange = CTBodyImpl.this.getCustomXmlMoveFromRangeStartArray(n);
    ...
    public List<CTMarkup> getCustomXmlMoveFromRangeEndList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTMarkup> {
                ...
                @Override
                public CTMarkup set(int n, CTMarkup cTMarkup) {
                    CTMarkup cTMarkup2 = CTBodyImpl.this.getCustomXmlMoveFromRangeEndArray(n);
                ...
                @Override
                public void add(int n, CTMarkup cTMarkup) {
                    CTBodyImpl.this.insertNewCustomXmlMoveFromRangeEnd(n).set(cTMarkup);
                }

                @Override
                public CTMarkup remove(int n) {
                    CTMarkup cTMarkup = CTBodyImpl.this.getCustomXmlMoveFromRangeEndArray(n);
    ...
    public List<CTTrackChange> getCustomXmlMoveToRangeStartList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTTrackChange> {
                ...
                @Override
                public CTTrackChange set(int n, CTTrackChange cTTrackChange) {
                    CTTrackChange cTTrackChange2 = CTBodyImpl.this.getCustomXmlMoveToRangeStartArray(n);
                ...
                @Override
                public void add(int n, CTTrackChange cTTrackChange) {
                    CTBodyImpl.this.insertNewCustomXmlMoveToRangeStart(n).set(cTTrackChange);
                }

                @Override
                public CTTrackChange remove(int n) {
                    CTTrackChange cTTrackChange = CTBodyImpl.this.getCustomXmlMoveToRangeStartArray(n);
    ...
    public List<CTMarkup> getCustomXmlMoveToRangeEndList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTMarkup> {
                ...
                @Override
                public CTMarkup set(int n, CTMarkup cTMarkup) {
                    CTMarkup cTMarkup2 = CTBodyImpl.this.getCustomXmlMoveToRangeEndArray(n);
                ...
                @Override
                public void add(int n, CTMarkup cTMarkup) {
                    CTBodyImpl.this.insertNewCustomXmlMoveToRangeEnd(n).set(cTMarkup);
                }

                @Override
                public CTMarkup remove(int n) {
                    CTMarkup cTMarkup = CTBodyImpl.this.getCustomXmlMoveToRangeEndArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTRunTrackChange> {
                ...
                public CTRunTrackChange set(int n, CTRunTrackChange cTRunTrackChange) {
                    CTRunTrackChange cTRunTrackChange2 = CTBodyImpl.this.getInsArray(n);
                ...
                public void add(int n, CTRunTrackChange cTRunTrackChange) {
                    CTBodyImpl.this.insertNewIns(n).set(cTRunTrackChange);
                }

                @Override
                public CTRunTrackChange remove(int n) {
                    CTRunTrackChange cTRunTrackChange = CTBodyImpl.this.getInsArray(n);
    ...
    public List<CTRunTrackChange> getDelList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTRunTrackChange> {
                ...
                @Override
                public CTRunTrackChange set(int n, CTRunTrackChange cTRunTrackChange) {
                    CTRunTrackChange cTRunTrackChange2 = CTBodyImpl.this.getDelArray(n);
                ...
                @Override
                public void add(int n, CTRunTrackChange cTRunTrackChange) {
                    CTBodyImpl.this.insertNewDel(n).set(cTRunTrackChange);
                }

                @Override
                public CTRunTrackChange remove(int n) {
                    CTRunTrackChange cTRunTrackChange = CTBodyImpl.this.getDelArray(n);
    ...
    public List<CTRunTrackChange> getMoveFromList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTRunTrackChange> {
                ...
                @Override
                public CTRunTrackChange set(int n, CTRunTrackChange cTRunTrackChange) {
                    CTRunTrackChange cTRunTrackChange2 = CTBodyImpl.this.getMoveFromArray(n);
                ...
                @Override
                public void add(int n, CTRunTrackChange cTRunTrackChange) {
                    CTBodyImpl.this.insertNewMoveFrom(n).set(cTRunTrackChange);
                }

                @Override
                public CTRunTrackChange remove(int n) {
                    CTRunTrackChange cTRunTrackChange = CTBodyImpl.this.getMoveFromArray(n);
    ...
    public List<CTRunTrackChange> getMoveToList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTRunTrackChange> {
                ...
                @Override
                public CTRunTrackChange set(int n, CTRunTrackChange cTRunTrackChange) {
                    CTRunTrackChange cTRunTrackChange2 = CTBodyImpl.this.getMoveToArray(n);
                ...
                @Override
                public void add(int n, CTRunTrackChange cTRunTrackChange) {
                    CTBodyImpl.this.insertNewMoveTo(n).set(cTRunTrackChange);
                }

                @Override
                public CTRunTrackChange remove(int n) {
                    CTRunTrackChange cTRunTrackChange = CTBodyImpl.this.getMoveToArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTOMathPara> {
                ...
                public CTOMathPara set(int n, CTOMathPara cTOMathPara) {
                    CTOMathPara cTOMathPara2 = CTBodyImpl.this.getOMathParaArray(n);
                ...
                public CTOMathPara remove(int n) {
                    CTOMathPara cTOMathPara = CTBodyImpl.this.getOMathParaArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTOMath> {
                ...
                public CTOMath set(int n, CTOMath cTOMath) {
                    CTOMath cTOMath2 = CTBodyImpl.this.getOMathArray(n);
                ...
                public CTOMath remove(int n) {
                    CTOMath cTOMath = CTBodyImpl.this.getOMathArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTAltChunk> {
                ...
                public CTAltChunk set(int n, CTAltChunk cTAltChunk) {
                    CTAltChunk cTAltChunk2 = CTBodyImpl.this.getAltChunkArray(n);
                ...
                public CTAltChunk remove(int n) {
                    CTAltChunk cTAltChunk = CTBodyImpl.this.getAltChunkArray(n);
    ...
    public CTSectPr getSectPr() {
        ...
        synchronized (object) {
            ...
            cTSectPr = (CTSectPr)((Object)this.get_store().find_element_user(SECTPR$60, 0));
            if (cTSectPr == null) {
                return null;
            }
            return cTSectPr;
    ...
    public void setSectPr(CTSectPr cTSectPr) {
        this.generatedSetterHelperImpl(cTSectPr, SECTPR$60, 0, (short)1);
    }
    ...
    public CTSectPr addNewSectPr() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTSectPr cTSectPr = null;
            cTSectPr = (CTSectPr)((Object)this.get_store().add_element_user(SECTPR$60));
            return cTSectPr;
        }
    }
