...
implements CTComment {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTCustomXmlBlock> {
                ...
                public CTCustomXmlBlock set(int n, CTCustomXmlBlock cTCustomXmlBlock) {
                    CTCustomXmlBlock cTCustomXmlBlock2 = CTCommentImpl.this.getCustomXmlArray(n);
                ...
                public CTCustomXmlBlock remove(int n) {
                    CTCustomXmlBlock cTCustomXmlBlock = CTCommentImpl.this.getCustomXmlArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTSdtBlock> {
                ...
                public CTSdtBlock set(int n, CTSdtBlock cTSdtBlock) {
                    CTSdtBlock cTSdtBlock2 = CTCommentImpl.this.getSdtArray(n);
                ...
                public void add(int n, CTSdtBlock cTSdtBlock) {
                    CTCommentImpl.this.insertNewSdt(n).set(cTSdtBlock);
                }

                @Override
                public CTSdtBlock remove(int n) {
                    CTSdtBlock cTSdtBlock = CTCommentImpl.this.getSdtArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTP> {
                ...
                public CTP set(int n, CTP cTP) {
                    CTP cTP2 = CTCommentImpl.this.getPArray(n);
                ...
                public void add(int n, CTP cTP) {
                    CTCommentImpl.this.insertNewP(n).set(cTP);
                }

                @Override
                public CTP remove(int n) {
                    CTP cTP = CTCommentImpl.this.getPArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTTbl> {
                ...
                public CTTbl set(int n, CTTbl cTTbl) {
                    CTTbl cTTbl2 = CTCommentImpl.this.getTblArray(n);
                ...
                public void add(int n, CTTbl cTTbl) {
                    CTCommentImpl.this.insertNewTbl(n).set(cTTbl);
                }

                @Override
                public CTTbl remove(int n) {
                    CTTbl cTTbl = CTCommentImpl.this.getTblArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTProofErr> {
                ...
                public CTProofErr set(int n, CTProofErr cTProofErr) {
                    CTProofErr cTProofErr2 = CTCommentImpl.this.getProofErrArray(n);
                ...
                public void add(int n, CTProofErr cTProofErr) {
                    CTCommentImpl.this.insertNewProofErr(n).set(cTProofErr);
                }

                @Override
                public CTProofErr remove(int n) {
                    CTProofErr cTProofErr = CTCommentImpl.this.getProofErrArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPermStart> {
                ...
                public CTPermStart set(int n, CTPermStart cTPermStart) {
                    CTPermStart cTPermStart2 = CTCommentImpl.this.getPermStartArray(n);
                ...
                public CTPermStart remove(int n) {
                    CTPermStart cTPermStart = CTCommentImpl.this.getPermStartArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTPerm> {
                ...
                public CTPerm set(int n, CTPerm cTPerm) {
                    CTPerm cTPerm2 = CTCommentImpl.this.getPermEndArray(n);
                ...
                public CTPerm remove(int n) {
                    CTPerm cTPerm = CTCommentImpl.this.getPermEndArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTBookmark> {
                ...
                public CTBookmark set(int n, CTBookmark cTBookmark) {
                    CTBookmark cTBookmark2 = CTCommentImpl.this.getBookmarkStartArray(n);
                ...
                public void add(int n, CTBookmark cTBookmark) {
                    CTCommentImpl.this.insertNewBookmarkStart(n).set(cTBookmark);
                }

                @Override
                public CTBookmark remove(int n) {
                    CTBookmark cTBookmark = CTCommentImpl.this.getBookmarkStartArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTMarkupRange> {
                ...
                public CTMarkupRange set(int n, CTMarkupRange cTMarkupRange) {
                    CTMarkupRange cTMarkupRange2 = CTCommentImpl.this.getBookmarkEndArray(n);
                ...
                public void add(int n, CTMarkupRange cTMarkupRange) {
                    CTCommentImpl.this.insertNewBookmarkEnd(n).set(cTMarkupRange);
                }

                @Override
                public CTMarkupRange remove(int n) {
                    CTMarkupRange cTMarkupRange = CTCommentImpl.this.getBookmarkEndArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTMoveBookmark> {
                ...
                public CTMoveBookmark set(int n, CTMoveBookmark cTMoveBookmark) {
                    CTMoveBookmark cTMoveBookmark2 = CTCommentImpl.this.getMoveFromRangeStartArray(n);
                ...
                public void add(int n, CTMoveBookmark cTMoveBookmark) {
                    CTCommentImpl.this.insertNewMoveFromRangeStart(n).set(cTMoveBookmark);
                }

                @Override
                public CTMoveBookmark remove(int n) {
                    CTMoveBookmark cTMoveBookmark = CTCommentImpl.this.getMoveFromRangeStartArray(n);
    ...
    public List<CTMarkupRange> getMoveFromRangeEndList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTMarkupRange> {
                ...
                @Override
                public CTMarkupRange set(int n, CTMarkupRange cTMarkupRange) {
                    CTMarkupRange cTMarkupRange2 = CTCommentImpl.this.getMoveFromRangeEndArray(n);
                ...
                @Override
                public void add(int n, CTMarkupRange cTMarkupRange) {
                    CTCommentImpl.this.insertNewMoveFromRangeEnd(n).set(cTMarkupRange);
                }

                @Override
                public CTMarkupRange remove(int n) {
                    CTMarkupRange cTMarkupRange = CTCommentImpl.this.getMoveFromRangeEndArray(n);
    ...
    public List<CTMoveBookmark> getMoveToRangeStartList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTMoveBookmark> {
                ...
                @Override
                public CTMoveBookmark set(int n, CTMoveBookmark cTMoveBookmark) {
                    CTMoveBookmark cTMoveBookmark2 = CTCommentImpl.this.getMoveToRangeStartArray(n);
                ...
                @Override
                public void add(int n, CTMoveBookmark cTMoveBookmark) {
                    CTCommentImpl.this.insertNewMoveToRangeStart(n).set(cTMoveBookmark);
                }

                @Override
                public CTMoveBookmark remove(int n) {
                    CTMoveBookmark cTMoveBookmark = CTCommentImpl.this.getMoveToRangeStartArray(n);
    ...
    public List<CTMarkupRange> getMoveToRangeEndList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTMarkupRange> {
                ...
                @Override
                public CTMarkupRange set(int n, CTMarkupRange cTMarkupRange) {
                    CTMarkupRange cTMarkupRange2 = CTCommentImpl.this.getMoveToRangeEndArray(n);
                ...
                @Override
                public void add(int n, CTMarkupRange cTMarkupRange) {
                    CTCommentImpl.this.insertNewMoveToRangeEnd(n).set(cTMarkupRange);
                }

                @Override
                public CTMarkupRange remove(int n) {
                    CTMarkupRange cTMarkupRange = CTCommentImpl.this.getMoveToRangeEndArray(n);
    ...
    public List<CTMarkupRange> getCommentRangeStartList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTMarkupRange> {
                ...
                @Override
                public CTMarkupRange set(int n, CTMarkupRange cTMarkupRange) {
                    CTMarkupRange cTMarkupRange2 = CTCommentImpl.this.getCommentRangeStartArray(n);
                ...
                @Override
                public void add(int n, CTMarkupRange cTMarkupRange) {
                    CTCommentImpl.this.insertNewCommentRangeStart(n).set(cTMarkupRange);
                }

                @Override
                public CTMarkupRange remove(int n) {
                    CTMarkupRange cTMarkupRange = CTCommentImpl.this.getCommentRangeStartArray(n);
    ...
    public List<CTMarkupRange> getCommentRangeEndList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTMarkupRange> {
                ...
                @Override
                public CTMarkupRange set(int n, CTMarkupRange cTMarkupRange) {
                    CTMarkupRange cTMarkupRange2 = CTCommentImpl.this.getCommentRangeEndArray(n);
                ...
                @Override
                public void add(int n, CTMarkupRange cTMarkupRange) {
                    CTCommentImpl.this.insertNewCommentRangeEnd(n).set(cTMarkupRange);
                }

                @Override
                public CTMarkupRange remove(int n) {
                    CTMarkupRange cTMarkupRange = CTCommentImpl.this.getCommentRangeEndArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTTrackChange> {
                ...
                public CTTrackChange set(int n, CTTrackChange cTTrackChange) {
                    CTTrackChange cTTrackChange2 = CTCommentImpl.this.getCustomXmlInsRangeStartArray(n);
                ...
                public void add(int n, CTTrackChange cTTrackChange) {
                    CTCommentImpl.this.insertNewCustomXmlInsRangeStart(n).set(cTTrackChange);
                }

                @Override
                public CTTrackChange remove(int n) {
                    CTTrackChange cTTrackChange = CTCommentImpl.this.getCustomXmlInsRangeStartArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTMarkup> {
                ...
                public CTMarkup set(int n, CTMarkup cTMarkup) {
                    CTMarkup cTMarkup2 = CTCommentImpl.this.getCustomXmlInsRangeEndArray(n);
                ...
                public void add(int n, CTMarkup cTMarkup) {
                    CTCommentImpl.this.insertNewCustomXmlInsRangeEnd(n).set(cTMarkup);
                }

                @Override
                public CTMarkup remove(int n) {
                    CTMarkup cTMarkup = CTCommentImpl.this.getCustomXmlInsRangeEndArray(n);
    ...
    public List<CTTrackChange> getCustomXmlDelRangeStartList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTTrackChange> {
                ...
                @Override
                public CTTrackChange set(int n, CTTrackChange cTTrackChange) {
                    CTTrackChange cTTrackChange2 = CTCommentImpl.this.getCustomXmlDelRangeStartArray(n);
                ...
                @Override
                public void add(int n, CTTrackChange cTTrackChange) {
                    CTCommentImpl.this.insertNewCustomXmlDelRangeStart(n).set(cTTrackChange);
                }

                @Override
                public CTTrackChange remove(int n) {
                    CTTrackChange cTTrackChange = CTCommentImpl.this.getCustomXmlDelRangeStartArray(n);
    ...
    public List<CTMarkup> getCustomXmlDelRangeEndList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTMarkup> {
                ...
                @Override
                public CTMarkup set(int n, CTMarkup cTMarkup) {
                    CTMarkup cTMarkup2 = CTCommentImpl.this.getCustomXmlDelRangeEndArray(n);
                ...
                @Override
                public void add(int n, CTMarkup cTMarkup) {
                    CTCommentImpl.this.insertNewCustomXmlDelRangeEnd(n).set(cTMarkup);
                }

                @Override
                public CTMarkup remove(int n) {
                    CTMarkup cTMarkup = CTCommentImpl.this.getCustomXmlDelRangeEndArray(n);
    ...
    public List<CTTrackChange> getCustomXmlMoveFromRangeStartList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTTrackChange> {
                ...
                @Override
                public CTTrackChange set(int n, CTTrackChange cTTrackChange) {
                    CTTrackChange cTTrackChange2 = CTCommentImpl.this.getCustomXmlMoveFromRangeStartArray(n);
                ...
                @Override
                public void add(int n, CTTrackChange cTTrackChange) {
                    CTCommentImpl.this.insertNewCustomXmlMoveFromRangeStart(n).set(cTTrackChange);
                }

                @Override
                public CTTrackChange remove(int n) {
                    CTTrackChange cTTrackChange = CTCommentImpl.this.getCustomXmlMoveFromRangeStartArray(n);
    ...
    public List<CTMarkup> getCustomXmlMoveFromRangeEndList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTMarkup> {
                ...
                @Override
                public CTMarkup set(int n, CTMarkup cTMarkup) {
                    CTMarkup cTMarkup2 = CTCommentImpl.this.getCustomXmlMoveFromRangeEndArray(n);
                ...
                @Override
                public void add(int n, CTMarkup cTMarkup) {
                    CTCommentImpl.this.insertNewCustomXmlMoveFromRangeEnd(n).set(cTMarkup);
                }

                @Override
                public CTMarkup remove(int n) {
                    CTMarkup cTMarkup = CTCommentImpl.this.getCustomXmlMoveFromRangeEndArray(n);
    ...
    public List<CTTrackChange> getCustomXmlMoveToRangeStartList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTTrackChange> {
                ...
                @Override
                public CTTrackChange set(int n, CTTrackChange cTTrackChange) {
                    CTTrackChange cTTrackChange2 = CTCommentImpl.this.getCustomXmlMoveToRangeStartArray(n);
                ...
                @Override
                public void add(int n, CTTrackChange cTTrackChange) {
                    CTCommentImpl.this.insertNewCustomXmlMoveToRangeStart(n).set(cTTrackChange);
                }

                @Override
                public CTTrackChange remove(int n) {
                    CTTrackChange cTTrackChange = CTCommentImpl.this.getCustomXmlMoveToRangeStartArray(n);
    ...
    public List<CTMarkup> getCustomXmlMoveToRangeEndList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTMarkup> {
                ...
                @Override
                public CTMarkup set(int n, CTMarkup cTMarkup) {
                    CTMarkup cTMarkup2 = CTCommentImpl.this.getCustomXmlMoveToRangeEndArray(n);
                ...
                @Override
                public void add(int n, CTMarkup cTMarkup) {
                    CTCommentImpl.this.insertNewCustomXmlMoveToRangeEnd(n).set(cTMarkup);
                }

                @Override
                public CTMarkup remove(int n) {
                    CTMarkup cTMarkup = CTCommentImpl.this.getCustomXmlMoveToRangeEndArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTRunTrackChange> {
                ...
                public CTRunTrackChange set(int n, CTRunTrackChange cTRunTrackChange) {
                    CTRunTrackChange cTRunTrackChange2 = CTCommentImpl.this.getInsArray(n);
                ...
                public void add(int n, CTRunTrackChange cTRunTrackChange) {
                    CTCommentImpl.this.insertNewIns(n).set(cTRunTrackChange);
                }

                @Override
                public CTRunTrackChange remove(int n) {
                    CTRunTrackChange cTRunTrackChange = CTCommentImpl.this.getInsArray(n);
    ...
    public List<CTRunTrackChange> getDelList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTRunTrackChange> {
                ...
                @Override
                public CTRunTrackChange set(int n, CTRunTrackChange cTRunTrackChange) {
                    CTRunTrackChange cTRunTrackChange2 = CTCommentImpl.this.getDelArray(n);
                ...
                @Override
                public void add(int n, CTRunTrackChange cTRunTrackChange) {
                    CTCommentImpl.this.insertNewDel(n).set(cTRunTrackChange);
                }

                @Override
                public CTRunTrackChange remove(int n) {
                    CTRunTrackChange cTRunTrackChange = CTCommentImpl.this.getDelArray(n);
    ...
    public List<CTRunTrackChange> getMoveFromList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTRunTrackChange> {
                ...
                @Override
                public CTRunTrackChange set(int n, CTRunTrackChange cTRunTrackChange) {
                    CTRunTrackChange cTRunTrackChange2 = CTCommentImpl.this.getMoveFromArray(n);
                ...
                @Override
                public void add(int n, CTRunTrackChange cTRunTrackChange) {
                    CTCommentImpl.this.insertNewMoveFrom(n).set(cTRunTrackChange);
                }

                @Override
                public CTRunTrackChange remove(int n) {
                    CTRunTrackChange cTRunTrackChange = CTCommentImpl.this.getMoveFromArray(n);
    ...
    public List<CTRunTrackChange> getMoveToList() {
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTRunTrackChange> {
                ...
                @Override
                public CTRunTrackChange set(int n, CTRunTrackChange cTRunTrackChange) {
                    CTRunTrackChange cTRunTrackChange2 = CTCommentImpl.this.getMoveToArray(n);
                ...
                @Override
                public void add(int n, CTRunTrackChange cTRunTrackChange) {
                    CTCommentImpl.this.insertNewMoveTo(n).set(cTRunTrackChange);
                }

                @Override
                public CTRunTrackChange remove(int n) {
                    CTRunTrackChange cTRunTrackChange = CTCommentImpl.this.getMoveToArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTOMathPara> {
                ...
                public CTOMathPara set(int n, CTOMathPara cTOMathPara) {
                    CTOMathPara cTOMathPara2 = CTCommentImpl.this.getOMathParaArray(n);
                ...
                public CTOMathPara remove(int n) {
                    CTOMathPara cTOMathPara = CTCommentImpl.this.getOMathParaArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTOMath> {
                ...
                public CTOMath set(int n, CTOMath cTOMath) {
                    CTOMath cTOMath2 = CTCommentImpl.this.getOMathArray(n);
                ...
                public CTOMath remove(int n) {
                    CTOMath cTOMath = CTCommentImpl.this.getOMathArray(n);
        ...
        synchronized (object) {
            ...
            extends AbstractList<CTAltChunk> {
                ...
                public CTAltChunk set(int n, CTAltChunk cTAltChunk) {
                    CTAltChunk cTAltChunk2 = CTCommentImpl.this.getAltChunkArray(n);
                ...
                public CTAltChunk remove(int n) {
                    CTAltChunk cTAltChunk = CTCommentImpl.this.getAltChunkArray(n);
    ...
    public String getInitials() {
        ...
        synchronized (object) {
            ...
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(INITIALS$60));
            if (simpleValue == null) {
                return null;
            }
    ...
    public STString xgetInitials() {
        ...
        synchronized (object) {
            ...
            sTString = (STString)((Object)this.get_store().find_attribute_user(INITIALS$60));
            return sTString;
        }
    }
    ...
    public void setInitials(String string) {
        ...
        synchronized (object) {
            ...
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(INITIALS$60));
            if (simpleValue == null) {
                simpleValue = (SimpleValue)((Object)this.get_store().add_attribute_user(INITIALS$60));
            }
    ...
    public void xsetInitials(STString sTString) {
        ...
        synchronized (object) {
            ...
            sTString2 = (STString)((Object)this.get_store().find_attribute_user(INITIALS$60));
            if (sTString2 == null) {
                sTString2 = (STString)((Object)this.get_store().add_attribute_user(INITIALS$60));
            }
