...
implements CTTextScale {
    ...
    public STTextScale xgetVal() {
        ...
        synchronized (object) {
            this.check_orphaned();
            STTextScale sTTextScale = null;
            sTTextScale = (STTextScale)((Object)this.get_store().find_attribute_user(VAL$0));
            return sTTextScale;
        }
    }
    ...
    public void xsetVal(STTextScale sTTextScale) {
        ...
        synchronized (object) {
            this.check_orphaned();
            STTextScale sTTextScale2 = null;
            sTTextScale2 = (STTextScale)((Object)this.get_store().find_attribute_user(VAL$0));
            if (sTTextScale2 == null) {
                sTTextScale2 = (STTextScale)((Object)this.get_store().add_attribute_user(VAL$0));
            }
