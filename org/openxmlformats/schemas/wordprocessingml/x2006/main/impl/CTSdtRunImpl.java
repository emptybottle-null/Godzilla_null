...
implements CTSdtRun {
    ...
    public CTSdtContentRun getSdtContent() {
        ...
        synchronized (object) {
            ...
            cTSdtContentRun = (CTSdtContentRun)((Object)this.get_store().find_element_user(SDTCONTENT$4, 0));
    ...
    public void setSdtContent(CTSdtContentRun cTSdtContentRun) {
        this.generatedSetterHelperImpl(cTSdtContentRun, SDTCONTENT$4, 0, (short)1);
    }
    ...
    public CTSdtContentRun addNewSdtContent() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTSdtContentRun cTSdtContentRun = null;
            cTSdtContentRun = (CTSdtContentRun)((Object)this.get_store().add_element_user(SDTCONTENT$4));
            return cTSdtContentRun;
        }
    }
