...
implements CTColor {
    ...
    public STHexColor xgetVal() {
        ...
        synchronized (object) {
            ...
            sTHexColor = (STHexColor)((Object)this.get_store().find_attribute_user(VAL$0));
            return sTHexColor;
        }
    }
    ...
    public void xsetVal(STHexColor sTHexColor) {
        ...
        synchronized (object) {
            ...
            sTHexColor2 = (STHexColor)((Object)this.get_store().find_attribute_user(VAL$0));
            if (sTHexColor2 == null) {
                sTHexColor2 = (STHexColor)((Object)this.get_store().add_attribute_user(VAL$0));
            }
