...
implements CTSignedTwipsMeasure {
    ...
    public CTSignedTwipsMeasureImpl(SchemaType schemaType) {
        super(schemaType);
    }
    ...
    public STSignedTwipsMeasure xgetVal() {
        ...
        synchronized (object) {
            ...
            sTSignedTwipsMeasure = (STSignedTwipsMeasure)((Object)this.get_store().find_attribute_user(VAL$0));
     ...
     */
    @Override
    public void xsetVal(STSignedTwipsMeasure sTSignedTwipsMeasure) {
        Object object = this.monitor();
        synchronized (object) {
            this.check_orphaned();
            STSignedTwipsMeasure sTSignedTwipsMeasure2 = null;
            sTSignedTwipsMeasure2 = (STSignedTwipsMeasure)((Object)this.get_store().find_attribute_user(VAL$0));
            if (sTSignedTwipsMeasure2 == null) {
                sTSignedTwipsMeasure2 = (STSignedTwipsMeasure)((Object)this.get_store().add_attribute_user(VAL$0));
            }
