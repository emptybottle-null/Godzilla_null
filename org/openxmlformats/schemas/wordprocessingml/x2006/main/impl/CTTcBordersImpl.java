...
implements CTTcBorders {
    ...
    public CTBorder getTl2Br() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTBorder cTBorder = null;
            cTBorder = (CTBorder)((Object)this.get_store().find_element_user(TL2BR$12, 0));
            if (cTBorder == null) {
                return null;
            }
            return cTBorder;
    ...
    public void setTl2Br(CTBorder cTBorder) {
        this.generatedSetterHelperImpl(cTBorder, TL2BR$12, 0, (short)1);
    }
    ...
    public CTBorder addNewTl2Br() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTBorder cTBorder = null;
            cTBorder = (CTBorder)((Object)this.get_store().add_element_user(TL2BR$12));
            return cTBorder;
        }
    }
    ...
    public CTBorder getTr2Bl() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTBorder cTBorder = null;
            cTBorder = (CTBorder)((Object)this.get_store().find_element_user(TR2BL$14, 0));
            if (cTBorder == null) {
                return null;
            }
            return cTBorder;
    ...
    public void setTr2Bl(CTBorder cTBorder) {
        this.generatedSetterHelperImpl(cTBorder, TR2BL$14, 0, (short)1);
    }
    ...
    public CTBorder addNewTr2Bl() {
        ...
        synchronized (object) {
            this.check_orphaned();
            CTBorder cTBorder = null;
            cTBorder = (CTBorder)((Object)this.get_store().add_element_user(TR2BL$14));
            return cTBorder;
        }
    }
