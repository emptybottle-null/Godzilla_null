...
implements CTHeight {
    ...
    public STTwipsMeasure xgetVal() {
        ...
        synchronized (object) {
            ...
            sTTwipsMeasure = (STTwipsMeasure)((Object)this.get_store().find_attribute_user(VAL$0));
    ...
    public void xsetVal(STTwipsMeasure sTTwipsMeasure) {
        ...
        synchronized (object) {
            ...
            sTTwipsMeasure2 = (STTwipsMeasure)((Object)this.get_store().find_attribute_user(VAL$0));
            if (sTTwipsMeasure2 == null) {
                sTTwipsMeasure2 = (STTwipsMeasure)((Object)this.get_store().add_attribute_user(VAL$0));
            }
    ...
    public STHeightRule.Enum getHRule() {
        ...
        synchronized (object) {
            this.check_orphaned();
            SimpleValue simpleValue = null;
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(HRULE$2));
            if (simpleValue == null) {
                return null;
            }
    ...
    public STHeightRule xgetHRule() {
        ...
        synchronized (object) {
            ...
            sTHeightRule = (STHeightRule)((Object)this.get_store().find_attribute_user(HRULE$2));
            return sTHeightRule;
        }
    }
     ...
     */
    @Override
    public void setHRule(STHeightRule.Enum enum_) {
        Object object = this.monitor();
        synchronized (object) {
            this.check_orphaned();
            SimpleValue simpleValue = null;
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(HRULE$2));
            if (simpleValue == null) {
                simpleValue = (SimpleValue)((Object)this.get_store().add_attribute_user(HRULE$2));
            }
    ...
    public void xsetHRule(STHeightRule sTHeightRule) {
        ...
        synchronized (object) {
            this.check_orphaned();
            STHeightRule sTHeightRule2 = null;
            sTHeightRule2 = (STHeightRule)((Object)this.get_store().find_attribute_user(HRULE$2));
            if (sTHeightRule2 == null) {
                sTHeightRule2 = (STHeightRule)((Object)this.get_store().add_attribute_user(HRULE$2));
            }
