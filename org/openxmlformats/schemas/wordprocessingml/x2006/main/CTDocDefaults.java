    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTDocDefaults.class.getClassLoader());
        ...
        public static CTDocDefaults newInstance() {
            return (CTDocDefaults)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTDocDefaults newInstance(XmlOptions xmlOptions) {
            return (CTDocDefaults)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTDocDefaults parse(String string) throws XmlException {
            return (CTDocDefaults)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTDocDefaults parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTDocDefaults)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTDocDefaults parse(File file) throws XmlException, IOException {
            return (CTDocDefaults)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTDocDefaults parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTDocDefaults)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTDocDefaults parse(URL uRL) throws XmlException, IOException {
            return (CTDocDefaults)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTDocDefaults parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTDocDefaults)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTDocDefaults parse(InputStream inputStream) throws XmlException, IOException {
            return (CTDocDefaults)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTDocDefaults parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTDocDefaults)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTDocDefaults parse(Reader reader) throws XmlException, IOException {
            return (CTDocDefaults)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTDocDefaults parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTDocDefaults)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTDocDefaults parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTDocDefaults)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTDocDefaults parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTDocDefaults)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTDocDefaults parse(Node node) throws XmlException {
            return (CTDocDefaults)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTDocDefaults parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTDocDefaults)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTDocDefaults parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTDocDefaults)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTDocDefaults parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTDocDefaults)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
