    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(FootnotesDocument.class.getClassLoader());
        ...
        public static FootnotesDocument newInstance() {
            return (FootnotesDocument)Factory.getTypeLoader().newInstance(type, null);
        }

        public static FootnotesDocument newInstance(XmlOptions xmlOptions) {
            return (FootnotesDocument)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static FootnotesDocument parse(String string) throws XmlException {
            return (FootnotesDocument)Factory.getTypeLoader().parse(string, type, null);
        }

        public static FootnotesDocument parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (FootnotesDocument)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static FootnotesDocument parse(File file) throws XmlException, IOException {
            return (FootnotesDocument)Factory.getTypeLoader().parse(file, type, null);
        }

        public static FootnotesDocument parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (FootnotesDocument)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static FootnotesDocument parse(URL uRL) throws XmlException, IOException {
            return (FootnotesDocument)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static FootnotesDocument parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (FootnotesDocument)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static FootnotesDocument parse(InputStream inputStream) throws XmlException, IOException {
            return (FootnotesDocument)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static FootnotesDocument parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (FootnotesDocument)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static FootnotesDocument parse(Reader reader) throws XmlException, IOException {
            return (FootnotesDocument)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static FootnotesDocument parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (FootnotesDocument)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static FootnotesDocument parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (FootnotesDocument)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static FootnotesDocument parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (FootnotesDocument)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static FootnotesDocument parse(Node node) throws XmlException {
            return (FootnotesDocument)Factory.getTypeLoader().parse(node, type, null);
        }

        public static FootnotesDocument parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (FootnotesDocument)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static FootnotesDocument parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (FootnotesDocument)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static FootnotesDocument parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (FootnotesDocument)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
