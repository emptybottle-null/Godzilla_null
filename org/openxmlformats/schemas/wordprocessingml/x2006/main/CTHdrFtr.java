...
extends XmlObject {
    public static final SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CTHdrFtr.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sD023D6490046BA0250A839A9AD24C443").resolveHandle("cthdrftr26datype");
    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTHdrFtr.class.getClassLoader());
        ...
        public static CTHdrFtr newInstance() {
            return (CTHdrFtr)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTHdrFtr newInstance(XmlOptions xmlOptions) {
            return (CTHdrFtr)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTHdrFtr parse(String string) throws XmlException {
            return (CTHdrFtr)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTHdrFtr parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTHdrFtr)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTHdrFtr parse(File file) throws XmlException, IOException {
            return (CTHdrFtr)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTHdrFtr parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTHdrFtr)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTHdrFtr parse(URL uRL) throws XmlException, IOException {
            return (CTHdrFtr)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTHdrFtr parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTHdrFtr)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTHdrFtr parse(InputStream inputStream) throws XmlException, IOException {
            return (CTHdrFtr)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTHdrFtr parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTHdrFtr)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTHdrFtr parse(Reader reader) throws XmlException, IOException {
            return (CTHdrFtr)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTHdrFtr parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTHdrFtr)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTHdrFtr parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTHdrFtr)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTHdrFtr parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTHdrFtr)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTHdrFtr parse(Node node) throws XmlException {
            return (CTHdrFtr)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTHdrFtr parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTHdrFtr)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTHdrFtr parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTHdrFtr)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static CTHdrFtr parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTHdrFtr)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
