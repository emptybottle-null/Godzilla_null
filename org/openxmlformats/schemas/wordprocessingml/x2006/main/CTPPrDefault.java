    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTPPrDefault.class.getClassLoader());
        ...
        public static CTPPrDefault newInstance() {
            return (CTPPrDefault)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTPPrDefault newInstance(XmlOptions xmlOptions) {
            return (CTPPrDefault)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTPPrDefault parse(String string) throws XmlException {
            return (CTPPrDefault)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTPPrDefault parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTPPrDefault)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTPPrDefault parse(File file) throws XmlException, IOException {
            return (CTPPrDefault)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTPPrDefault parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPPrDefault)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTPPrDefault parse(URL uRL) throws XmlException, IOException {
            return (CTPPrDefault)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTPPrDefault parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPPrDefault)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTPPrDefault parse(InputStream inputStream) throws XmlException, IOException {
            return (CTPPrDefault)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTPPrDefault parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPPrDefault)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTPPrDefault parse(Reader reader) throws XmlException, IOException {
            return (CTPPrDefault)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTPPrDefault parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPPrDefault)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTPPrDefault parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTPPrDefault)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTPPrDefault parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTPPrDefault)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTPPrDefault parse(Node node) throws XmlException {
            return (CTPPrDefault)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTPPrDefault parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTPPrDefault)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTPPrDefault parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTPPrDefault)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTPPrDefault parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTPPrDefault)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
