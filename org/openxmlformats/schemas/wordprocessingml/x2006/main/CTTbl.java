    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTTbl.class.getClassLoader());
        ...
        public static CTTbl newInstance() {
            return (CTTbl)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTTbl newInstance(XmlOptions xmlOptions) {
            return (CTTbl)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTTbl parse(String string) throws XmlException {
            return (CTTbl)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTTbl parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTTbl)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTTbl parse(File file) throws XmlException, IOException {
            return (CTTbl)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTTbl parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTbl)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTTbl parse(URL uRL) throws XmlException, IOException {
            return (CTTbl)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTTbl parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTbl)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTTbl parse(InputStream inputStream) throws XmlException, IOException {
            return (CTTbl)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTTbl parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTbl)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTTbl parse(Reader reader) throws XmlException, IOException {
            return (CTTbl)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTTbl parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTbl)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTTbl parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTTbl)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTTbl parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTTbl)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTTbl parse(Node node) throws XmlException {
            return (CTTbl)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTTbl parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTTbl)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTTbl parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTTbl)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static CTTbl parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTTbl)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
