    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTRel.class.getClassLoader());
        ...
        public static CTRel newInstance() {
            return (CTRel)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTRel newInstance(XmlOptions xmlOptions) {
            return (CTRel)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTRel parse(String string) throws XmlException {
            return (CTRel)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTRel parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTRel)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTRel parse(File file) throws XmlException, IOException {
            return (CTRel)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTRel parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTRel)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTRel parse(URL uRL) throws XmlException, IOException {
            return (CTRel)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTRel parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTRel)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTRel parse(InputStream inputStream) throws XmlException, IOException {
            return (CTRel)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTRel parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTRel)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTRel parse(Reader reader) throws XmlException, IOException {
            return (CTRel)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTRel parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTRel)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTRel parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTRel)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTRel parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTRel)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTRel parse(Node node) throws XmlException {
            return (CTRel)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTRel parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTRel)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTRel parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTRel)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static CTRel parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTRel)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
