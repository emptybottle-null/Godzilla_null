    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTProofErr.class.getClassLoader());
        ...
        public static CTProofErr newInstance() {
            return (CTProofErr)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTProofErr newInstance(XmlOptions xmlOptions) {
            return (CTProofErr)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTProofErr parse(String string) throws XmlException {
            return (CTProofErr)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTProofErr parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTProofErr)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTProofErr parse(File file) throws XmlException, IOException {
            return (CTProofErr)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTProofErr parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTProofErr)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTProofErr parse(URL uRL) throws XmlException, IOException {
            return (CTProofErr)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTProofErr parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTProofErr)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTProofErr parse(InputStream inputStream) throws XmlException, IOException {
            return (CTProofErr)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTProofErr parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTProofErr)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTProofErr parse(Reader reader) throws XmlException, IOException {
            return (CTProofErr)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTProofErr parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTProofErr)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTProofErr parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTProofErr)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTProofErr parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTProofErr)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTProofErr parse(Node node) throws XmlException {
            return (CTProofErr)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTProofErr parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTProofErr)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTProofErr parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTProofErr)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTProofErr parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTProofErr)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
