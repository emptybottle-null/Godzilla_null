    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTOnOff.class.getClassLoader());
        ...
        public static CTOnOff newInstance() {
            return (CTOnOff)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTOnOff newInstance(XmlOptions xmlOptions) {
            return (CTOnOff)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTOnOff parse(String string) throws XmlException {
            return (CTOnOff)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTOnOff parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTOnOff)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTOnOff parse(File file) throws XmlException, IOException {
            return (CTOnOff)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTOnOff parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTOnOff)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTOnOff parse(URL uRL) throws XmlException, IOException {
            return (CTOnOff)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTOnOff parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTOnOff)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTOnOff parse(InputStream inputStream) throws XmlException, IOException {
            return (CTOnOff)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTOnOff parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTOnOff)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTOnOff parse(Reader reader) throws XmlException, IOException {
            return (CTOnOff)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTOnOff parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTOnOff)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTOnOff parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTOnOff)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTOnOff parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTOnOff)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTOnOff parse(Node node) throws XmlException {
            return (CTOnOff)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTOnOff parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTOnOff)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTOnOff parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTOnOff)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static CTOnOff parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTOnOff)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
