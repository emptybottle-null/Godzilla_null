    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTJc.class.getClassLoader());
        ...
        public static CTJc newInstance() {
            return (CTJc)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTJc newInstance(XmlOptions xmlOptions) {
            return (CTJc)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTJc parse(String string) throws XmlException {
            return (CTJc)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTJc parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTJc)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTJc parse(File file) throws XmlException, IOException {
            return (CTJc)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTJc parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTJc)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTJc parse(URL uRL) throws XmlException, IOException {
            return (CTJc)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTJc parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTJc)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTJc parse(InputStream inputStream) throws XmlException, IOException {
            return (CTJc)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTJc parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTJc)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTJc parse(Reader reader) throws XmlException, IOException {
            return (CTJc)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTJc parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTJc)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTJc parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTJc)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTJc parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTJc)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTJc parse(Node node) throws XmlException {
            return (CTJc)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTJc parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTJc)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTJc parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTJc)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static CTJc parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTJc)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
