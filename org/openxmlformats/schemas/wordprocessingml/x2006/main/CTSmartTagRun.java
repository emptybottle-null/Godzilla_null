...
extends XmlObject {
    public static final SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CTSmartTagRun.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sD023D6490046BA0250A839A9AD24C443").resolveHandle("ctsmarttagrune098type");
    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTSmartTagRun.class.getClassLoader());
        ...
        public static CTSmartTagRun newInstance() {
            return (CTSmartTagRun)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTSmartTagRun newInstance(XmlOptions xmlOptions) {
            return (CTSmartTagRun)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTSmartTagRun parse(String string) throws XmlException {
            return (CTSmartTagRun)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTSmartTagRun parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTSmartTagRun)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTSmartTagRun parse(File file) throws XmlException, IOException {
            return (CTSmartTagRun)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTSmartTagRun parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSmartTagRun)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTSmartTagRun parse(URL uRL) throws XmlException, IOException {
            return (CTSmartTagRun)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTSmartTagRun parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSmartTagRun)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTSmartTagRun parse(InputStream inputStream) throws XmlException, IOException {
            return (CTSmartTagRun)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTSmartTagRun parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSmartTagRun)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTSmartTagRun parse(Reader reader) throws XmlException, IOException {
            return (CTSmartTagRun)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTSmartTagRun parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSmartTagRun)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTSmartTagRun parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTSmartTagRun)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTSmartTagRun parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTSmartTagRun)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTSmartTagRun parse(Node node) throws XmlException {
            return (CTSmartTagRun)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTSmartTagRun parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTSmartTagRun)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTSmartTagRun parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTSmartTagRun)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTSmartTagRun parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTSmartTagRun)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
