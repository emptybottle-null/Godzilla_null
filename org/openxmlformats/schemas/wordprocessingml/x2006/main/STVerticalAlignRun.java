...
extends XmlString {
    public static final SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(STVerticalAlignRun.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sD023D6490046BA0250A839A9AD24C443").resolveHandle("stverticalalignrun297ctype");
    ...
    public static final class Factory {
        ...
        public static STVerticalAlignRun newValue(Object object) {
            return (STVerticalAlignRun)type.newValue(object);
        }
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(STVerticalAlignRun.class.getClassLoader());
        ...
        public static STVerticalAlignRun newInstance() {
            return (STVerticalAlignRun)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STVerticalAlignRun newInstance(XmlOptions xmlOptions) {
            return (STVerticalAlignRun)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STVerticalAlignRun parse(String string) throws XmlException {
            return (STVerticalAlignRun)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STVerticalAlignRun parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STVerticalAlignRun)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STVerticalAlignRun parse(File file) throws XmlException, IOException {
            return (STVerticalAlignRun)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STVerticalAlignRun parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STVerticalAlignRun)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STVerticalAlignRun parse(URL uRL) throws XmlException, IOException {
            return (STVerticalAlignRun)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STVerticalAlignRun parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STVerticalAlignRun)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STVerticalAlignRun parse(InputStream inputStream) throws XmlException, IOException {
            return (STVerticalAlignRun)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static STVerticalAlignRun parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STVerticalAlignRun)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static STVerticalAlignRun parse(Reader reader) throws XmlException, IOException {
            return (STVerticalAlignRun)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static STVerticalAlignRun parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STVerticalAlignRun)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static STVerticalAlignRun parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STVerticalAlignRun)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static STVerticalAlignRun parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STVerticalAlignRun)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static STVerticalAlignRun parse(Node node) throws XmlException {
            return (STVerticalAlignRun)Factory.getTypeLoader().parse(node, type, null);
        }

        public static STVerticalAlignRun parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STVerticalAlignRun)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static STVerticalAlignRun parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (STVerticalAlignRun)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static STVerticalAlignRun parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STVerticalAlignRun)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
