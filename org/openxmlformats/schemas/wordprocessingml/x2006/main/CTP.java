...
extends XmlObject {
    public static final SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CTP.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sD023D6490046BA0250A839A9AD24C443").resolveHandle("ctpa1e2type");
    ...
    public static final class Factory {
        ...
        public static CTP newInstance() {
            return (CTP)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTP newInstance(XmlOptions xmlOptions) {
            return (CTP)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTP parse(String string) throws XmlException {
            return (CTP)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTP parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTP)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTP parse(File file) throws XmlException, IOException {
            return (CTP)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTP parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTP)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTP parse(URL uRL) throws XmlException, IOException {
            return (CTP)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTP parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTP)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTP parse(InputStream inputStream) throws XmlException, IOException {
            return (CTP)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTP parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTP)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTP parse(Reader reader) throws XmlException, IOException {
            return (CTP)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTP parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTP)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTP parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTP)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTP parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTP)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTP parse(Node node) throws XmlException {
            return (CTP)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTP parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTP)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTP parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTP)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static CTP parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTP)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
