...
extends STUnsignedDecimalNumber {
    ...
    public static final class Factory {
        ...
        public static STPointMeasure newValue(Object object) {
            return (STPointMeasure)type.newValue(object);
        }
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(STPointMeasure.class.getClassLoader());
        ...
        public static STPointMeasure newInstance() {
            return (STPointMeasure)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STPointMeasure newInstance(XmlOptions xmlOptions) {
            return (STPointMeasure)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STPointMeasure parse(String string) throws XmlException {
            return (STPointMeasure)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STPointMeasure parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STPointMeasure)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STPointMeasure parse(File file) throws XmlException, IOException {
            return (STPointMeasure)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STPointMeasure parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPointMeasure)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STPointMeasure parse(URL uRL) throws XmlException, IOException {
            return (STPointMeasure)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STPointMeasure parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPointMeasure)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STPointMeasure parse(InputStream inputStream) throws XmlException, IOException {
            return (STPointMeasure)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static STPointMeasure parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPointMeasure)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static STPointMeasure parse(Reader reader) throws XmlException, IOException {
            return (STPointMeasure)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static STPointMeasure parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPointMeasure)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static STPointMeasure parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STPointMeasure)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static STPointMeasure parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STPointMeasure)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static STPointMeasure parse(Node node) throws XmlException {
            return (STPointMeasure)Factory.getTypeLoader().parse(node, type, null);
        }

        public static STPointMeasure parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STPointMeasure)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static STPointMeasure parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (STPointMeasure)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static STPointMeasure parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STPointMeasure)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
