...
extends XmlObject {
    public static final SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CTTc.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sD023D6490046BA0250A839A9AD24C443").resolveHandle("cttc4019type");
    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTTc.class.getClassLoader());
        ...
        public static CTTc newInstance() {
            return (CTTc)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTTc newInstance(XmlOptions xmlOptions) {
            return (CTTc)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTTc parse(String string) throws XmlException {
            return (CTTc)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTTc parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTTc)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTTc parse(File file) throws XmlException, IOException {
            return (CTTc)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTTc parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTc)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTTc parse(URL uRL) throws XmlException, IOException {
            return (CTTc)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTTc parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTc)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTTc parse(InputStream inputStream) throws XmlException, IOException {
            return (CTTc)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTTc parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTc)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTTc parse(Reader reader) throws XmlException, IOException {
            return (CTTc)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTTc parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTc)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTTc parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTTc)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTTc parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTTc)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTTc parse(Node node) throws XmlException {
            return (CTTc)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTTc parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTTc)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTTc parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTTc)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static CTTc parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTTc)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
