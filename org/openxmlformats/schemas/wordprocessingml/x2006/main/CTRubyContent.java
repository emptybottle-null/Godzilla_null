    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTRubyContent.class.getClassLoader());
        ...
        public static CTRubyContent newInstance() {
            return (CTRubyContent)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTRubyContent newInstance(XmlOptions xmlOptions) {
            return (CTRubyContent)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTRubyContent parse(String string) throws XmlException {
            return (CTRubyContent)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTRubyContent parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTRubyContent)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTRubyContent parse(File file) throws XmlException, IOException {
            return (CTRubyContent)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTRubyContent parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTRubyContent)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTRubyContent parse(URL uRL) throws XmlException, IOException {
            return (CTRubyContent)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTRubyContent parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTRubyContent)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTRubyContent parse(InputStream inputStream) throws XmlException, IOException {
            return (CTRubyContent)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTRubyContent parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTRubyContent)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTRubyContent parse(Reader reader) throws XmlException, IOException {
            return (CTRubyContent)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTRubyContent parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTRubyContent)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTRubyContent parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTRubyContent)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTRubyContent parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTRubyContent)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTRubyContent parse(Node node) throws XmlException {
            return (CTRubyContent)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTRubyContent parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTRubyContent)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTRubyContent parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTRubyContent)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static CTRubyContent parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTRubyContent)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
