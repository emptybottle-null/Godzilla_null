...
extends STUnsignedDecimalNumber {
    ...
    public static final class Factory {
        ...
        public static STTwipsMeasure newValue(Object object) {
            return (STTwipsMeasure)type.newValue(object);
        }
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(STTwipsMeasure.class.getClassLoader());
        ...
        public static STTwipsMeasure newInstance() {
            return (STTwipsMeasure)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STTwipsMeasure newInstance(XmlOptions xmlOptions) {
            return (STTwipsMeasure)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STTwipsMeasure parse(String string) throws XmlException {
            return (STTwipsMeasure)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STTwipsMeasure parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STTwipsMeasure)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STTwipsMeasure parse(File file) throws XmlException, IOException {
            return (STTwipsMeasure)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STTwipsMeasure parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTwipsMeasure)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STTwipsMeasure parse(URL uRL) throws XmlException, IOException {
            return (STTwipsMeasure)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STTwipsMeasure parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTwipsMeasure)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STTwipsMeasure parse(InputStream inputStream) throws XmlException, IOException {
            return (STTwipsMeasure)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static STTwipsMeasure parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTwipsMeasure)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static STTwipsMeasure parse(Reader reader) throws XmlException, IOException {
            return (STTwipsMeasure)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static STTwipsMeasure parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTwipsMeasure)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static STTwipsMeasure parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STTwipsMeasure)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static STTwipsMeasure parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STTwipsMeasure)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static STTwipsMeasure parse(Node node) throws XmlException {
            return (STTwipsMeasure)Factory.getTypeLoader().parse(node, type, null);
        }

        public static STTwipsMeasure parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STTwipsMeasure)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static STTwipsMeasure parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (STTwipsMeasure)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static STTwipsMeasure parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STTwipsMeasure)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
