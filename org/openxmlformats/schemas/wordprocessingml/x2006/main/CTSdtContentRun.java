    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTSdtContentRun.class.getClassLoader());
        ...
        public static CTSdtContentRun newInstance() {
            return (CTSdtContentRun)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTSdtContentRun newInstance(XmlOptions xmlOptions) {
            return (CTSdtContentRun)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTSdtContentRun parse(String string) throws XmlException {
            return (CTSdtContentRun)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTSdtContentRun parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTSdtContentRun)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTSdtContentRun parse(File file) throws XmlException, IOException {
            return (CTSdtContentRun)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTSdtContentRun parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentRun)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTSdtContentRun parse(URL uRL) throws XmlException, IOException {
            return (CTSdtContentRun)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTSdtContentRun parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentRun)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTSdtContentRun parse(InputStream inputStream) throws XmlException, IOException {
            return (CTSdtContentRun)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTSdtContentRun parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentRun)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTSdtContentRun parse(Reader reader) throws XmlException, IOException {
            return (CTSdtContentRun)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTSdtContentRun parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentRun)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTSdtContentRun parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTSdtContentRun)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTSdtContentRun parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTSdtContentRun)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTSdtContentRun parse(Node node) throws XmlException {
            return (CTSdtContentRun)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTSdtContentRun parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTSdtContentRun)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTSdtContentRun parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTSdtContentRun)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTSdtContentRun parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTSdtContentRun)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
