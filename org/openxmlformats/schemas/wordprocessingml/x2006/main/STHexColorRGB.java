...
extends XmlHexBinary {
    ...
    public static final class Factory {
        ...
        public static STHexColorRGB newValue(Object object) {
            return (STHexColorRGB)type.newValue(object);
        }
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(STHexColorRGB.class.getClassLoader());
        ...
        public static STHexColorRGB newInstance() {
            return (STHexColorRGB)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STHexColorRGB newInstance(XmlOptions xmlOptions) {
            return (STHexColorRGB)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STHexColorRGB parse(String string) throws XmlException {
            return (STHexColorRGB)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STHexColorRGB parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STHexColorRGB)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STHexColorRGB parse(File file) throws XmlException, IOException {
            return (STHexColorRGB)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STHexColorRGB parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STHexColorRGB)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STHexColorRGB parse(URL uRL) throws XmlException, IOException {
            return (STHexColorRGB)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STHexColorRGB parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STHexColorRGB)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STHexColorRGB parse(InputStream inputStream) throws XmlException, IOException {
            return (STHexColorRGB)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static STHexColorRGB parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STHexColorRGB)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static STHexColorRGB parse(Reader reader) throws XmlException, IOException {
            return (STHexColorRGB)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static STHexColorRGB parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STHexColorRGB)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static STHexColorRGB parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STHexColorRGB)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static STHexColorRGB parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STHexColorRGB)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static STHexColorRGB parse(Node node) throws XmlException {
            return (STHexColorRGB)Factory.getTypeLoader().parse(node, type, null);
        }

        public static STHexColorRGB parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STHexColorRGB)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static STHexColorRGB parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (STHexColorRGB)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static STHexColorRGB parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STHexColorRGB)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
