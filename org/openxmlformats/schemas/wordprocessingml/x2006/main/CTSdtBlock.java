    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTSdtBlock.class.getClassLoader());
        ...
        public static CTSdtBlock newInstance() {
            return (CTSdtBlock)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTSdtBlock newInstance(XmlOptions xmlOptions) {
            return (CTSdtBlock)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTSdtBlock parse(String string) throws XmlException {
            return (CTSdtBlock)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTSdtBlock parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTSdtBlock)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTSdtBlock parse(File file) throws XmlException, IOException {
            return (CTSdtBlock)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTSdtBlock parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtBlock)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTSdtBlock parse(URL uRL) throws XmlException, IOException {
            return (CTSdtBlock)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTSdtBlock parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtBlock)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTSdtBlock parse(InputStream inputStream) throws XmlException, IOException {
            return (CTSdtBlock)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTSdtBlock parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtBlock)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTSdtBlock parse(Reader reader) throws XmlException, IOException {
            return (CTSdtBlock)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTSdtBlock parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtBlock)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTSdtBlock parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTSdtBlock)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTSdtBlock parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTSdtBlock)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTSdtBlock parse(Node node) throws XmlException {
            return (CTSdtBlock)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTSdtBlock parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTSdtBlock)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTSdtBlock parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTSdtBlock)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTSdtBlock parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTSdtBlock)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
