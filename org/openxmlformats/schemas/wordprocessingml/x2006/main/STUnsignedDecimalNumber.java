...
extends XmlUnsignedLong {
    ...
    public static final class Factory {
        ...
        public static STUnsignedDecimalNumber newValue(Object object) {
            return (STUnsignedDecimalNumber)type.newValue(object);
        }
        ...
        public static STUnsignedDecimalNumber newInstance() {
            return (STUnsignedDecimalNumber)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STUnsignedDecimalNumber newInstance(XmlOptions xmlOptions) {
            return (STUnsignedDecimalNumber)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STUnsignedDecimalNumber parse(String string) throws XmlException {
            return (STUnsignedDecimalNumber)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STUnsignedDecimalNumber parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STUnsignedDecimalNumber)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STUnsignedDecimalNumber parse(File file) throws XmlException, IOException {
            return (STUnsignedDecimalNumber)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STUnsignedDecimalNumber parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STUnsignedDecimalNumber)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STUnsignedDecimalNumber parse(URL uRL) throws XmlException, IOException {
            return (STUnsignedDecimalNumber)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STUnsignedDecimalNumber parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STUnsignedDecimalNumber)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STUnsignedDecimalNumber parse(InputStream inputStream) throws XmlException, IOException {
            return (STUnsignedDecimalNumber)Factory.getTypeLoader().parse(inputStream, type, null);
        }
        ...
        public static STUnsignedDecimalNumber parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STUnsignedDecimalNumber)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
