    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTString.class.getClassLoader());
        ...
        public static CTString newInstance() {
            return (CTString)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTString newInstance(XmlOptions xmlOptions) {
            return (CTString)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTString parse(String string) throws XmlException {
            return (CTString)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTString parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTString)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTString parse(File file) throws XmlException, IOException {
            return (CTString)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTString parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTString)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTString parse(URL uRL) throws XmlException, IOException {
            return (CTString)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTString parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTString)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTString parse(InputStream inputStream) throws XmlException, IOException {
            return (CTString)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTString parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTString)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTString parse(Reader reader) throws XmlException, IOException {
            return (CTString)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTString parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTString)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTString parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTString)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTString parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTString)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTString parse(Node node) throws XmlException {
            return (CTString)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTString parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTString)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTString parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTString)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static CTString parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTString)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
