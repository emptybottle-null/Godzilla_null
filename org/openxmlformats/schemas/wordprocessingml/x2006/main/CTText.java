    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTText.class.getClassLoader());
        ...
        public static CTText newInstance() {
            return (CTText)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTText newInstance(XmlOptions xmlOptions) {
            return (CTText)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTText parse(String string) throws XmlException {
            return (CTText)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTText parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTText)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTText parse(File file) throws XmlException, IOException {
            return (CTText)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTText parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTText)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTText parse(URL uRL) throws XmlException, IOException {
            return (CTText)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTText parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTText)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTText parse(InputStream inputStream) throws XmlException, IOException {
            return (CTText)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTText parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTText)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTText parse(Reader reader) throws XmlException, IOException {
            return (CTText)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTText parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTText)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTText parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTText)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTText parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTText)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTText parse(Node node) throws XmlException {
            return (CTText)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTText parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTText)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTText parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTText)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static CTText parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTText)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
