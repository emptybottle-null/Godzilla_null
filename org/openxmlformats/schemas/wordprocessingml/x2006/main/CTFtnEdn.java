...
extends XmlObject {
    public static final SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CTFtnEdn.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sD023D6490046BA0250A839A9AD24C443").resolveHandle("ctftnedncad9type");
    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTFtnEdn.class.getClassLoader());
        ...
        public static CTFtnEdn newInstance() {
            return (CTFtnEdn)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTFtnEdn newInstance(XmlOptions xmlOptions) {
            return (CTFtnEdn)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTFtnEdn parse(String string) throws XmlException {
            return (CTFtnEdn)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTFtnEdn parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTFtnEdn)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTFtnEdn parse(File file) throws XmlException, IOException {
            return (CTFtnEdn)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTFtnEdn parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTFtnEdn)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTFtnEdn parse(URL uRL) throws XmlException, IOException {
            return (CTFtnEdn)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTFtnEdn parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTFtnEdn)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTFtnEdn parse(InputStream inputStream) throws XmlException, IOException {
            return (CTFtnEdn)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTFtnEdn parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTFtnEdn)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTFtnEdn parse(Reader reader) throws XmlException, IOException {
            return (CTFtnEdn)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTFtnEdn parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTFtnEdn)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTFtnEdn parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTFtnEdn)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTFtnEdn parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTFtnEdn)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTFtnEdn parse(Node node) throws XmlException {
            return (CTFtnEdn)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTFtnEdn parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTFtnEdn)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTFtnEdn parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTFtnEdn)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static CTFtnEdn parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTFtnEdn)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
