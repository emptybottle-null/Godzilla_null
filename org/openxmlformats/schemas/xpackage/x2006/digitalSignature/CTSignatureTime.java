    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTSignatureTime.class.getClassLoader());
        ...
        public static CTSignatureTime newInstance() {
            return (CTSignatureTime)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTSignatureTime newInstance(XmlOptions xmlOptions) {
            return (CTSignatureTime)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTSignatureTime parse(String string) throws XmlException {
            return (CTSignatureTime)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTSignatureTime parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTSignatureTime)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTSignatureTime parse(File file) throws XmlException, IOException {
            return (CTSignatureTime)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTSignatureTime parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSignatureTime)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTSignatureTime parse(URL uRL) throws XmlException, IOException {
            return (CTSignatureTime)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTSignatureTime parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSignatureTime)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTSignatureTime parse(InputStream inputStream) throws XmlException, IOException {
            return (CTSignatureTime)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTSignatureTime parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSignatureTime)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTSignatureTime parse(Reader reader) throws XmlException, IOException {
            return (CTSignatureTime)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTSignatureTime parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSignatureTime)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTSignatureTime parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTSignatureTime)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTSignatureTime parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTSignatureTime)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTSignatureTime parse(Node node) throws XmlException {
            return (CTSignatureTime)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTSignatureTime parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTSignatureTime)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTSignatureTime parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTSignatureTime)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTSignatureTime parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTSignatureTime)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
