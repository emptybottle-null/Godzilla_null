    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTDigSigBlob.class.getClassLoader());
        ...
        public static CTDigSigBlob newInstance() {
            return (CTDigSigBlob)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTDigSigBlob newInstance(XmlOptions xmlOptions) {
            return (CTDigSigBlob)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTDigSigBlob parse(String string) throws XmlException {
            return (CTDigSigBlob)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTDigSigBlob parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTDigSigBlob)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTDigSigBlob parse(File file) throws XmlException, IOException {
            return (CTDigSigBlob)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTDigSigBlob parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTDigSigBlob)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTDigSigBlob parse(URL uRL) throws XmlException, IOException {
            return (CTDigSigBlob)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTDigSigBlob parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTDigSigBlob)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTDigSigBlob parse(InputStream inputStream) throws XmlException, IOException {
            return (CTDigSigBlob)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTDigSigBlob parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTDigSigBlob)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTDigSigBlob parse(Reader reader) throws XmlException, IOException {
            return (CTDigSigBlob)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTDigSigBlob parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTDigSigBlob)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTDigSigBlob parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTDigSigBlob)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTDigSigBlob parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTDigSigBlob)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTDigSigBlob parse(Node node) throws XmlException {
            return (CTDigSigBlob)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTDigSigBlob parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTDigSigBlob)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTDigSigBlob parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTDigSigBlob)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTDigSigBlob parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTDigSigBlob)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
