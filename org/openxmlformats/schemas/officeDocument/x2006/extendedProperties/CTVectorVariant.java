    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTVectorVariant.class.getClassLoader());
        ...
        public static CTVectorVariant newInstance() {
            return (CTVectorVariant)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTVectorVariant newInstance(XmlOptions xmlOptions) {
            return (CTVectorVariant)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTVectorVariant parse(String string) throws XmlException {
            return (CTVectorVariant)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTVectorVariant parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTVectorVariant)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTVectorVariant parse(File file) throws XmlException, IOException {
            return (CTVectorVariant)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTVectorVariant parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTVectorVariant)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTVectorVariant parse(URL uRL) throws XmlException, IOException {
            return (CTVectorVariant)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTVectorVariant parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTVectorVariant)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTVectorVariant parse(InputStream inputStream) throws XmlException, IOException {
            return (CTVectorVariant)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTVectorVariant parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTVectorVariant)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTVectorVariant parse(Reader reader) throws XmlException, IOException {
            return (CTVectorVariant)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTVectorVariant parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTVectorVariant)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTVectorVariant parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTVectorVariant)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTVectorVariant parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTVectorVariant)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTVectorVariant parse(Node node) throws XmlException {
            return (CTVectorVariant)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTVectorVariant parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTVectorVariant)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTVectorVariant parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTVectorVariant)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTVectorVariant parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTVectorVariant)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
