...
extends XmlString {
    ...
    public static final class Factory {
        ...
        public static STRelationshipId newValue(Object object) {
            return (STRelationshipId)type.newValue(object);
        }
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(STRelationshipId.class.getClassLoader());
        ...
        public static STRelationshipId newInstance() {
            return (STRelationshipId)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STRelationshipId newInstance(XmlOptions xmlOptions) {
            return (STRelationshipId)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STRelationshipId parse(String string) throws XmlException {
            return (STRelationshipId)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STRelationshipId parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STRelationshipId)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STRelationshipId parse(File file) throws XmlException, IOException {
            return (STRelationshipId)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STRelationshipId parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STRelationshipId)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STRelationshipId parse(URL uRL) throws XmlException, IOException {
            return (STRelationshipId)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STRelationshipId parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STRelationshipId)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STRelationshipId parse(InputStream inputStream) throws XmlException, IOException {
            return (STRelationshipId)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static STRelationshipId parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STRelationshipId)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static STRelationshipId parse(Reader reader) throws XmlException, IOException {
            return (STRelationshipId)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static STRelationshipId parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STRelationshipId)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static STRelationshipId parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STRelationshipId)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static STRelationshipId parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STRelationshipId)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static STRelationshipId parse(Node node) throws XmlException {
            return (STRelationshipId)Factory.getTypeLoader().parse(node, type, null);
        }

        public static STRelationshipId parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STRelationshipId)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static STRelationshipId parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (STRelationshipId)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static STRelationshipId parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STRelationshipId)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
