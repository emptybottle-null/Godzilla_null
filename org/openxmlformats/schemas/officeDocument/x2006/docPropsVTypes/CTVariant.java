    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTVariant.class.getClassLoader());
        ...
        public static CTVariant newInstance() {
            return (CTVariant)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTVariant newInstance(XmlOptions xmlOptions) {
            return (CTVariant)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTVariant parse(String string) throws XmlException {
            return (CTVariant)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTVariant parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTVariant)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTVariant parse(File file) throws XmlException, IOException {
            return (CTVariant)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTVariant parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTVariant)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTVariant parse(URL uRL) throws XmlException, IOException {
            return (CTVariant)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTVariant parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTVariant)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTVariant parse(InputStream inputStream) throws XmlException, IOException {
            return (CTVariant)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTVariant parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTVariant)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTVariant parse(Reader reader) throws XmlException, IOException {
            return (CTVariant)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTVariant parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTVariant)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTVariant parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTVariant)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTVariant parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTVariant)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTVariant parse(Node node) throws XmlException {
            return (CTVariant)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTVariant parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTVariant)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTVariant parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTVariant)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static CTVariant parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTVariant)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
