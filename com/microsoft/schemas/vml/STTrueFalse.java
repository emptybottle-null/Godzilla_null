...
extends XmlString {
    ...
    public static final class Factory {
        ...
        public static STTrueFalse newValue(Object object) {
            return (STTrueFalse)type.newValue(object);
        }
        ...
        public static STTrueFalse newInstance() {
            return (STTrueFalse)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STTrueFalse newInstance(XmlOptions xmlOptions) {
            return (STTrueFalse)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STTrueFalse parse(String string) throws XmlException {
            return (STTrueFalse)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STTrueFalse parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STTrueFalse)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STTrueFalse parse(File file) throws XmlException, IOException {
            return (STTrueFalse)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STTrueFalse parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTrueFalse)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STTrueFalse parse(URL uRL) throws XmlException, IOException {
            return (STTrueFalse)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STTrueFalse parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTrueFalse)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STTrueFalse parse(InputStream inputStream) throws XmlException, IOException {
            return (STTrueFalse)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static STTrueFalse parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTrueFalse)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static STTrueFalse parse(Reader reader) throws XmlException, IOException {
            return (STTrueFalse)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static STTrueFalse parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STTrueFalse)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static STTrueFalse parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STTrueFalse)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static STTrueFalse parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STTrueFalse)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static STTrueFalse parse(Node node) throws XmlException {
            return (STTrueFalse)Factory.getTypeLoader().parse(node, type, null);
        }

        public static STTrueFalse parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STTrueFalse)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static STTrueFalse parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (STTrueFalse)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static STTrueFalse parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STTrueFalse)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
