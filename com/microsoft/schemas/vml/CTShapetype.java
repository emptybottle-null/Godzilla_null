    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(CTShapetype.class.getClassLoader());
        ...
        public static CTShapetype newInstance() {
            return (CTShapetype)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTShapetype newInstance(XmlOptions xmlOptions) {
            return (CTShapetype)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTShapetype parse(String string) throws XmlException {
            return (CTShapetype)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTShapetype parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTShapetype)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTShapetype parse(File file) throws XmlException, IOException {
            return (CTShapetype)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTShapetype parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTShapetype)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTShapetype parse(URL uRL) throws XmlException, IOException {
            return (CTShapetype)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTShapetype parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTShapetype)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTShapetype parse(InputStream inputStream) throws XmlException, IOException {
            return (CTShapetype)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTShapetype parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTShapetype)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTShapetype parse(Reader reader) throws XmlException, IOException {
            return (CTShapetype)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTShapetype parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTShapetype)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTShapetype parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTShapetype)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTShapetype parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTShapetype)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTShapetype parse(Node node) throws XmlException {
            return (CTShapetype)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTShapetype parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTShapetype)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTShapetype parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTShapetype)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static CTShapetype parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTShapetype)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
