...
extends XmlObject {
    ...
    public static final class Factory {
        ...
        public static CTRect newInstance() {
            return (CTRect)Factory.getTypeLoader().newInstance(type, null);
        }

        public static CTRect newInstance(XmlOptions xmlOptions) {
            return (CTRect)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static CTRect parse(String string) throws XmlException {
            return (CTRect)Factory.getTypeLoader().parse(string, type, null);
        }

        public static CTRect parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (CTRect)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static CTRect parse(File file) throws XmlException, IOException {
            return (CTRect)Factory.getTypeLoader().parse(file, type, null);
        }

        public static CTRect parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTRect)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static CTRect parse(URL uRL) throws XmlException, IOException {
            return (CTRect)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static CTRect parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTRect)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static CTRect parse(InputStream inputStream) throws XmlException, IOException {
            return (CTRect)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static CTRect parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTRect)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static CTRect parse(Reader reader) throws XmlException, IOException {
            return (CTRect)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static CTRect parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTRect)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static CTRect parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (CTRect)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static CTRect parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (CTRect)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static CTRect parse(Node node) throws XmlException {
            return (CTRect)Factory.getTypeLoader().parse(node, type, null);
        }

        public static CTRect parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (CTRect)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static CTRect parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (CTRect)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static CTRect parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTRect)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
