...
extends XmlString {
    ...
    public static final class Factory {
        ...
        public static STExt newValue(Object object) {
            return (STExt)type.newValue(object);
        }
        ...
        public static STExt newInstance() {
            return (STExt)Factory.getTypeLoader().newInstance(type, null);
        }

        public static STExt newInstance(XmlOptions xmlOptions) {
            return (STExt)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static STExt parse(String string) throws XmlException {
            return (STExt)Factory.getTypeLoader().parse(string, type, null);
        }

        public static STExt parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (STExt)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static STExt parse(File file) throws XmlException, IOException {
            return (STExt)Factory.getTypeLoader().parse(file, type, null);
        }

        public static STExt parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STExt)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static STExt parse(URL uRL) throws XmlException, IOException {
            return (STExt)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static STExt parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STExt)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static STExt parse(InputStream inputStream) throws XmlException, IOException {
            return (STExt)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static STExt parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STExt)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static STExt parse(Reader reader) throws XmlException, IOException {
            return (STExt)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static STExt parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (STExt)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static STExt parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (STExt)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static STExt parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (STExt)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static STExt parse(Node node) throws XmlException {
            return (STExt)Factory.getTypeLoader().parse(node, type, null);
        }

        public static STExt parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (STExt)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static STExt parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (STExt)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }

        @Deprecated
        public static STExt parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STExt)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
