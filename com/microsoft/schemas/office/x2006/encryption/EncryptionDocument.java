...
public interface EncryptionDocument
extends XmlObject {
    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoader == null) {
                schemaTypeLoader = XmlBeans.typeLoaderForClassLoader(EncryptionDocument.class.getClassLoader());
        ...
        public static EncryptionDocument newInstance() {
            return (EncryptionDocument)Factory.getTypeLoader().newInstance(type, null);
        }

        public static EncryptionDocument newInstance(XmlOptions xmlOptions) {
            return (EncryptionDocument)Factory.getTypeLoader().newInstance(type, xmlOptions);
        }

        public static EncryptionDocument parse(String string) throws XmlException {
            return (EncryptionDocument)Factory.getTypeLoader().parse(string, type, null);
        }

        public static EncryptionDocument parse(String string, XmlOptions xmlOptions) throws XmlException {
            return (EncryptionDocument)Factory.getTypeLoader().parse(string, type, xmlOptions);
        }

        public static EncryptionDocument parse(File file) throws XmlException, IOException {
            return (EncryptionDocument)Factory.getTypeLoader().parse(file, type, null);
        }

        public static EncryptionDocument parse(File file, XmlOptions xmlOptions) throws XmlException, IOException {
            return (EncryptionDocument)Factory.getTypeLoader().parse(file, type, xmlOptions);
        }

        public static EncryptionDocument parse(URL uRL) throws XmlException, IOException {
            return (EncryptionDocument)Factory.getTypeLoader().parse(uRL, type, null);
        }

        public static EncryptionDocument parse(URL uRL, XmlOptions xmlOptions) throws XmlException, IOException {
            return (EncryptionDocument)Factory.getTypeLoader().parse(uRL, type, xmlOptions);
        }

        public static EncryptionDocument parse(InputStream inputStream) throws XmlException, IOException {
            return (EncryptionDocument)Factory.getTypeLoader().parse(inputStream, type, null);
        }

        public static EncryptionDocument parse(InputStream inputStream, XmlOptions xmlOptions) throws XmlException, IOException {
            return (EncryptionDocument)Factory.getTypeLoader().parse(inputStream, type, xmlOptions);
        }

        public static EncryptionDocument parse(Reader reader) throws XmlException, IOException {
            return (EncryptionDocument)Factory.getTypeLoader().parse(reader, type, null);
        }

        public static EncryptionDocument parse(Reader reader, XmlOptions xmlOptions) throws XmlException, IOException {
            return (EncryptionDocument)Factory.getTypeLoader().parse(reader, type, xmlOptions);
        }

        public static EncryptionDocument parse(XMLStreamReader xMLStreamReader) throws XmlException {
            return (EncryptionDocument)Factory.getTypeLoader().parse(xMLStreamReader, type, null);
        }

        public static EncryptionDocument parse(XMLStreamReader xMLStreamReader, XmlOptions xmlOptions) throws XmlException {
            return (EncryptionDocument)Factory.getTypeLoader().parse(xMLStreamReader, type, xmlOptions);
        }

        public static EncryptionDocument parse(Node node) throws XmlException {
            return (EncryptionDocument)Factory.getTypeLoader().parse(node, type, null);
        }

        public static EncryptionDocument parse(Node node, XmlOptions xmlOptions) throws XmlException {
            return (EncryptionDocument)Factory.getTypeLoader().parse(node, type, xmlOptions);
        }

        @Deprecated
        public static EncryptionDocument parse(XMLInputStream xMLInputStream) throws XmlException, XMLStreamException {
            return (EncryptionDocument)Factory.getTypeLoader().parse(xMLInputStream, type, null);
        }
        ...
        public static EncryptionDocument parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (EncryptionDocument)Factory.getTypeLoader().parse(xMLInputStream, type, xmlOptions);
        }
