...
public class CTPasswordKeyEncryptorImpl
extends XmlComplexContentImpl
implements CTPasswordKeyEncryptor {
    ...
    public int getSpinCount() {
        ...
        synchronized (object) {
            this.check_orphaned();
            SimpleValue simpleValue = null;
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(SPINCOUNT$16));
            if (simpleValue == null) {
                return 0;
            }
            return simpleValue.getIntValue();
    ...
    public STSpinCount xgetSpinCount() {
        ...
        synchronized (object) {
            ...
            sTSpinCount = (STSpinCount)((Object)this.get_store().find_attribute_user(SPINCOUNT$16));
            return sTSpinCount;
        }
    }
     ...
     */
    @Override
    public void setSpinCount(int n) {
        Object object = this.monitor();
        synchronized (object) {
            this.check_orphaned();
            SimpleValue simpleValue = null;
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(SPINCOUNT$16));
            if (simpleValue == null) {
                simpleValue = (SimpleValue)((Object)this.get_store().add_attribute_user(SPINCOUNT$16));
            }
            simpleValue.setIntValue(n);
        }
    }
    ...
    public void xsetSpinCount(STSpinCount sTSpinCount) {
        ...
        synchronized (object) {
            this.check_orphaned();
            STSpinCount sTSpinCount2 = null;
            sTSpinCount2 = (STSpinCount)((Object)this.get_store().find_attribute_user(SPINCOUNT$16));
            if (sTSpinCount2 == null) {
                sTSpinCount2 = (STSpinCount)((Object)this.get_store().add_attribute_user(SPINCOUNT$16));
            }
    ...
    public byte[] getEncryptedVerifierHashInput() {
        ...
        synchronized (object) {
            this.check_orphaned();
            SimpleValue simpleValue = null;
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(ENCRYPTEDVERIFIERHASHINPUT$18));
            if (simpleValue == null) {
                return null;
            }
            return simpleValue.getByteArrayValue();
    ...
    public XmlBase64Binary xgetEncryptedVerifierHashInput() {
        ...
        synchronized (object) {
            this.check_orphaned();
            XmlBase64Binary xmlBase64Binary = null;
            xmlBase64Binary = (XmlBase64Binary)((Object)this.get_store().find_attribute_user(ENCRYPTEDVERIFIERHASHINPUT$18));
            return xmlBase64Binary;
        }
    }
     ...
     */
    @Override
    public void setEncryptedVerifierHashInput(byte[] byArray) {
        Object object = this.monitor();
        synchronized (object) {
            this.check_orphaned();
            SimpleValue simpleValue = null;
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(ENCRYPTEDVERIFIERHASHINPUT$18));
            if (simpleValue == null) {
                simpleValue = (SimpleValue)((Object)this.get_store().add_attribute_user(ENCRYPTEDVERIFIERHASHINPUT$18));
            }
            simpleValue.setByteArrayValue(byArray);
        }
    }
    ...
    public void xsetEncryptedVerifierHashInput(XmlBase64Binary xmlBase64Binary) {
        ...
        synchronized (object) {
            this.check_orphaned();
            XmlBase64Binary xmlBase64Binary2 = null;
            xmlBase64Binary2 = (XmlBase64Binary)((Object)this.get_store().find_attribute_user(ENCRYPTEDVERIFIERHASHINPUT$18));
            if (xmlBase64Binary2 == null) {
                xmlBase64Binary2 = (XmlBase64Binary)((Object)this.get_store().add_attribute_user(ENCRYPTEDVERIFIERHASHINPUT$18));
            }
            xmlBase64Binary2.set(xmlBase64Binary);
        }
    }
    ...
    public byte[] getEncryptedVerifierHashValue() {
        ...
        synchronized (object) {
            this.check_orphaned();
            SimpleValue simpleValue = null;
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(ENCRYPTEDVERIFIERHASHVALUE$20));
            if (simpleValue == null) {
                return null;
            }
            return simpleValue.getByteArrayValue();
    ...
    public XmlBase64Binary xgetEncryptedVerifierHashValue() {
        ...
        synchronized (object) {
            this.check_orphaned();
            XmlBase64Binary xmlBase64Binary = null;
            xmlBase64Binary = (XmlBase64Binary)((Object)this.get_store().find_attribute_user(ENCRYPTEDVERIFIERHASHVALUE$20));
            return xmlBase64Binary;
        }
    }
     ...
     */
    @Override
    public void setEncryptedVerifierHashValue(byte[] byArray) {
        Object object = this.monitor();
        synchronized (object) {
            this.check_orphaned();
            SimpleValue simpleValue = null;
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(ENCRYPTEDVERIFIERHASHVALUE$20));
            if (simpleValue == null) {
                simpleValue = (SimpleValue)((Object)this.get_store().add_attribute_user(ENCRYPTEDVERIFIERHASHVALUE$20));
            }
            simpleValue.setByteArrayValue(byArray);
        }
    }
    ...
    public void xsetEncryptedVerifierHashValue(XmlBase64Binary xmlBase64Binary) {
        ...
        synchronized (object) {
            this.check_orphaned();
            XmlBase64Binary xmlBase64Binary2 = null;
            xmlBase64Binary2 = (XmlBase64Binary)((Object)this.get_store().find_attribute_user(ENCRYPTEDVERIFIERHASHVALUE$20));
            if (xmlBase64Binary2 == null) {
                xmlBase64Binary2 = (XmlBase64Binary)((Object)this.get_store().add_attribute_user(ENCRYPTEDVERIFIERHASHVALUE$20));
            }
            xmlBase64Binary2.set(xmlBase64Binary);
        }
    }
    ...
    public byte[] getEncryptedKeyValue() {
        ...
        synchronized (object) {
            this.check_orphaned();
            SimpleValue simpleValue = null;
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(ENCRYPTEDKEYVALUE$22));
            if (simpleValue == null) {
                return null;
            }
            return simpleValue.getByteArrayValue();
    ...
    public XmlBase64Binary xgetEncryptedKeyValue() {
        ...
        synchronized (object) {
            this.check_orphaned();
            XmlBase64Binary xmlBase64Binary = null;
            xmlBase64Binary = (XmlBase64Binary)((Object)this.get_store().find_attribute_user(ENCRYPTEDKEYVALUE$22));
            return xmlBase64Binary;
        }
    }
    ...
    public void setEncryptedKeyValue(byte[] byArray) {
        ...
        synchronized (object) {
            ...
            simpleValue = (SimpleValue)((Object)this.get_store().find_attribute_user(ENCRYPTEDKEYVALUE$22));
            if (simpleValue == null) {
                simpleValue = (SimpleValue)((Object)this.get_store().add_attribute_user(ENCRYPTEDKEYVALUE$22));
            }
            simpleValue.setByteArrayValue(byArray);
        }
    }
    ...
    public void xsetEncryptedKeyValue(XmlBase64Binary xmlBase64Binary) {
        ...
        synchronized (object) {
            this.check_orphaned();
            XmlBase64Binary xmlBase64Binary2 = null;
            xmlBase64Binary2 = (XmlBase64Binary)((Object)this.get_store().find_attribute_user(ENCRYPTEDKEYVALUE$22));
            if (xmlBase64Binary2 == null) {
                xmlBase64Binary2 = (XmlBase64Binary)((Object)this.get_store().add_attribute_user(ENCRYPTEDKEYVALUE$22));
            }
            xmlBase64Binary2.set(xmlBase64Binary);
        }
    }
