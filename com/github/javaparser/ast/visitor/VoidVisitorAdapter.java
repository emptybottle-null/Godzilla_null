...
implements VoidVisitor<A> {
    ...
    public void visit(AnnotationDeclaration n, A arg) {
        n.getMembers().forEach((Consumer<BodyDeclaration<?>>)((Consumer<BodyDeclaration>)p -> p.accept(this, arg)));
    ...
    public void visit(CompilationUnit n, A arg) {
        ...
        n.getTypes().forEach((Consumer<TypeDeclaration<?>>)((Consumer<TypeDeclaration>)p -> p.accept(this, arg)));
        n.getComment().ifPresent(l -> l.accept(this, arg));
    }
    ...
    public void visit(EnumConstantDeclaration n, A arg) {
        ...
        n.getClassBody().forEach((Consumer<BodyDeclaration<?>>)((Consumer<BodyDeclaration>)p -> p.accept(this, arg)));
        n.getName().accept(this, arg);
        n.getAnnotations().forEach(p -> p.accept(this, arg));
        n.getComment().ifPresent(l -> l.accept(this, arg));
    }
