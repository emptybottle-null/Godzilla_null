...
public class NoCommentHashCodeVisitor
implements GenericVisitor<Integer, Void> {
    ...
    public Integer visit(BreakStmt n, Void arg) {
        return n.getLabel().isPresent() ? n.getLabel().get().accept(this, arg) : Integer.valueOf(0);
    }
    ...
    public Integer visit(ReturnStmt n, Void arg) {
        return n.getExpression().isPresent() ? n.getExpression().get().accept(this, arg) : Integer.valueOf(0);
    }
    ...
    public Integer visit(SuperExpr n, Void arg) {
        return n.getTypeName().isPresent() ? n.getTypeName().get().accept(this, arg) : Integer.valueOf(0);
    }
