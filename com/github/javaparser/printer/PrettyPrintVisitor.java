...
implements VoidVisitor<Void> {
    ...
    public void visit(AssignExpr n, Void arg) {
        ...
        if (this.configuration.isSpaceAroundOperators()) {
            this.printer.print(" ");
        }
    ...
    public void visit(MethodCallExpr n, Void arg) {
        ...
        if (this.configuration.isColumnAlignFirstMethodChain() && n.findAncestor(Statement.class).map(p -> p.isReturnStmt() || p.isThrowStmt() || p.isAssertStmt() || p.isExpressionStmt()).orElse(false).booleanValue()) {
            Node c = n;
    ...
    private void printSwitchNode(SwitchNode n, Void arg) {
        ...
        if (n.getEntries() != null) {
            this.indentIf(this.configuration.isIndentCaseInSwitch());
            for (SwitchEntry e : n.getEntries()) {
                e.accept(this, arg);
            }
            this.unindentIf(this.configuration.isIndentCaseInSwitch());
        }
        this.printer.print("}");
    }
    ...
    public void visit(EnumDeclaration n, Void arg) {
        ...
        if (n.getEntries().isNonEmpty()) {
            boolean alignVertically = n.getEntries().size() > this.configuration.getMaxEnumConstantsToAlignHorizontally() || n.getEntries().stream().anyMatch(e -> e.getComment().isPresent());
            this.printer.println();
